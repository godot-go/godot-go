...
type AStar2D interface {
	RefCounted
	// TODO: Implement virtual method: Internal_FilterNeighbor(from_id int64,neighbor_id int64,) bool
	// TODO: Implement virtual method: Internal_EstimateCost(from_id int64,end_id int64,) float32
	...
	SetNeighborFilterEnabled(enabled bool)
	IsNeighborFilterEnabled() bool
	...
	GetPointPath(from_id int64, to_id int64, allow_partial_path bool) PackedVector2Array
	GetIdPath(from_id int64, to_id int64, allow_partial_path bool) PackedInt64Array
}
type AStar3D interface {
	...
	GetPointPath(from_id int64, to_id int64, allow_partial_path bool) PackedVector3Array
	GetIdPath(from_id int64, to_id int64, allow_partial_path bool) PackedInt64Array
}
type AStarGrid2D interface {
	RefCounted
	// TODO: Implement virtual method: Internal_EstimateCost(from_id Vector2i,end_id Vector2i,) float32
	...
	GetCellSize() Vector2
	SetCellShape(cell_shape AStarGrid2DCellShape)
	GetCellShape() AStarGrid2DCellShape
	...
	GetPointPath(from_id Vector2i, to_id Vector2i, allow_partial_path bool) PackedVector2Array
	GetIdPath(from_id Vector2i, to_id Vector2i, allow_partial_path bool) Vector2i
}
...
type AccessibilityServer interface {
	Object
	IsSupported() bool
	CreateElement(window_id int32, role AccessibilityServerAccessibilityRole) RID
	CreateSubElement(parent_rid RID, role AccessibilityServerAccessibilityRole, insert_pos int32) RID
	CreateSubTextEditElements(parent_rid RID, shaped_text RID, min_height float32, insert_pos int32, is_last_line bool) RID
	HasElement(id RID) bool
	FreeElement(id RID)
	ElementSetMeta(id RID, meta Variant)
	ElementGetMeta(id RID) Variant
	SetWindowRect(window_id int32, rect_out Rect2, rect_in Rect2)
	SetWindowFocused(window_id int32, focused bool)
	UpdateSetFocus(id RID)
	GetWindowRoot(window_id int32) RID
	UpdateSetRole(id RID, role AccessibilityServerAccessibilityRole)
	UpdateSetName(id RID, name String)
	UpdateSetBrailleLabel(id RID, name String)
	UpdateSetBrailleRoleDescription(id RID, description String)
	UpdateSetExtraInfo(id RID, name String)
	UpdateSetDescription(id RID, description String)
	UpdateSetValue(id RID, value String)
	UpdateSetTooltip(id RID, tooltip String)
	UpdateSetBounds(id RID, rect Rect2)
	UpdateSetTransform(id RID, transform Transform2D)
	UpdateAddChild(id RID, child_id RID)
	UpdateAddRelatedControls(id RID, related_id RID)
	UpdateAddRelatedDetails(id RID, related_id RID)
	UpdateAddRelatedDescribedBy(id RID, related_id RID)
	UpdateAddRelatedFlowTo(id RID, related_id RID)
	UpdateAddRelatedLabeledBy(id RID, related_id RID)
	UpdateAddRelatedRadioGroup(id RID, related_id RID)
	UpdateSetActiveDescendant(id RID, other_id RID)
	UpdateSetNextOnLine(id RID, other_id RID)
	UpdateSetPreviousOnLine(id RID, other_id RID)
	UpdateSetMemberOf(id RID, group_id RID)
	UpdateSetInPageLinkTarget(id RID, other_id RID)
	UpdateSetErrorMessage(id RID, other_id RID)
	UpdateSetLive(id RID, live AccessibilityServerAccessibilityLiveMode)
	UpdateAddAction(id RID, action AccessibilityServerAccessibilityAction, callable Callable)
	UpdateAddCustomAction(id RID, action_id int32, action_description String)
	UpdateSetTableRowCount(id RID, count int32)
	UpdateSetTableColumnCount(id RID, count int32)
	UpdateSetTableRowIndex(id RID, index int32)
	UpdateSetTableColumnIndex(id RID, index int32)
	UpdateSetTableCellPosition(id RID, row_index int32, column_index int32)
	UpdateSetTableCellSpan(id RID, row_span int32, column_span int32)
	UpdateSetListItemCount(id RID, size int32)
	UpdateSetListItemIndex(id RID, index int32)
	UpdateSetListItemLevel(id RID, level int32)
	UpdateSetListItemSelected(id RID, selected bool)
	UpdateSetListItemExpanded(id RID, expanded bool)
	UpdateSetPopupType(id RID, popup AccessibilityServerAccessibilityPopupType)
	UpdateSetChecked(id RID, checekd bool)
	UpdateSetNumValue(id RID, position float64)
	UpdateSetNumRange(id RID, min float64, max float64)
	UpdateSetNumStep(id RID, step float64)
	UpdateSetNumJump(id RID, jump float64)
	UpdateSetScrollX(id RID, position float64)
	UpdateSetScrollXRange(id RID, min float64, max float64)
	UpdateSetScrollY(id RID, position float64)
	UpdateSetScrollYRange(id RID, min float64, max float64)
	UpdateSetTextDecorations(id RID, underline bool, strikethrough bool, overline bool, color Color)
	UpdateSetTextAlign(id RID, align HorizontalAlignment)
	UpdateSetTextSelection(id RID, text_start_id RID, start_char int32, text_end_id RID, end_char int32)
	UpdateSetFlag(id RID, flag AccessibilityServerAccessibilityFlags, value bool)
	UpdateSetClassname(id RID, classname String)
	UpdateSetPlaceholder(id RID, placeholder String)
	UpdateSetLanguage(id RID, language String)
	UpdateSetTextOrientation(id RID, vertical bool)
	UpdateSetListOrientation(id RID, vertical bool)
	UpdateSetShortcut(id RID, shortcut String)
	UpdateSetUrl(id RID, url String)
	UpdateSetRoleDescription(id RID, description String)
	UpdateSetStateDescription(id RID, description String)
	UpdateSetColorValue(id RID, color Color)
	UpdateSetBackgroundColor(id RID, color Color)
	UpdateSetForegroundColor(id RID, color Color)
}
type AimModifier3D interface {
	BoneConstraint3D
	SetForwardAxis(index int32, axis SkeletonModifier3DBoneAxis)
	GetForwardAxis(index int32) SkeletonModifier3DBoneAxis
	SetUseEuler(index int32, enabled bool)
	IsUsingEuler(index int32) bool
	SetPrimaryRotationAxis(index int32, axis Vector3Axis)
...
type Animation interface {
	...
	PositionTrackInterpolate(track_idx int32, time_sec float64, backward bool) Vector3
	RotationTrackInterpolate(track_idx int32, time_sec float64, backward bool) Quaternion
	ScaleTrackInterpolate(track_idx int32, time_sec float64, backward bool) Vector3
	BlendShapeTrackInterpolate(track_idx int32, time_sec float64, backward bool) float32
	...
	TrackFindKey(track_idx int32, time float64, find_mode AnimationFindMode, limit bool, backward bool) int32
	...
	ValueTrackInterpolate(track_idx int32, time_sec float64, backward bool) Variant
	...
	AddMarker(name StringName, time float64)
	RemoveMarker(name StringName)
	HasMarker(name StringName) bool
	...
	SetMarkerColor(name StringName, color Color)
	SetLength(time_sec float64)
	GetLength() float64
	...
	Optimize(allowed_velocity_err float32, allowed_angular_err float32, precision int32)
	Compress(page_size uint32, fps uint32, split_tolerance float32)
	IsCaptureIncluded() bool
}
...
type AnimationMixer interface {
	...
	SetCallbackModeDiscrete(mode AnimationMixerAnimationCallbackModeDiscrete)
	...
	SetRootMotionLocal(enabled bool)
	IsRootMotionLocal() bool
...
type AnimationNode interface {
	...
	GetProcessingAnimationTreeInstanceId() uint64
	IsProcessTesting() bool
...
type AnimationNodeAnimation interface {
	...
	SetAdvanceOnStart(advance_on_start bool)
	IsAdvanceOnStart() bool
	SetUseCustomTimeline(use_custom_timeline bool)
	IsUsingCustomTimeline() bool
	SetTimelineLength(timeline_length float64)
	GetTimelineLength() float64
	SetStretchTimeScale(stretch_time_scale bool)
	IsStretchingTimeScale() bool
	SetStartOffset(start_offset float64)
...
type AnimationNodeBlendSpace1D interface {
	AnimationRootNode
	AddBlendPoint(node RefAnimationRootNode, pos float32, at_index int32, name StringName)
	...
	SetBlendPointName(point int32, name StringName)
	GetBlendPointName(point int32) StringName
	FindBlendPointByName(name StringName) int32
	RemoveBlendPoint(point int32)
	GetBlendPointCount() int32
	ReorderBlendPoint(from_index int32, to_index int32)
	...
	IsUsingSync() bool
	SetSyncMode(sync_mode AnimationNodeBlendSpace1DSyncMode)
	GetSyncMode() AnimationNodeBlendSpace1DSyncMode
	SetCyclicLength(length float64)
	GetCyclicLength() float64
}
type AnimationNodeBlendSpace2D interface {
	AnimationRootNode
	AddBlendPoint(node RefAnimationRootNode, pos Vector2, at_index int32, name StringName)
	...
	SetUseSync(enable bool)
	IsUsingSync() bool
	SetSyncMode(sync_mode AnimationNodeBlendSpace2DSyncMode)
	GetSyncMode() AnimationNodeBlendSpace2DSyncMode
	SetCyclicLength(length float64)
	GetCyclicLength() float64
}
...
type AnimationNodeExtension interface {
	AnimationNode
	// TODO: Implement virtual method: Internal_ProcessAnimationNode(playback_info PackedFloat64Array,test_only bool,) PackedFloat32Array
	IsLooping(node_info PackedFloat32Array) bool
	GetRemainingTime(node_info PackedFloat32Array, break_loop bool) float64
}
...
type AnimationNodeTimeSeek interface {
	AnimationNode
	SetExplicitElapse(enable bool)
	IsExplicitElapse() bool
}
type AnimationNodeTransition interface {
	...
	SetInputBreakLoopAtEnd(input int32, enable bool)
	IsInputLoopBrokenAtEnd(input int32) bool
...
type AnimationPlayer interface {
	...
	SetAutoCapture(auto_capture bool)
	IsAutoCapture() bool
	SetAutoCaptureDuration(auto_capture_duration float64)
	GetAutoCaptureDuration() float64
	SetAutoCaptureTransitionType(auto_capture_transition_type TweenTransitionType)
	...
	PlaySectionWithMarkers(name StringName, start_marker StringName, end_marker StringName, custom_blend float64, custom_speed float32, from_end bool)
	PlaySection(name StringName, start_time float64, end_time float64, custom_blend float64, custom_speed float32, from_end bool)
	PlayBackwards(name StringName, custom_blend float64)
	PlaySectionWithMarkersBackwards(name StringName, start_marker StringName, end_marker StringName, custom_blend float64)
	PlaySectionBackwards(name StringName, start_time float64, end_time float64, custom_blend float64)
	...
	SetSectionWithMarkers(start_marker StringName, end_marker StringName)
	SetSection(start_time float64, end_time float64)
	ResetSection()
...
type AreaLight3D interface {
	Light3D
	SetAreaTexture(texture RefTexture2D)
	GetAreaTexture() RefTexture2D
	SetAreaSize(area_size Vector2)
	GetAreaSize() Vector2
	SetAreaNormalizeEnergy(enable bool)
	IsAreaNormalizingEnergy() bool
}
...
type AudioEffect interface {
	Resource
	// TODO: Implement virtual method: Internal_Instantiate() RefAudioEffectInstance
...
type AudioEffectAmplify interface {
	...
	GetVolumeDb() float32
	SetVolumeLinear(volume float32)
	GetVolumeLinear() float32
}
...
type AudioEffectHardLimiter interface {
	AudioEffect
	SetCeilingDb(ceiling float32)
	GetCeilingDb() float32
	SetPreGainDb(pre_gain float32)
	GetPreGainDb() float32
...
type AudioEffectInstance interface {
	RefCounted
	// TODO: Implement virtual method: Internal_Process(src_buffer unsafe.Pointer,r_dst_buffer *AudioFrame,frame_count int32,)
	// TODO: Implement virtual method: Internal_ProcessSilence() bool
...
type AudioListener3D interface {
	...
	SetDopplerTracking(mode AudioListener3DDopplerTracking)
	GetDopplerTracking() AudioListener3DDopplerTracking
}
type AudioSample interface {
	RefCounted
}
type AudioSamplePlayback interface {
	RefCounted
}
type AudioServer interface {
	...
	SetBusVolumeLinear(bus_idx int32, volume_linear float32)
	GetBusVolumeLinear(bus_idx int32) float32
	...
	IsStreamRegisteredAsSample(stream RefAudioStream) bool
	RegisterStreamAsSample(stream RefAudioStream)
}
type AudioStream interface {
	...
	// TODO: Implement virtual method: Internal_GetTags() Dictionary
	// TODO: Implement virtual method: Internal_GetParameterList() Dictionary
	// TODO: Implement virtual method: Internal_HasLoop() bool
	// TODO: Implement virtual method: Internal_GetBarBeats() int32
	GetLength() float64
	IsMonophonic() bool
	InstantiatePlayback() RefAudioStreamPlayback
	CanBeSampled() bool
	GenerateSample() RefAudioSample
	IsMetaStream() bool
}
type AudioStreamGenerator interface {
	...
	GetMixRate() float32
	SetMixRateMode(mode AudioStreamGeneratorAudioStreamGeneratorMixRate)
	GetMixRateMode() AudioStreamGeneratorAudioStreamGeneratorMixRate
	SetBufferLength(seconds float32)
	GetBufferLength() float32
}
...
type AudioStreamInteractive interface {
	AudioStream
	SetClipCount(clip_count int32)
	GetClipCount() int32
	...
	GetClipStream(clip_index int32) RefAudioStream
	SetClipAutoAdvance(clip_index int32, mode AudioStreamInteractiveAutoAdvanceMode)
	GetClipAutoAdvance(clip_index int32) AudioStreamInteractiveAutoAdvanceMode
	SetClipAutoAdvanceNextClip(clip_index int32, auto_advance_next_clip int32)
	GetClipAutoAdvanceNextClip(clip_index int32) int32
	AddTransition(from_clip int32, to_clip int32, from_time AudioStreamInteractiveTransitionFromTime, to_time AudioStreamInteractiveTransitionToTime, fade_mode AudioStreamInteractiveFadeMode, fade_beats float32, use_filler_clip bool, filler_clip int32, hold_previous bool)
	HasTransition(from_clip int32, to_clip int32) bool
	EraseTransition(from_clip int32, to_clip int32)
	GetTransitionList() PackedInt32Array
	GetTransitionFromTime(from_clip int32, to_clip int32) AudioStreamInteractiveTransitionFromTime
	GetTransitionToTime(from_clip int32, to_clip int32) AudioStreamInteractiveTransitionToTime
	GetTransitionFadeMode(from_clip int32, to_clip int32) AudioStreamInteractiveFadeMode
	GetTransitionFadeBeats(from_clip int32, to_clip int32) float32
	IsTransitionUsingFillerClip(from_clip int32, to_clip int32) bool
	GetTransitionFillerClip(from_clip int32, to_clip int32) int32
	IsTransitionHoldingPrevious(from_clip int32, to_clip int32) bool
}
type AudioStreamMP3 interface {
	AudioStream
	LoadFromBuffer(stream_data PackedByteArray) RefAudioStreamMP3
	LoadFromFile(path String) RefAudioStreamMP3
...
type AudioStreamOggVorbis interface {
	AudioStream
	LoadFromBuffer(stream_data PackedByteArray) RefAudioStreamOggVorbis
	...
	SetBarBeats(count int32)
	GetBarBeats() int32
	SetTags(tags Dictionary)
	GetTags() Dictionary
}
type AudioStreamPlayback interface {
	RefCounted
	// TODO: Implement virtual method: Internal_Start(from_pos float64,)
	// TODO: Implement virtual method: Internal_Stop()
	// TODO: Implement virtual method: Internal_IsPlaying() bool
	// TODO: Implement virtual method: Internal_GetLoopCount() int32
	// TODO: Implement virtual method: Internal_GetPlaybackPosition() float64
	// TODO: Implement virtual method: Internal_Seek(position float64,)
	// TODO: Implement virtual method: Internal_Mix(buffer *AudioFrame,rate_scale float32,frames int32,) int32
	// TODO: Implement virtual method: Internal_TagUsedStreams()
	// TODO: Implement virtual method: Internal_SetParameter(name StringName,value Variant,)
	// TODO: Implement virtual method: Internal_GetParameter(name StringName,) Variant
	SetSamplePlayback(playback_sample RefAudioSamplePlayback)
	GetSamplePlayback() RefAudioSamplePlayback
	MixAudio(rate_scale float32, frames int32) PackedVector2Array
...
type AudioStreamPlaybackInteractive interface {
	...
	GetCurrentClipIndex() int32
}
type AudioStreamPlaybackOggVorbis interface {
	AudioStreamPlaybackResampled
}
type AudioStreamPlaybackPlaylist interface {
	AudioStreamPlayback
}
...
type AudioStreamPlaybackSynchronized interface {
	AudioStreamPlayback
}
type AudioStreamPlayer interface {
	...
	GetVolumeDb() float32
	SetVolumeLinear(volume_linear float32)
	GetVolumeLinear() float32
	...
	SetPlaybackType(playback_type AudioServerPlaybackType)
	GetPlaybackType() AudioServerPlaybackType
}
...
type AudioStreamPlaylist interface {
	AudioStream
	SetStreamCount(stream_count int32)
	GetStreamCount() int32
	GetBpm() float64
	SetListStream(stream_index int32, audio_stream RefAudioStream)
	GetListStream(stream_index int32) RefAudioStream
	SetShuffle(shuffle bool)
	GetShuffle() bool
	SetFadeTime(dec float32)
	GetFadeTime() float32
	SetLoop(loop bool)
	HasLoop() bool
}
...
type AudioStreamSynchronized interface {
	AudioStream
	SetStreamCount(stream_count int32)
	GetStreamCount() int32
	SetSyncStream(stream_index int32, audio_stream RefAudioStream)
	GetSyncStream(stream_index int32) RefAudioStream
	SetSyncStreamVolume(stream_index int32, volume_db float32)
	GetSyncStreamVolume(stream_index int32) float32
}
type AudioStreamWAV interface {
	AudioStream
	LoadFromBuffer(stream_data PackedByteArray, options Dictionary) RefAudioStreamWAV
	LoadFromFile(path String, options Dictionary) RefAudioStreamWAV
	SetData(data PackedByteArray)
	GetData() PackedByteArray
	SetFormat(format AudioStreamWAVFormat)
	GetFormat() AudioStreamWAVFormat
...
type AwaitTweener interface {
	Tweener
	SetTimeout(timeout float64) RefAwaitTweener
}
...
type BaseMaterial3D interface {
	...
	SetDepthTest(depth_test BaseMaterial3DDepthTest)
	GetDepthTest() BaseMaterial3DDepthTest
	...
	SetZClipScale(scale float32)
	GetZClipScale() float32
	SetFovOverride(scale float32)
	GetFovOverride() float32
	SetStencilMode(stencil_mode BaseMaterial3DStencilMode)
	GetStencilMode() BaseMaterial3DStencilMode
	SetStencilFlags(stencil_flags int32)
	GetStencilFlags() int32
	SetStencilCompare(stencil_compare BaseMaterial3DStencilCompare)
	GetStencilCompare() BaseMaterial3DStencilCompare
	SetStencilReference(stencil_reference int32)
	GetStencilReference() int32
	SetStencilEffectColor(stencil_color Color)
	GetStencilEffectColor() Color
	SetStencilEffectOutlineThickness(stencil_outline_thickness float32)
	GetStencilEffectOutlineThickness() float32
}
...
type BlitMaterial interface {
	Material
	SetBlendMode(blend_mode BlitMaterialBlendMode)
	GetBlendMode() BlitMaterialBlendMode
}
...
type BoneConstraint3D interface {
	SkeletonModifier3D
	SetAmount(index int32, amount float32)
	GetAmount(index int32) float32
	SetApplyBoneName(index int32, bone_name String)
...
type Button interface {
	...
	SetAutowrapTrimFlags(autowrap_trim_flags TextServerLineBreakFlag)
	GetAutowrapTrimFlags() TextServerLineBreakFlag
...
type CPUParticles2D interface {
	...
	RequestParticlesProcess(process_time float32, process_time_residual float32)
	IsEmitting() bool
	GetAmount() int32
	GetLifetime() float64
	GetOneShot() bool
	...
	SetUseFixedSeed(use_fixed_seed bool)
	GetUseFixedSeed() bool
	SetSeed(seed uint32)
	GetSeed() uint32
...
type CPUParticles3D interface {
	...
	SetEmissionRingInnerRadius(inner_radius float32)
	GetEmissionRingInnerRadius() float32
	SetEmissionRingConeAngle(cone_angle float32)
	GetEmissionRingConeAngle() float32
	GetGravity() Vector3
...
type CSGPolygon3D interface {
	...
	SetPathRotationAccurate(enable bool)
	GetPathRotationAccurate() bool
...
type CSGShape3D interface {
	...
	BakeCollisionShape() RefConcavePolygonShape3D
	SetCalculateTangents(enabled bool)
	IsCalculatingTangents() bool
	GetMeshes() Array
	BakeStaticMesh() RefArrayMesh
	SetAutosmooth(autosmooth bool)
	IsAutosmooth() bool
	SetSmoothingAngle(smoothing_angle float32)
	GetSmoothingAngle() float32
}
...
type Camera2D interface {
	...
	MakeCurrent()
	IsCurrent() bool
	SetLimitEnabled(limit_enabled bool)
	IsLimitEnabled() bool
	...
	SetPositionSmoothingEnabled(enabled bool)
...
type Camera3D interface {
	...
	SetCompositor(compositor RefCompositor)
	GetCompositor() RefCompositor
...
type CameraFeed interface {
	RefCounted
	// TODO: Implement virtual method: Internal_ActivateFeed() bool
	// TODO: Implement virtual method: Internal_DeactivateFeed()
	// TODO: Implement virtual method: Internal_SetFormat(index int32,parameters Dictionary,) bool
	// TODO: Implement virtual method: Internal_GetFormats() Array
	GetId() int32
	IsActive() bool
	SetActive(active bool)
	GetName() String
	...
	SetPosition(position CameraFeedFeedPosition)
	...
	GetFormats() Array
	SetFormat(index int32, parameters Dictionary) bool
}
type CameraServer interface {
	Object
	SetMonitoringFeeds(is_monitoring_feeds bool)
	IsMonitoringFeeds() bool
...
type CanvasItem interface {
	...
	DrawString(font RefFont, pos Vector2, text String, alignment HorizontalAlignment, width float32, font_size int32, modulate Color, justification_flags TextServerJustificationFlag, direction TextServerDirection, orientation TextServerOrientation, oversampling float32)
	DrawMultilineString(font RefFont, pos Vector2, text String, alignment HorizontalAlignment, width float32, font_size int32, max_lines int32, modulate Color, brk_flags TextServerLineBreakFlag, justification_flags TextServerJustificationFlag, direction TextServerDirection, orientation TextServerOrientation, oversampling float32)
	DrawStringOutline(font RefFont, pos Vector2, text String, alignment HorizontalAlignment, width float32, font_size int32, size int32, modulate Color, justification_flags TextServerJustificationFlag, direction TextServerDirection, orientation TextServerOrientation, oversampling float32)
	DrawMultilineStringOutline(font RefFont, pos Vector2, text String, alignment HorizontalAlignment, width float32, font_size int32, max_lines int32, size int32, modulate Color, brk_flags TextServerLineBreakFlag, justification_flags TextServerJustificationFlag, direction TextServerDirection, orientation TextServerOrientation, oversampling float32)
	DrawChar(font RefFont, pos Vector2, char String, font_size int32, modulate Color, oversampling float32)
	DrawCharOutline(font RefFont, pos Vector2, char String, font_size int32, size int32, modulate Color, oversampling float32)
	...
	MakeCanvasPositionLocal(viewport_point Vector2) Vector2
	...
	SetOversamplingWithScale(enabled CanvasItemOversamplingWithScale)
	GetOversamplingWithScale() CanvasItemOversamplingWithScale
}
...
type ClassDB interface {
	...
	ClassGetApiType(class StringName) ClassDBAPIType
	...
	ClassGetPropertyGetter(class StringName, property StringName) StringName
	ClassGetPropertySetter(class StringName, property StringName) StringName
	...
	ClassCallStatic(class StringName, method StringName, varargs ...Variant) Variant
...
type CodeEdit interface {
	...
	SetSymbolTooltipOnHoverEnabled(enable bool)
	IsSymbolTooltipOnHoverEnabled() bool
	MoveLinesUp()
	MoveLinesDown()
	DeleteLines()
	JoinLines(line_ending String)
	DuplicateSelection()
	DuplicateLines()
}
...
type CollisionObject2D interface {
	...
	GetShapeOwnerOneWayCollisionDirection(owner_id uint32) Vector2
	ShapeOwnerSetOneWayCollisionDirection(owner_id uint32, direction Vector2)
...
type CollisionObject3D interface {
	Node3D
	// TODO: Implement virtual method: Internal_InputEvent(camera Camera3D,event RefInputEvent,event_position Vector3,normal Vector3,shape_idx int32,)
	// TODO: Implement virtual method: Internal_MouseEnter()
	// TODO: Implement virtual method: Internal_MouseExit()
	SetCollisionLayer(layer uint32)
	GetCollisionLayer() uint32
...
type CollisionPolygon2D interface {
	...
	SetOneWayCollisionDirection(direction Vector2)
	GetOneWayCollisionDirection() Vector2
}
type CollisionPolygon3D interface {
	...
	GetDebugColor() Color
	SetEnableDebugFill(enable bool)
	GetEnableDebugFill() bool
...
type ColorPicker interface {
	...
	IsEditingAlpha() bool
	SetEditIntensity(show bool)
	IsEditingIntensity() bool
...
type Compositor interface {
	Resource
	SetCompositorEffects(compositor_effects RefCompositorEffect)
	GetCompositorEffects() RefCompositorEffect
}
type CompositorEffect interface {
	Resource
	// TODO: Implement virtual method: Internal_RenderCallback(effect_callback_type int32,render_data RenderData,)
	SetEnabled(enabled bool)
	GetEnabled() bool
	SetEffectCallbackType(effect_callback_type CompositorEffectEffectCallbackType)
	GetEffectCallbackType() CompositorEffectEffectCallbackType
	SetAccessResolvedColor(enable bool)
	GetAccessResolvedColor() bool
	SetAccessResolvedDepth(enable bool)
	GetAccessResolvedDepth() bool
	SetNeedsMotionVectors(enable bool)
	GetNeedsMotionVectors() bool
	SetNeedsNormalRoughness(enable bool)
	GetNeedsNormalRoughness() bool
	SetNeedsSeparateSpecular(enable bool)
	GetNeedsSeparateSpecular() bool
}
...
type Container interface {
	...
	SetAccessibilityRegion(region bool)
	IsAccessibilityRegion() bool
}
type Control interface {
	...
	// TODO: Implement virtual method: Internal_GetMaximumSize() Vector2
	...
	// TODO: Implement virtual method: Internal_GetTooltipAutoTranslateModeAt(at_position Vector2,) NodeAutoTranslateMode
	...
	// TODO: Implement virtual method: Internal_GetCursorShape(at_position Vector2,) int32
	// TODO: Implement virtual method: Internal_AccessibilityGetContextualInfo() String
	// TODO: Implement virtual method: Internal_GetAccessibilityContainerName(node Node,) String
	...
	SetPropagateMaximumSize(enable bool)
	IsPropagatingMaximumSize() bool
	...
	ResetSize()
	SetCustomMaximumSize(size Vector2)
	...
	SetOffsetTransformEnabled(enabled bool)
	IsOffsetTransformEnabled() bool
	SetOffsetTransformPosition(offset Vector2)
	GetOffsetTransformPosition() Vector2
	SetOffsetTransformPositionRatio(offset Vector2)
	GetOffsetTransformPositionRatio() Vector2
	SetOffsetTransformScale(scale Vector2)
	GetOffsetTransformScale() Vector2
	SetOffsetTransformRotation(rotation float32)
	GetOffsetTransformRotation() float32
	SetOffsetTransformPivot(pivot Vector2)
	GetOffsetTransformPivot() Vector2
	SetOffsetTransformPivotRatio(pivot Vector2)
	GetOffsetTransformPivotRatio() Vector2
	SetOffsetTransformVisualOnly(enabled bool)
	IsOffsetTransformVisualOnly() bool
	...
	SetTooltipAutoTranslateMode(mode NodeAutoTranslateMode)
	GetTooltipAutoTranslateMode() NodeAutoTranslateMode
	SetTooltipText(hint String)
	GetTooltipText() String
	GetTooltip(at_position Vector2) String
	SetTranslationContext(context StringName)
	GetTranslationContext() StringName
	SetDefaultCursorShape(shape ControlCursorShape)
	GetDefaultCursorShape() ControlCursorShape
	GetCursorShape(at_position Vector2) ControlCursorShape
	...
	AccessibilityDrag()
	AccessibilityDrop()
	SetAccessibilityName(name String)
	GetAccessibilityName() String
	SetAccessibilityDescription(description String)
	GetAccessibilityDescription() String
	SetAccessibilityLive(mode AccessibilityServerAccessibilityLiveMode)
	GetAccessibilityLive() AccessibilityServerAccessibilityLiveMode
	SetAccessibilityControlsNodes(node_path NodePath)
	GetAccessibilityControlsNodes() NodePath
	SetAccessibilityDescribedByNodes(node_path NodePath)
	GetAccessibilityDescribedByNodes() NodePath
	SetAccessibilityLabeledByNodes(node_path NodePath)
	GetAccessibilityLabeledByNodes() NodePath
	SetAccessibilityFlowToNodes(node_path NodePath)
	GetAccessibilityFlowToNodes() NodePath
	SetMouseFilter(filter ControlMouseFilter)
	GetMouseFilter() ControlMouseFilter
	GetMouseFilterWithOverride() ControlMouseFilter
	SetMouseBehaviorRecursive(mouse_behavior_recursive ControlMouseBehaviorRecursive)
	GetMouseBehaviorRecursive() ControlMouseBehaviorRecursive
...
type ConvertTransformModifier3D interface {
	BoneConstraint3D
	SetApplyTransformMode(index int32, transform_mode ConvertTransformModifier3DTransformMode)
	GetApplyTransformMode(index int32) ConvertTransformModifier3DTransformMode
	SetApplyAxis(index int32, axis Vector3Axis)
	GetApplyAxis(index int32) Vector3Axis
	SetApplyRangeMin(index int32, range_min float32)
	GetApplyRangeMin(index int32) float32
	SetApplyRangeMax(index int32, range_max float32)
	GetApplyRangeMax(index int32) float32
	SetReferenceTransformMode(index int32, transform_mode ConvertTransformModifier3DTransformMode)
	GetReferenceTransformMode(index int32) ConvertTransformModifier3DTransformMode
	SetReferenceAxis(index int32, axis Vector3Axis)
	GetReferenceAxis(index int32) Vector3Axis
	SetReferenceRangeMin(index int32, range_min float32)
	GetReferenceRangeMin(index int32) float32
	SetReferenceRangeMax(index int32, range_max float32)
	GetReferenceRangeMax(index int32) float32
	SetRelative(index int32, enabled bool)
	IsRelative(index int32) bool
	SetAdditive(index int32, enabled bool)
	IsAdditive(index int32) bool
}
...
type CopyTransformModifier3D interface {
	BoneConstraint3D
	SetCopyFlags(index int32, copy_flags CopyTransformModifier3DTransformFlag)
	GetCopyFlags(index int32) CopyTransformModifier3DTransformFlag
	SetAxisFlags(index int32, axis_flags CopyTransformModifier3DAxisFlag)
	GetAxisFlags(index int32) CopyTransformModifier3DAxisFlag
	SetInvertFlags(index int32, axis_flags CopyTransformModifier3DAxisFlag)
	GetInvertFlags(index int32) CopyTransformModifier3DAxisFlag
	SetCopyPosition(index int32, enabled bool)
	IsPositionCopying(index int32) bool
	SetCopyRotation(index int32, enabled bool)
	IsRotationCopying(index int32) bool
	SetCopyScale(index int32, enabled bool)
	IsScaleCopying(index int32) bool
	SetAxisXEnabled(index int32, enabled bool)
	IsAxisXEnabled(index int32) bool
	SetAxisYEnabled(index int32, enabled bool)
	IsAxisYEnabled(index int32) bool
	SetAxisZEnabled(index int32, enabled bool)
	IsAxisZEnabled(index int32) bool
	SetAxisXInverted(index int32, enabled bool)
	IsAxisXInverted(index int32) bool
	SetAxisYInverted(index int32, enabled bool)
	IsAxisYInverted(index int32) bool
	SetAxisZInverted(index int32, enabled bool)
	IsAxisZInverted(index int32) bool
	SetRelative(index int32, enabled bool)
	IsRelative(index int32) bool
	SetAdditive(index int32, enabled bool)
	IsAdditive(index int32) bool
...
type Curve interface {
	...
	GetValueRange() float32
	GetMinDomain() float32
	SetMinDomain(min float32)
	GetMaxDomain() float32
	SetMaxDomain(max float32)
	GetDomainRange() float32
	CleanDupes()
	Bake()
...
type DPITexture interface {
	Texture2D
	CreateFromString(source String, scale float32, saturation float32, color_map Dictionary) RefDPITexture
	SetSource(source String)
	GetSource() String
	SetFixAlphaBorder(fix_alpha_border bool)
	GetFixAlphaBorder() bool
	SetPremultAlpha(premult_alpha bool)
	GetPremultAlpha() bool
	SetBaseScale(base_scale float32)
	GetBaseScale() float32
	SetSaturation(saturation float32)
	GetSaturation() float32
	SetColorMap(color_map Dictionary)
	GetColorMap() Dictionary
...
type DirAccess interface {
	...
	GetOpenError() Error
	CreateTemp(prefix String, keep bool) RefDirAccess
	ListDirBegin() Error
	GetNext() String
	CurrentIsDir() bool
	ListDirEnd()
	...
	GetDriveLabel(idx int32) String
	...
	IsEquivalent(path_a String, path_b String) bool
}
...
type DisplayServer interface {
	...
	GetBaseColor() Color
	SetSystemThemeChangeCallback(callable Callable)
	...
	ScreenGetImageRect(rect Rect2i) RefImage
	...
	WindowSetIcon(icon RefImage, window_id int32)
	...
	WindowSetTaskbarProgressValue(value float32, window_id int32)
	WindowSetTaskbarProgressState(state DisplayServerProgressState, window_id int32)
	...
	WindowIsHdrOutputSupported(window_id int32) bool
	WindowRequestHdrOutput(enable bool, window_id int32)
	WindowIsHdrOutputRequested(window_id int32) bool
	WindowIsHdrOutputEnabled(window_id int32) bool
	WindowSetHdrOutputReferenceLuminance(reference_luminance float32, window_id int32)
	WindowGetHdrOutputReferenceLuminance(window_id int32) float32
	WindowGetHdrOutputCurrentReferenceLuminance(window_id int32) float32
	WindowSetHdrOutputMaxLuminance(max_luminance float32, window_id int32)
	WindowGetHdrOutputMaxLuminance(window_id int32) float32
	WindowGetHdrOutputCurrentMaxLuminance(window_id int32) float32
	WindowGetOutputMaxLinearValue(window_id int32) float32
	...
	AccessibilityElementGetMeta(id RID) Variant
	AccessibilitySetWindowRect(window_id int32, rect_out Rect2, rect_in Rect2)
	AccessibilitySetWindowFocused(window_id int32, focused bool)
	AccessibilityUpdateSetFocus(id RID)
	AccessibilityGetWindowRoot(window_id int32) RID
	AccessibilityUpdateSetRole(id RID, role DisplayServerAccessibilityRole)
	AccessibilityUpdateSetName(id RID, name String)
	AccessibilityUpdateSetExtraInfo(id RID, name String)
	AccessibilityUpdateSetDescription(id RID, description String)
	AccessibilityUpdateSetValue(id RID, value String)
	AccessibilityUpdateSetTooltip(id RID, tooltip String)
	AccessibilityUpdateSetBounds(id RID, rect Rect2)
	AccessibilityUpdateSetTransform(id RID, transform Transform2D)
	AccessibilityUpdateAddChild(id RID, child_id RID)
	AccessibilityUpdateAddRelatedControls(id RID, related_id RID)
	AccessibilityUpdateAddRelatedDetails(id RID, related_id RID)
	AccessibilityUpdateAddRelatedDescribedBy(id RID, related_id RID)
	AccessibilityUpdateAddRelatedFlowTo(id RID, related_id RID)
	AccessibilityUpdateAddRelatedLabeledBy(id RID, related_id RID)
	AccessibilityUpdateAddRelatedRadioGroup(id RID, related_id RID)
	AccessibilityUpdateSetActiveDescendant(id RID, other_id RID)
	AccessibilityUpdateSetNextOnLine(id RID, other_id RID)
	AccessibilityUpdateSetPreviousOnLine(id RID, other_id RID)
	AccessibilityUpdateSetMemberOf(id RID, group_id RID)
	AccessibilityUpdateSetInPageLinkTarget(id RID, other_id RID)
	AccessibilityUpdateSetErrorMessage(id RID, other_id RID)
	AccessibilityUpdateSetLive(id RID, live DisplayServerAccessibilityLiveMode)
	AccessibilityUpdateAddAction(id RID, action DisplayServerAccessibilityAction, callable Callable)
	AccessibilityUpdateAddCustomAction(id RID, action_id int32, action_description String)
	AccessibilityUpdateSetTableRowCount(id RID, count int32)
	AccessibilityUpdateSetTableColumnCount(id RID, count int32)
	AccessibilityUpdateSetTableRowIndex(id RID, index int32)
	AccessibilityUpdateSetTableColumnIndex(id RID, index int32)
	AccessibilityUpdateSetTableCellPosition(id RID, row_index int32, column_index int32)
	AccessibilityUpdateSetTableCellSpan(id RID, row_span int32, column_span int32)
	AccessibilityUpdateSetListItemCount(id RID, size int32)
	AccessibilityUpdateSetListItemIndex(id RID, index int32)
	AccessibilityUpdateSetListItemLevel(id RID, level int32)
	AccessibilityUpdateSetListItemSelected(id RID, selected bool)
	AccessibilityUpdateSetListItemExpanded(id RID, expanded bool)
	AccessibilityUpdateSetPopupType(id RID, popup DisplayServerAccessibilityPopupType)
	AccessibilityUpdateSetChecked(id RID, checekd bool)
	AccessibilityUpdateSetNumValue(id RID, position float64)
	AccessibilityUpdateSetNumRange(id RID, min float64, max float64)
	AccessibilityUpdateSetNumStep(id RID, step float64)
	AccessibilityUpdateSetNumJump(id RID, jump float64)
	AccessibilityUpdateSetScrollX(id RID, position float64)
	AccessibilityUpdateSetScrollXRange(id RID, min float64, max float64)
	AccessibilityUpdateSetScrollY(id RID, position float64)
	AccessibilityUpdateSetScrollYRange(id RID, min float64, max float64)
	AccessibilityUpdateSetTextDecorations(id RID, underline bool, strikethrough bool, overline bool)
	AccessibilityUpdateSetTextAlign(id RID, align HorizontalAlignment)
	AccessibilityUpdateSetTextSelection(id RID, text_start_id RID, start_char int32, text_end_id RID, end_char int32)
	AccessibilityUpdateSetFlag(id RID, flag DisplayServerAccessibilityFlags, value bool)
	AccessibilityUpdateSetClassname(id RID, classname String)
	AccessibilityUpdateSetPlaceholder(id RID, placeholder String)
	AccessibilityUpdateSetLanguage(id RID, language String)
	AccessibilityUpdateSetTextOrientation(id RID, vertical bool)
	AccessibilityUpdateSetListOrientation(id RID, vertical bool)
	AccessibilityUpdateSetShortcut(id RID, shortcut String)
	AccessibilityUpdateSetUrl(id RID, url String)
	AccessibilityUpdateSetRoleDescription(id RID, description String)
	AccessibilityUpdateSetStateDescription(id RID, description String)
	AccessibilityUpdateSetColorValue(id RID, color Color)
	AccessibilityUpdateSetBackgroundColor(id RID, color Color)
	AccessibilityUpdateSetForegroundColor(id RID, color Color)
	...
	SetHardwareKeyboardConnectionChangeCallback(callable Callable)
	...
	FileDialogShow(title String, current_directory String, filename String, show_hidden bool, mode DisplayServerFileDialogMode, filters PackedStringArray, callback Callable, parent_window_id int32) Error
	FileDialogWithOptionsShow(title String, current_directory String, root String, filename String, show_hidden bool, mode DisplayServerFileDialogMode, filters PackedStringArray, options Dictionary, callback Callable, parent_window_id int32) Error
	Beep()
	...
	ShowEmojiAndSymbolPicker()
	ColorPicker(callback Callable) bool
	ProcessEvents()
	...
	StatusIndicatorGetRect(id int32) Rect2
	DeleteStatusIndicator(id int32)
	...
	RegisterAdditionalOutput(object Object)
	UnregisterAdditionalOutput(object Object)
	HasAdditionalOutputs() bool
	IsInPipMode(window_id int32) bool
	PipModeEnter(window_id int32)
	PipModeSetAspectRatio(numerator int32, denominator int32, window_id int32)
	PipModeSetAutoEnterOnBackground(auto_enter_on_background bool, window_id int32)
}
type DrawableTexture2D interface {
	Texture2D
	SetFormat(format DrawableTexture2DDrawableFormat)
	SetUseMipmaps(mipmaps bool)
	GetUseMipmaps() bool
	Setup(width int32, height int32, format DrawableTexture2DDrawableFormat, color Color, use_mipmaps bool)
	BlitRect(rect Rect2i, source RefTexture2D, modulate Color, mipmap int32, material RefMaterial)
	BlitRectMulti(rect Rect2i, sources RefTexture2D, extra_targets RefDrawableTexture2D, modulate Color, mipmap int32, material RefMaterial)
	GenerateMipmaps()
}
...
type EditorContextMenuPlugin interface {
	RefCounted
	// TODO: Implement virtual method: Internal_PopupMenu(paths PackedStringArray,)
	AddMenuShortcut(shortcut RefShortcut, callback Callable)
	AddContextMenuItem(name String, callback Callable, icon RefTexture2D)
	AddContextMenuItemFromShortcut(name String, shortcut RefShortcut, icon RefTexture2D)
	AddContextSubmenuItem(name String, menu PopupMenu, icon RefTexture2D)
}
type EditorDebuggerPlugin interface {
	...
	// TODO: Implement virtual method: Internal_GotoScriptLine(script RefScript,line int32,)
	// TODO: Implement virtual method: Internal_BreakpointsClearedInTree()
	// TODO: Implement virtual method: Internal_BreakpointSetInTree(script RefScript,line int32,enabled bool,)
...
type EditorExportPlatform interface {
	RefCounted
	GetOsName() String
	CreatePreset() RefEditorExportPreset
	FindExportTemplate(template_file_name String) Dictionary
	GetCurrentPresets() Array
	SavePack(preset RefEditorExportPreset, debug bool, path String, embed bool) Dictionary
	SaveZip(preset RefEditorExportPreset, debug bool, path String) Dictionary
	SavePackPatch(preset RefEditorExportPreset, debug bool, path String) Dictionary
	SaveZipPatch(preset RefEditorExportPreset, debug bool, path String) Dictionary
	GenExportFlags(flags EditorExportPlatformDebugFlags) PackedStringArray
	ExportProjectFiles(preset RefEditorExportPreset, debug bool, save_cb Callable, shared_cb Callable) Error
	ExportProject(preset RefEditorExportPreset, debug bool, path String, flags EditorExportPlatformDebugFlags, notify bool) Error
	ExportPack(preset RefEditorExportPreset, debug bool, path String, flags EditorExportPlatformDebugFlags) Error
	ExportZip(preset RefEditorExportPreset, debug bool, path String, flags EditorExportPlatformDebugFlags) Error
	ExportPackPatch(preset RefEditorExportPreset, debug bool, path String, patches PackedStringArray, flags EditorExportPlatformDebugFlags) Error
	ExportZipPatch(preset RefEditorExportPreset, debug bool, path String, patches PackedStringArray, flags EditorExportPlatformDebugFlags) Error
	ClearMessages()
	AddMessage(typeName EditorExportPlatformExportMessageType, category String, message String)
	GetMessageCount() int32
	GetMessageType(index int32) EditorExportPlatformExportMessageType
	GetMessageCategory(index int32) String
	GetMessageText(index int32) String
	GetWorstMessageType() EditorExportPlatformExportMessageType
	SshRunOnRemote(host String, port String, ssh_arg PackedStringArray, cmd_args String, output Array, port_fwd int32) Error
	SshRunOnRemoteNoWait(host String, port String, ssh_args PackedStringArray, cmd_args String, port_fwd int32) int64
	SshPushToRemote(host String, port String, scp_args PackedStringArray, src_file String, dst_file String) Error
	GetInternalExportFiles(preset RefEditorExportPreset, debug bool) Dictionary
	GetForcedExportFiles(preset RefEditorExportPreset) PackedStringArray
}
type EditorExportPlatformAndroid interface {
	EditorExportPlatform
}
type EditorExportPlatformAppleEmbedded interface {
	EditorExportPlatform
}
type EditorExportPlatformExtension interface {
	EditorExportPlatform
	// TODO: Implement virtual method: Internal_GetPresetFeatures(preset RefEditorExportPreset,) PackedStringArray
	// TODO: Implement virtual method: Internal_IsExecutable(path String,) bool
	// TODO: Implement virtual method: Internal_GetExportOptions() Dictionary
	// TODO: Implement virtual method: Internal_ShouldUpdateExportOptions() bool
	// TODO: Implement virtual method: Internal_GetExportOptionVisibility(preset RefEditorExportPreset,option String,) bool
	// TODO: Implement virtual method: Internal_GetExportOptionWarning(preset RefEditorExportPreset,option StringName,) String
	// TODO: Implement virtual method: Internal_GetOsName() String
	// TODO: Implement virtual method: Internal_GetName() String
	// TODO: Implement virtual method: Internal_GetLogo() RefTexture2D
	// TODO: Implement virtual method: Internal_PollExport() bool
	// TODO: Implement virtual method: Internal_GetOptionsCount() int32
	// TODO: Implement virtual method: Internal_GetOptionsTooltip() String
	// TODO: Implement virtual method: Internal_GetOptionIcon(device int32,) RefTexture2D
	// TODO: Implement virtual method: Internal_GetOptionLabel(device int32,) String
	// TODO: Implement virtual method: Internal_GetOptionTooltip(device int32,) String
	// TODO: Implement virtual method: Internal_GetDeviceArchitecture(device int32,) String
	// TODO: Implement virtual method: Internal_Cleanup()
	// TODO: Implement virtual method: Internal_Run(preset RefEditorExportPreset,device int32,debug_flags EditorExportPlatformDebugFlags,) Error
	// TODO: Implement virtual method: Internal_GetRunIcon() RefTexture2D
	// TODO: Implement virtual method: Internal_CanExport(preset RefEditorExportPreset,debug bool,) bool
	// TODO: Implement virtual method: Internal_HasValidExportConfiguration(preset RefEditorExportPreset,debug bool,) bool
	// TODO: Implement virtual method: Internal_HasValidProjectConfiguration(preset RefEditorExportPreset,) bool
	// TODO: Implement virtual method: Internal_GetBinaryExtensions(preset RefEditorExportPreset,) PackedStringArray
	// TODO: Implement virtual method: Internal_ExportProject(preset RefEditorExportPreset,debug bool,path String,flags EditorExportPlatformDebugFlags,) Error
	// TODO: Implement virtual method: Internal_ExportPack(preset RefEditorExportPreset,debug bool,path String,flags EditorExportPlatformDebugFlags,) Error
	// TODO: Implement virtual method: Internal_ExportZip(preset RefEditorExportPreset,debug bool,path String,flags EditorExportPlatformDebugFlags,) Error
	// TODO: Implement virtual method: Internal_ExportPackPatch(preset RefEditorExportPreset,debug bool,path String,patches PackedStringArray,flags EditorExportPlatformDebugFlags,) Error
	...
	GetConfigMissingTemplates() bool
}
...
type EditorExportPlatformVisionOS interface {
	EditorExportPlatformAppleEmbedded
}
...
type EditorExportPlugin interface {
	...
	// TODO: Implement virtual method: Internal_EndGenerateAppleEmbeddedProject(path String,will_build_archive bool,)
	...
	// TODO: Implement virtual method: Internal_GetExportOptionsOverrides(platform RefEditorExportPlatform,) Dictionary
	// TODO: Implement virtual method: Internal_ShouldUpdateExportOptions(platform RefEditorExportPlatform,) bool
	// TODO: Implement virtual method: Internal_GetExportOptionVisibility(platform RefEditorExportPlatform,option String,) bool
	...
	// TODO: Implement virtual method: Internal_UpdateAndroidPrebuiltManifest(platform RefEditorExportPlatform,manifest_data PackedByteArray,) PackedByteArray
	AddSharedObject(path String, tags PackedStringArray, target String)
	AddFile(path String, file PackedByteArray, remap bool)
	AddAppleEmbeddedPlatformProjectStaticLib(path String)
	AddAppleEmbeddedPlatformFramework(path String)
	AddAppleEmbeddedPlatformEmbeddedFramework(path String)
	AddAppleEmbeddedPlatformPlistContent(plist_content String)
	AddAppleEmbeddedPlatformLinkerFlags(flags String)
	AddAppleEmbeddedPlatformBundleFile(path String)
	AddAppleEmbeddedPlatformCppCode(code String)
	...
	GetExportPreset() RefEditorExportPreset
	GetExportPlatform() RefEditorExportPlatform
}
type EditorExportPreset interface {
	RefCounted
	Has(property StringName) bool
	GetFilesToExport() PackedStringArray
	GetCustomizedFiles() Dictionary
	GetCustomizedFilesCount() int32
	HasExportFile(path String) bool
	GetFileExportMode(path String, defaultName EditorExportPresetFileExportMode) EditorExportPresetFileExportMode
	GetProjectSetting(name StringName) Variant
	GetPresetName() String
	IsRunnable() bool
	AreAdvancedOptionsEnabled() bool
	IsDedicatedServer() bool
	GetExportFilter() EditorExportPresetExportFilter
...
type EditorFileSystemImportFormatSupportQuery interface {
	RefCounted
	// TODO: Implement virtual method: Internal_IsActive() bool
	// TODO: Implement virtual method: Internal_GetFileExtensions() PackedStringArray
	// TODO: Implement virtual method: Internal_Query() bool
...
type EditorImportPlugin interface {
	...
	// TODO: Implement virtual method: Internal_GetFormatVersion() int32
...
type EditorInspector interface {
	...
	ExpandAllFolding()
	ExpandRevertable()
	InstantiatePropertyEditor(object Object, typeName VariantType, path String, hint PropertyHint, hint_text String, usage uint32, wide bool) EditorProperty
	CreateDefaultInspector(filter_line_edit LineEdit) EditorInspector
}
...
type EditorInterface interface {
	...
	PopupNodeSelector(callback Callable, valid_types StringName, current_value Node)
	PopupPropertySelector(object Object, callback Callable, type_filter PackedInt32Array, current_value String)
	PopupMethodSelector(object Object, callback Callable, current_value String)
	PopupQuickOpen(callback Callable, base_types StringName)
	PopupCreateDialog(callback Callable, base_type StringName, current_type String, dialog_title String, type_blocklist StringName)
	...
	GetUnsavedScenes() PackedStringArray
...
type EditorNode3DGizmoPlugin interface {
	...
	// TODO: Implement virtual method: Internal_CanCommitHandleOnClick() bool
...
type EditorPlugin interface {
	...
	AddExportPlatform(platform RefEditorExportPlatform)
	RemoveExportPlatform(platform RefEditorExportPlatform)
	...
	AddContextMenuPlugin(slot EditorContextMenuPluginContextMenuSlot, plugin RefEditorContextMenuPlugin)
	RemoveContextMenuPlugin(plugin RefEditorContextMenuPlugin)
...
type EditorProperty interface {
	...
	IsReadOnly() bool
	SetDrawLabel(draw_label bool)
	IsDrawLabel() bool
	SetDrawBackground(draw_background bool)
	IsDrawBackground() bool
	...
	IsSelectable() bool
	SetUseFolding(use_folding bool)
	IsUsingFolding() bool
	SetNameSplitRatio(ratio float32)
	GetNameSplitRatio() float32
	Deselect()
	IsSelected() bool
	Select(focusable int32)
	SetObjectAndProperty(object Object, property StringName)
	SetLabelReference(control Control)
...
type EditorResourceConversionPlugin interface {
	RefCounted
	// TODO: Implement virtual method: Internal_ConvertsTo() String
	// TODO: Implement virtual method: Internal_Handles(resource RefResource,) bool
	// TODO: Implement virtual method: Internal_Convert(resource RefResource,) RefResource
...
type EditorResourcePreviewGenerator interface {
	...
	// TODO: Implement virtual method: Internal_Generate(resource RefResource,size Vector2i,metadata Dictionary,) RefTexture2D
...
type EditorSceneFormatImporter interface {
	RefCounted
	// TODO: Implement virtual method: Internal_GetExtensions() PackedStringArray
	// TODO: Implement virtual method: Internal_ImportScene(path String,flags uint32,options Dictionary,) Object
...
type EditorSceneFormatImporterFBX2GLTF interface {
	EditorSceneFormatImporter
}
type EditorSceneFormatImporterGLTF interface {
	EditorSceneFormatImporter
}
type EditorSceneFormatImporterUFBX interface {
	EditorSceneFormatImporter
}
...
type EditorSpinSlider interface {
	...
	IsEditingInteger() bool
	SetDeferredDragModeEnabled(enabled bool)
	IsDeferredDragModeEnabled() bool
}
type EditorSyntaxHighlighter interface {
	SyntaxHighlighter
	// TODO: Implement virtual method: Internal_GetName() String
	// TODO: Implement virtual method: Internal_GetSupportedLanguages() PackedStringArray
	// TODO: Implement virtual method: Internal_Create() RefEditorSyntaxHighlighter

}
type EditorToaster interface {
	HBoxContainer
	PushToast(message String, severity EditorToasterSeverity, tooltip String)
}
type EditorTranslationParserPlugin interface {
	RefCounted
	// TODO: Implement virtual method: Internal_ParseFile(path String,) PackedStringArray
	// TODO: Implement virtual method: Internal_GetRecognizedExtensions() PackedStringArray
	// TODO: Implement virtual method: Internal_CustomizeStrings(strings PackedStringArray,) PackedStringArray

}
type EditorUndoRedoManager interface {
	Object
	CreateAction(name String, merge_mode UndoRedoMergeMode, custom_context Object, backward_undo_ops bool, mark_unsaved bool)
	...
	ClearHistory(id int32, increase_version bool)
}
type EditorVCSInterface interface {
	...
	// TODO: Implement virtual method: Internal_Commit(msg String,amend bool,)
	// TODO: Implement virtual method: Internal_AllowAmends() bool
...
type Engine interface {
	...
	CaptureScriptBacktraces(include_variables bool) RefScriptBacktrace
	IsEditorHint() bool
	IsEmbeddedInEditor() bool
	GetWriteMoviePath() String
	SetPrintToStdout(enabled bool)
	IsPrintingToStdout() bool
...
type EngineProfiler interface {
	RefCounted
	// TODO: Implement virtual method: Internal_Toggle(enable bool,options Array,)
	// TODO: Implement virtual method: Internal_AddFrame(data Array,)
	// TODO: Implement virtual method: Internal_Tick(frame_time float64,process_time float64,physics_time float64,physics_frame_time float64,)
...
type Environment interface {
	...
	IsFogEnabled() bool
	SetFogMode(mode EnvironmentFogMode)
	GetFogMode() EnvironmentFogMode
	...
	SetFogDepthBegin(begin float32)
	GetFogDepthBegin() float32
	SetFogDepthEnd(end float32)
...
type FBXState interface {
	GLTFState
	GetAllowGeometryHelperNodes() bool
	SetAllowGeometryHelperNodes(allow bool)
}
...
type FileAccess interface {
	...
	OpenEncrypted(path String, mode_flags FileAccessModeFlags, key PackedByteArray, iv PackedByteArray) RefFileAccess
	...
	Store8(value uint8) bool
	Store16(value uint16) bool
	Store32(value uint32) bool
	Store64(value uint64) bool
	StoreHalf(value float32) bool
	StoreFloat(value float32) bool
	StoreDouble(value float64) bool
	StoreReal(value float32) bool
	StoreBuffer(buffer PackedByteArray) bool
	StoreLine(line String) bool
	StoreCsvLine(values PackedStringArray, delim String) bool
	StoreString(strValue String) bool
	StoreVar(value Variant, full_objects bool) bool
	StorePascalString(strValue String) bool
	GetPascalString() String
	Close()
	FileExists(path String) bool
	GetModifiedTime(file String) uint64
	GetAccessTime(file String) uint64
	GetSize(file String) int64
...
type FileDialog interface {
	...
	SetDisplayMode(mode FileDialogDisplayMode)
	GetDisplayMode() FileDialogDisplayMode
...
type FlowContainer interface {
	...
	SetLastWrapAlignment(last_wrap_alignment FlowContainerLastWrapAlignmentMode)
	GetLastWrapAlignment() FlowContainerLastWrapAlignmentMode
	SetVertical(vertical bool)
	IsVertical() bool
	SetReverseFill(reverse_fill bool)
	IsReverseFill() bool
}
...
type FoldableContainer interface {
	Container
	Fold()
	Expand()
	SetFolded(folded bool)
	IsFolded() bool
	SetFoldableGroup(button_group RefFoldableGroup)
	GetFoldableGroup() RefFoldableGroup
	SetTitle(text String)
	GetTitle() String
	SetTitleAlignment(alignment HorizontalAlignment)
	GetTitleAlignment() HorizontalAlignment
	SetLanguage(language String)
	GetLanguage() String
	SetTitleTextDirection(text_direction ControlTextDirection)
	GetTitleTextDirection() ControlTextDirection
	SetTitleTextOverrunBehavior(overrun_behavior TextServerOverrunBehavior)
	GetTitleTextOverrunBehavior() TextServerOverrunBehavior
	SetTitlePosition(title_position FoldableContainerTitlePosition)
	GetTitlePosition() FoldableContainerTitlePosition
	AddTitleBarControl(control Control)
	RemoveTitleBarControl(control Control)
}
type FoldableGroup interface {
	Resource
	GetExpandedContainer() FoldableContainer
	GetContainers() FoldableContainer
	SetAllowFoldingAll(enabled bool)
	IsAllowFoldingAll() bool
}
type Font interface {
	Resource
	SetFallbacks(fallbacks RefFont)
	GetFallbacks() RefFont
	FindVariation(variation_coordinates Dictionary, face_index int32, strength float32, transform Transform2D, spacing_top int32, spacing_bottom int32, spacing_space int32, spacing_glyph int32, baseline_offset float32, palette_index int64, custom_colors PackedColorArray) RID
	GetRids() RID
	...
	GetPaletteCount() int64
	GetPaletteName(index int64) String
	GetPaletteColors(index int64) PackedColorArray
	...
	DrawString(canvas_item RID, pos Vector2, text String, alignment HorizontalAlignment, width float32, font_size int32, modulate Color, justification_flags TextServerJustificationFlag, direction TextServerDirection, orientation TextServerOrientation, oversampling float32)
	DrawMultilineString(canvas_item RID, pos Vector2, text String, alignment HorizontalAlignment, width float32, font_size int32, max_lines int32, modulate Color, brk_flags TextServerLineBreakFlag, justification_flags TextServerJustificationFlag, direction TextServerDirection, orientation TextServerOrientation, oversampling float32)
	DrawStringOutline(canvas_item RID, pos Vector2, text String, alignment HorizontalAlignment, width float32, font_size int32, size int32, modulate Color, justification_flags TextServerJustificationFlag, direction TextServerDirection, orientation TextServerOrientation, oversampling float32)
	DrawMultilineStringOutline(canvas_item RID, pos Vector2, text String, alignment HorizontalAlignment, width float32, font_size int32, max_lines int32, size int32, modulate Color, brk_flags TextServerLineBreakFlag, justification_flags TextServerJustificationFlag, direction TextServerDirection, orientation TextServerOrientation, oversampling float32)
	GetCharSize(char Char32T, font_size int32) Vector2
	DrawChar(canvas_item RID, pos Vector2, char Char32T, font_size int32, modulate Color, oversampling float32) float32
	DrawCharOutline(canvas_item RID, pos Vector2, char Char32T, font_size int32, size int32, modulate Color, oversampling float32) float32
	HasChar(char Char32T) bool
...
type FontFile interface {
	...
	SetDisableEmbeddedBitmaps(disable_embedded_bitmaps bool)
	GetDisableEmbeddedBitmaps() bool
	...
	SetModulateColorGlyphs(modulate bool)
	IsModulateColorGlyphs() bool
	...
	SetKeepRoundingRemainders(keep_rounding_remainders bool)
	GetKeepRoundingRemainders() bool
	...
	SetExtraBaselineOffset(cache_index int32, baseline_offset float32)
	GetExtraBaselineOffset(cache_index int32) float32
	...
	RenderRange(cache_index int32, size Vector2i, start Char32T, end Char32T)
	...
	GetGlyphIndex(size int32, char Char32T, variation_selector Char32T) int32
	GetCharFromGlyphIndex(size int32, glyph_index int32) Char32T
}
type FontVariation interface {
	...
	SetBaselineOffset(baseline_offset float32)
	GetBaselineOffset() float32
	GetPaletteIndex() int64
	SetPaletteIndex(palette_index int64)
	GetPaletteCustomColors() PackedColorArray
	SetPaletteCustomColors(colors PackedColorArray)
}
type FramebufferCacheRD interface {
	Object
	GetCacheMultipass(textures RID, passes RefRDFramebufferPass, views uint32) RID
}
...
type GDScriptLanguageProtocol interface {
	JSONRPC
	GetTextDocument() RefGDScriptTextDocument
	GetWorkspace() RefGDScriptWorkspace
	IsSmartResolveEnabled() bool
	IsInitialized() bool
	Initialize(params Dictionary) Variant
	Initialized(params Variant)
	OnClientConnected() Error
	OnClientDisconnected(client_id int32)
	NotifyClient(method String, params Variant, client_id int32)
}
type GDScriptSyntaxHighlighter interface {
	EditorSyntaxHighlighter
}
type GDScriptTextDocument interface {
	RefCounted
	ShowNativeSymbolInEditor(symbol_id String)
	...
	NativeSymbol(params Dictionary) Variant
	DocumentSymbol(params Dictionary) Array
	Completion(params Dictionary) Array
	Resolve(params Dictionary) Dictionary
	Rename(params Dictionary) Dictionary
	PrepareRename(params Dictionary) Variant
	References(params Dictionary) Array
	FoldingRange(params Dictionary) Array
	CodeLens(params Dictionary) Array
	DocumentLink(params Dictionary) Array
	ColorPresentation(params Dictionary) Array
	Hover(params Dictionary) Variant
	Definition(params Dictionary) Array
	Declaration(params Dictionary) Variant
	SignatureHelp(params Dictionary) Variant
}
type GDScriptWorkspace interface {
	RefCounted
	ApplyNewSignal(obj Object, function String, args PackedStringArray)
	GetFilePath(uri String) String
	GetFileUri(path String) String
	GenerateScriptApi(path String) Dictionary
	DidDeleteFiles(params Dictionary)
	ParseScript(path String, content String) Error
	ParseLocalScript(path String) Error
	PublishDiagnostics(path String)
}
type GLTFAccessor interface {
	...
	GetComponentType() GLTFAccessorGLTFComponentType
	SetComponentType(component_type GLTFAccessorGLTFComponentType)
	GetNormalized() bool
	SetNormalized(normalized bool)
	GetCount() int64
	SetCount(count int64)
	GetAccessorType() GLTFAccessorGLTFAccessorType
	SetAccessorType(accessor_type GLTFAccessorGLTFAccessorType)
	GetType() int32
	...
	GetSparseIndicesComponentType() GLTFAccessorGLTFComponentType
	SetSparseIndicesComponentType(sparse_indices_component_type GLTFAccessorGLTFComponentType)
...
type GLTFBufferView interface {
	...
	GetVertexAttributes() bool
	SetVertexAttributes(is_attributes bool)
}
...
type GLTFDocument interface {
	...
	SetFallbackImageFormat(fallback_image_format String)
	GetFallbackImageFormat() String
	SetFallbackImageQuality(fallback_image_quality float32)
	GetFallbackImageQuality() float32
	SetRootNodeMode(root_node_mode GLTFDocumentRootNodeMode)
	GetRootNodeMode() GLTFDocumentRootNodeMode
	SetTextureMapMode(texture_map_mode GLTFDocumentTextureMapMode)
	GetTextureMapMode() GLTFDocumentTextureMapMode
	SetVisibilityMode(visibility_mode GLTFDocumentVisibilityMode)
	GetVisibilityMode() GLTFDocumentVisibilityMode
	...
	ImportObjectModelProperty(state RefGLTFState, json_pointer String) RefGLTFObjectModelProperty
	ExportObjectModelProperty(state RefGLTFState, node_path NodePath, godot_node Node, gltf_node_index int32) RefGLTFObjectModelProperty
	...
	GetSupportedGltfExtensions() PackedStringArray
}
type GLTFDocumentExtension interface {
	Resource
	// TODO: Implement virtual method: Internal_ImportPreflight(state RefGLTFState,extensions PackedStringArray,) Error
	// TODO: Implement virtual method: Internal_GetSupportedExtensions() PackedStringArray
	// TODO: Implement virtual method: Internal_ParseNodeExtensions(state RefGLTFState,gltf_node RefGLTFNode,extensions Dictionary,) Error
	// TODO: Implement virtual method: Internal_ParseImageData(state RefGLTFState,image_data PackedByteArray,mime_type String,ret_image RefImage,) Error
	// TODO: Implement virtual method: Internal_GetImageFileExtension() String
	// TODO: Implement virtual method: Internal_ParseTextureJson(state RefGLTFState,texture_json Dictionary,ret_gltf_texture RefGLTFTexture,) Error
	// TODO: Implement virtual method: Internal_ImportObjectModelProperty(state RefGLTFState,split_json_pointer PackedStringArray,partial_paths NodePath,) RefGLTFObjectModelProperty
	// TODO: Implement virtual method: Internal_ImportPostParse(state RefGLTFState,) Error
	// TODO: Implement virtual method: Internal_ImportPreGenerate(state RefGLTFState,) Error
	// TODO: Implement virtual method: Internal_GenerateSceneNode(state RefGLTFState,gltf_node RefGLTFNode,scene_parent Node,) Node3D
	// TODO: Implement virtual method: Internal_ImportNode(state RefGLTFState,gltf_node RefGLTFNode,json Dictionary,node Node,) Error
	// TODO: Implement virtual method: Internal_ImportPost(state RefGLTFState,root Node,) Error
	// TODO: Implement virtual method: Internal_ExportGetPropertyList(root_node Node,) Dictionary
	// TODO: Implement virtual method: Internal_ExportPreflight(state RefGLTFState,root Node,) Error
	// TODO: Implement virtual method: Internal_ConvertSceneNode(state RefGLTFState,gltf_node RefGLTFNode,scene_node Node,)
	// TODO: Implement virtual method: Internal_ExportPostConvert(state RefGLTFState,root Node,) Error
	// TODO: Implement virtual method: Internal_ExportPreserialize(state RefGLTFState,) Error
	// TODO: Implement virtual method: Internal_ExportObjectModelProperty(state RefGLTFState,node_path NodePath,godot_node Node,gltf_node_index int32,target_object Object,target_depth int32,) RefGLTFObjectModelProperty
	// TODO: Implement virtual method: Internal_GetSaveableImageFormats() PackedStringArray
	// TODO: Implement virtual method: Internal_SerializeImageToBytes(state RefGLTFState,image RefImage,image_dict Dictionary,image_format String,lossy_quality float32,) PackedByteArray
	// TODO: Implement virtual method: Internal_SaveImageAtPath(state RefGLTFState,image RefImage,file_path String,image_format String,lossy_quality float32,) Error
	// TODO: Implement virtual method: Internal_SerializeTextureJson(state RefGLTFState,texture_json Dictionary,gltf_texture RefGLTFTexture,image_format String,) Error
	// TODO: Implement virtual method: Internal_ExportNode(state RefGLTFState,gltf_node RefGLTFNode,json Dictionary,node Node,) Error
	// TODO: Implement virtual method: Internal_ExportPost(state RefGLTFState,) Error
...
type GLTFNode interface {
	...
	AppendChildIndex(child_index int32)
	GetLight() int32
	...
	GetAdditionalData(extension_name StringName) Variant
	SetAdditionalData(extension_name StringName, additional_data Variant)
	GetSceneNodePath(gltf_state RefGLTFState, handle_skeletons bool) NodePath
}
type GLTFObjectModelProperty interface {
	RefCounted
	AppendNodePath(node_path NodePath)
	AppendPathToProperty(node_path NodePath, prop_name StringName)
	GetAccessorType() GLTFAccessorGLTFAccessorType
	GetGltfToGodotExpression() RefExpression
	SetGltfToGodotExpression(gltf_to_godot_expr RefExpression)
	GetGodotToGltfExpression() RefExpression
	SetGodotToGltfExpression(godot_to_gltf_expr RefExpression)
	GetNodePaths() NodePath
	HasNodePaths() bool
	SetNodePaths(node_paths NodePath)
	GetObjectModelType() GLTFObjectModelPropertyGLTFObjectModelType
	SetObjectModelType(typeName GLTFObjectModelPropertyGLTFObjectModelType)
	GetJsonPointers() PackedStringArray
	HasJsonPointers() bool
	SetJsonPointers(json_pointers PackedStringArray)
	GetVariantType() VariantType
	SetVariantType(variant_type VariantType)
	SetTypes(variant_type VariantType, obj_model_type GLTFObjectModelPropertyGLTFObjectModelType)
}
type GLTFPhysicsBody interface {
	...
	GetInertiaDiagonal() Vector3
	SetInertiaDiagonal(inertia_diagonal Vector3)
	GetInertiaOrientation() Quaternion
	SetInertiaOrientation(inertia_orientation Quaternion)
...
type GLTFPhysicsShape interface {
	...
	FromResource(shape_resource RefShape3D) RefGLTFPhysicsShape
	ToResource(cache_shapes bool) RefShape3D
...
type GLTFState interface {
	...
	AppendGltfNode(gltf_node RefGLTFNode, godot_scene_node Node, parent_node_index int32) int32
	GetJson() Dictionary
...
type GPUParticles3D interface {
	...
	SetTransformAlignChannelFilter(channel_filter RenderingServerParticlesTransformAlignCustomSrc)
	GetTransformAlignChannelFilter() RenderingServerParticlesTransformAlignCustomSrc
	SetTransformAlignAxis(align RenderingServerParticlesTransformAlignAxis)
	GetTransformAlignAxis() RenderingServerParticlesTransformAlignAxis
	ConvertFromParticles(particles Node)
	SetAmountRatio(ratio float32)
	GetAmountRatio() float32
	RequestParticlesProcess(process_time float32, process_time_residual float32)
...
type GPUParticlesCollisionHeightField3D interface {
	...
	SetHeightfieldMask(heightfield_mask uint32)
	GetHeightfieldMask() uint32
	SetHeightfieldMaskValue(layer_number int32, value bool)
	GetHeightfieldMaskValue(layer_number int32) bool
...
type Geometry2D interface {
	...
	BresenhamLine(from Vector2i, to Vector2i) Vector2i
}
...
type GeometryInstance3D interface {
	...
	SetLightmapTexelScale(scale float32)
	GetLightmapTexelScale() float32
...
type GraphEdit interface {
	...
	ConnectNode(from_node StringName, from_port int32, to_node StringName, to_port int32, keep_alive bool) Error
	...
	SetConnections(connections Dictionary)
	GetConnectionList() Dictionary
	GetConnectionCount(from_node StringName, from_port int32) int32
	GetClosestConnectionAtPoint(point Vector2, max_distance float32) Dictionary
	GetConnectionListFromNode(node StringName) Dictionary
	...
	IsShowingGrid() bool
	SetGridPattern(pattern GraphEditGridPattern)
	GetGridPattern() GraphEditGridPattern
	...
	SetTypeNames(type_names Dictionary)
	GetTypeNames() Dictionary
...
type GraphFrame interface {
	...
	SetAutoshrinkEnabled(shrink bool)
	IsAutoshrinkEnabled() bool
	SetAutoshrinkMargin(autoshrink_margin int32)
	GetAutoshrinkMargin() int32
	SetDragMargin(drag_margin int32)
	GetDragMargin() int32
	SetTintColorEnabled(enable bool)
	IsTintColorEnabled() bool
...
type GraphNode interface {
	...
	IsIgnoringValidConnectionType() bool
	SetSlotsFocusMode(focus_mode ControlFocusMode)
	GetSlotsFocusMode() ControlFocusMode
...
type GridMap interface {
	...
	SetCollisionPriority(priority float32)
	GetCollisionPriority() float32
	SetCollisionVisibilityMode(visibility_mode GridMapDebugVisibilityMode)
	GetCollisionVisibilityMode() GridMapDebugVisibilityMode
	...
	GetUsedOctants() Vector3i
	GetUsedOctantsByItem(item int32) Vector3i
	GetUsedCellsInOctant(octant_coords Vector3i) Vector3i
	GetUsedCellsInOctantByItem(octant_coords Vector3i, item int32) Vector3i
	GetOctantsInBounds(bounds AABB) Vector3i
	GetUsedOctantsInBounds(bounds AABB) Vector3i
	GetOctantCoordsFromCellCoords(cell_coords Vector3i) Vector3i
	GetMeshes() Array
	GetBakeMeshes() Array
...
type GridMapEditorPlugin interface {
	EditorPlugin
	GetCurrentGridMap() GridMap
	SetSelection(begin Vector3i, end Vector3i)
	ClearSelection()
	GetSelection() AABB
	HasSelection() bool
	GetSelectedCells() Array
	SetSelectedPaletteItem(item int32)
	GetSelectedPaletteItem() int32
}
...
type HeightMapShape3D interface {
	...
	GetMinHeight() float32
	GetMaxHeight() float32
	UpdateMapDataFromImage(image RefImage, height_min float32, height_max float32)
}
...
type Image interface {
	...
	GetMipmapOffset(mipmap int32) int64
	...
	CreateEmpty(width int32, height int32, use_mipmaps bool, format ImageFormat) RefImage
	...
	SaveExr(path String, grayscale bool, color_image bool, max_linear_value float32) Error
	SaveExrToBuffer(grayscale bool, color_image bool, max_linear_value float32) PackedByteArray
	SaveDds(path String) Error
...
type ImporterMesh interface {
	Resource
	MergeImporterMeshes(importer_meshes RefImporterMesh, relative_transforms Transform3D, deduplicate_surfaces bool) RefImporterMesh
...
type Input interface {
	...
	IsActionJustPressedByEvent(action StringName, event RefInputEvent, exact_match bool) bool
	IsActionJustReleasedByEvent(action StringName, event RefInputEvent, exact_match bool) bool
	...
	GetJoyVibrationRemainingDuration(device int32) float32
	IsJoyVibrating(device int32) bool
	HasJoyVibration(device int32) bool
	...
	VibrateHandheld(duration_ms int32, amplitude float32)
	SetIgnoreJoypadOnUnfocusedApplication(enable bool)
	IsIgnoringJoypadOnUnfocusedApplication() bool
	GetGravity() Vector3
	GetAccelerometer() Vector3
	GetMagnetometer() Vector3
	GetGyroscope() Vector3
	GetJoyAccelerometer(device int32) Vector3
	GetJoyGravity(device int32) Vector3
	GetJoyGyroscope(device int32) Vector3
	GetJoyMotionSensorsRate(device int32) float32
	IsJoyMotionSensorsEnabled(device int32) bool
	SetJoyMotionSensorsEnabled(device int32, enable bool)
	HasJoyMotionSensors(device int32) bool
	StartJoyMotionSensorsCalibration(device int32)
	StopJoyMotionSensorsCalibration(device int32)
	ClearJoyMotionSensorsCalibration(device int32)
	GetJoyMotionSensorsCalibration(device int32) Dictionary
	SetJoyMotionSensorsCalibration(device int32, calibration_info Dictionary)
	IsJoyMotionSensorsCalibrated(device int32) bool
	IsJoyMotionSensorsCalibrating(device int32) bool
	...
	FlushBufferedEvents()
	SetEmulateMouseFromTouch(enable bool)
	IsEmulatingMouseFromTouch() bool
	SetEmulateTouchFromMouse(enable bool)
	IsEmulatingTouchFromMouse() bool
}
...
type InputEventKey interface {
	...
	GetKeyLabel() Key
	SetUnicode(unicode Char32T)
	GetUnicode() Char32T
	SetLocation(location KeyLocation)
	GetLocation() KeyLocation
	SetEcho(echo bool)
...
type InputEventMouseMotion interface {
	...
	GetRelative() Vector2
	SetScreenRelative(relative Vector2)
	GetScreenRelative() Vector2
	SetVelocity(velocity Vector2)
	GetVelocity() Vector2
	SetScreenVelocity(velocity Vector2)
	GetScreenVelocity() Vector2
}
...
type InputMap interface {
	...
	GetActionDescription(action StringName) String
...
type ItemList interface {
	...
	SetItemAutoTranslateMode(idx int32, mode NodeAutoTranslateMode)
	GetItemAutoTranslateMode(idx int32) NodeAutoTranslateMode
	...
	CenterOnCurrent(center_verically bool, center_horizontally bool)
...
type JSON interface {
	...
	FromNative(variant Variant, full_objects bool) Variant
	ToNative(json Variant, allow_objects bool) Variant
}
type JSONRPC interface {
	Object
	SetMethod(name String, callback Callable)
...
type JavaClassWrapper interface {
	...
	GetException() RefJavaObject
	CreateSamCallback(sam_interface String, callable Callable) RefJavaObject
	CreateProxy(object Object, interfaces PackedStringArray) RefJavaObject
}
...
type JavaScriptBridge interface {
	...
	IsJsBuffer(javascript_object RefJavaScriptObject) bool
	JsBufferToPackedByteArray(javascript_buffer RefJavaScriptObject) PackedByteArray
...
type Label interface {
	...
	SetLanguage(language String)
	GetLanguage() String
	SetParagraphSeparator(paragraph_separator String)
	...
	GetCharacterBounds(pos int32) Rect2
}
...
type LabelSettings interface {
	...
	GetLineSpacing() float32
	SetParagraphSpacing(spacing float32)
	GetParagraphSpacing() float32
	SetFont(font RefFont)
	GetFont() RefFont
	SetFontSize(size int32)
	GetFontSize() int32
	...
	GetStackedOutlineCount() int32
	SetStackedOutlineCount(count int32)
	AddStackedOutline(index int32)
	MoveStackedOutline(from_index int32, to_position int32)
	RemoveStackedOutline(index int32)
	SetStackedOutlineSize(index int32, size int32)
	GetStackedOutlineSize(index int32) int32
	SetStackedOutlineColor(index int32, color Color)
	GetStackedOutlineColor(index int32) Color
	GetStackedShadowCount() int32
	SetStackedShadowCount(count int32)
	AddStackedShadow(index int32)
	MoveStackedShadow(from_index int32, to_position int32)
	RemoveStackedShadow(index int32)
	SetStackedShadowOffset(index int32, offset Vector2)
	GetStackedShadowOffset(index int32) Vector2
	SetStackedShadowColor(index int32, color Color)
	GetStackedShadowColor(index int32) Color
	SetStackedShadowOutlineSize(index int32, size int32)
	GetStackedShadowOutlineSize(index int32) int32
}
...
type Light3D interface {
	...
	SetShadowCasterMask(caster_mask uint32)
	GetShadowCasterMask() uint32
...
type LightmapGI interface {
	...
	SetTexelScale(texel_scale float32)
	GetTexelScale() float32
	SetMaxTextureSize(max_texture_size int32)
	GetMaxTextureSize() int32
	SetSupersamplingEnabled(enable bool)
	IsSupersamplingEnabled() bool
	SetSupersamplingFactor(factor float32)
	GetSupersamplingFactor() float32
	...
	SetDenoiserRange(denoiser_range int32)
	GetDenoiserRange() int32
	SetInterior(enable bool)
	IsInterior() bool
	SetDirectional(directional bool)
	IsDirectional() bool
	SetShadowmaskMode(mode LightmapGIDataShadowmaskMode)
	GetShadowmaskMode() LightmapGIDataShadowmaskMode
...
type LightmapGIData interface {
	...
	SetShadowmaskTextures(shadowmask_textures RefTextureLayered)
	GetShadowmaskTextures() RefTextureLayered
...
type LineEdit interface {
	...
	IsEditingKeptOnTextSubmit() bool
	Clear()
	...
	GetNextCompositeCharacterColumn(column int32) int32
	GetPreviousCompositeCharacterColumn(column int32) int32
	...
	SetEmojiMenuEnabled(enable bool)
	IsEmojiMenuEnabled() bool
	SetBackspaceDeletesCompositeCharacterEnabled(enable bool)
	IsBackspaceDeletesCompositeCharacterEnabled() bool
	SetVirtualKeyboardEnabled(enable bool)
	IsVirtualKeyboardEnabled() bool
	SetVirtualKeyboardShowOnFocus(show_on_focus bool)
	GetVirtualKeyboardShowOnFocus() bool
...
type Logger interface {
	RefCounted
	// TODO: Implement virtual method: Internal_LogError(function String,file String,line int32,code String,rationale String,editor_notify bool,error_type int32,script_backtraces RefScriptBacktrace,)
	// TODO: Implement virtual method: Internal_LogMessage(message String,error bool,)

}
type LookAtModifier3D interface {
	SkeletonModifier3D
	SetTargetNode(target_node NodePath)
	GetTargetNode() NodePath
	SetBoneName(bone_name String)
	GetBoneName() String
	SetBone(bone int32)
	GetBone() int32
	SetForwardAxis(forward_axis SkeletonModifier3DBoneAxis)
	GetForwardAxis() SkeletonModifier3DBoneAxis
	SetPrimaryRotationAxis(axis Vector3Axis)
	...
	GetOriginFrom() LookAtModifier3DOriginFrom
	SetOriginBoneName(bone_name String)
	GetOriginBoneName() String
	SetOriginBone(bone int32)
	GetOriginBone() int32
	SetOriginExternalNode(external_node NodePath)
	GetOriginExternalNode() NodePath
	SetOriginOffset(offset Vector3)
	GetOriginOffset() Vector3
	SetDuration(duration float32)
	GetDuration() float32
	SetTransitionType(transition_type TweenTransitionType)
	GetTransitionType() TweenTransitionType
	SetEaseType(ease_type TweenEaseType)
	GetEaseType() TweenEaseType
	SetUseAngleLimitation(enabled bool)
	IsUsingAngleLimitation() bool
	SetSymmetryLimitation(enabled bool)
	IsLimitationSymmetry() bool
	SetPrimaryLimitAngle(angle float32)
	GetPrimaryLimitAngle() float32
	SetPrimaryDampThreshold(power float32)
	GetPrimaryDampThreshold() float32
	SetPrimaryPositiveLimitAngle(angle float32)
	GetPrimaryPositiveLimitAngle() float32
	SetPrimaryPositiveDampThreshold(power float32)
	GetPrimaryPositiveDampThreshold() float32
	SetPrimaryNegativeLimitAngle(angle float32)
	GetPrimaryNegativeLimitAngle() float32
	SetPrimaryNegativeDampThreshold(power float32)
	GetPrimaryNegativeDampThreshold() float32
	SetSecondaryLimitAngle(angle float32)
	GetSecondaryLimitAngle() float32
	SetSecondaryDampThreshold(power float32)
	GetSecondaryDampThreshold() float32
	SetSecondaryPositiveLimitAngle(angle float32)
	GetSecondaryPositiveLimitAngle() float32
	SetSecondaryPositiveDampThreshold(power float32)
	GetSecondaryPositiveDampThreshold() float32
	SetSecondaryNegativeLimitAngle(angle float32)
	GetSecondaryNegativeLimitAngle() float32
	SetSecondaryNegativeDampThreshold(power float32)
	GetSecondaryNegativeDampThreshold() float32
	GetInterpolationRemaining() float32
	IsInterpolating() bool
	IsTargetWithinLimitation() bool
}
type MainLoop interface {
	Object
	// TODO: Implement virtual method: Internal_Initialize()
	// TODO: Implement virtual method: Internal_PhysicsProcess(delta float64,) bool
	// TODO: Implement virtual method: Internal_Process(delta float64,) bool
	// TODO: Implement virtual method: Internal_Finalize()
...
type MeshInstance3D interface {
	...
	SetSkin(skin RefSkin)
	GetSkin() RefSkin
	GetSkinReference() RefSkinReference
	...
	CreateDebugTangents()
	BakeMeshFromCurrentBlendShapeMix(existing RefArrayMesh) RefArrayMesh
	BakeMeshFromCurrentSkeletonPose(existing RefArrayMesh) RefArrayMesh
}
type MeshLibrary interface {
	...
	SetItemMeshCastShadow(id int32, shadow_casting_setting RenderingServerShadowCastingSetting)
	...
	GetItemMeshCastShadow(id int32) RenderingServerShadowCastingSetting
...
type MobileVRInterface interface {
	...
	SetOffsetRect(offset_rect Rect2)
	GetOffsetRect() Rect2
	...
	SetK2(k float64)
	GetK2() float64
	GetVrsMinRadius() float32
	SetVrsMinRadius(radius float32)
	GetVrsStrength() float32
	SetVrsStrength(strength float32)
}
type ModifierBoneTarget3D interface {
	SkeletonModifier3D
	SetBoneName(bone_name String)
	GetBoneName() String
	SetBone(bone int32)
...
type MultiMesh interface {
	...
	SetPhysicsInterpolationQuality(quality MultiMeshPhysicsInterpolationQuality)
	GetPhysicsInterpolationQuality() MultiMeshPhysicsInterpolationQuality
	...
	SetBufferInterpolated(buffer_curr PackedFloat32Array, buffer_prev PackedFloat32Array)
}
...
type MultiplayerAPIExtension interface {
	MultiplayerAPI
	// TODO: Implement virtual method: Internal_Poll() Error
	// TODO: Implement virtual method: Internal_SetMultiplayerPeer(multiplayer_peer RefMultiplayerPeer,)
	// TODO: Implement virtual method: Internal_GetMultiplayerPeer() RefMultiplayerPeer
	// TODO: Implement virtual method: Internal_GetUniqueId() int32
	// TODO: Implement virtual method: Internal_GetPeerIds() PackedInt32Array
	// TODO: Implement virtual method: Internal_Rpc(peer int32,object Object,method StringName,args Array,) Error
	// TODO: Implement virtual method: Internal_GetRemoteSenderId() int32
	// TODO: Implement virtual method: Internal_ObjectConfigurationAdd(object Object,configuration Variant,) Error
	// TODO: Implement virtual method: Internal_ObjectConfigurationRemove(object Object,configuration Variant,) Error
...
type MultiplayerPeerExtension interface {
	MultiplayerPeer
	// TODO: Implement virtual method: Internal_GetPacket(r_buffer **uint8,r_buffer_size *Int32T,) Error
	// TODO: Implement virtual method: Internal_PutPacket(buffer *uint8,buffer_size int32,) Error
	// TODO: Implement virtual method: Internal_GetAvailablePacketCount() int32
	// TODO: Implement virtual method: Internal_GetMaxPacketSize() int32
	// TODO: Implement virtual method: Internal_GetPacketScript() PackedByteArray
	// TODO: Implement virtual method: Internal_PutPacketScript(buffer PackedByteArray,) Error
	// TODO: Implement virtual method: Internal_GetPacketChannel() int32
	// TODO: Implement virtual method: Internal_GetPacketMode() MultiplayerPeerTransferMode
	// TODO: Implement virtual method: Internal_SetTransferChannel(channel int32,)
	// TODO: Implement virtual method: Internal_GetTransferChannel() int32
	// TODO: Implement virtual method: Internal_SetTransferMode(mode MultiplayerPeerTransferMode,)
	// TODO: Implement virtual method: Internal_GetTransferMode() MultiplayerPeerTransferMode
	// TODO: Implement virtual method: Internal_SetTargetPeer(peer int32,)
	// TODO: Implement virtual method: Internal_GetPacketPeer() int32
	// TODO: Implement virtual method: Internal_IsServer() bool
	// TODO: Implement virtual method: Internal_Poll()
	// TODO: Implement virtual method: Internal_Close()
	// TODO: Implement virtual method: Internal_DisconnectPeer(peer int32,force bool,)
	// TODO: Implement virtual method: Internal_GetUniqueId() int32
	// TODO: Implement virtual method: Internal_SetRefuseNewConnections(enable bool,)
	// TODO: Implement virtual method: Internal_IsRefusingNewConnections() bool
	// TODO: Implement virtual method: Internal_IsServerRelaySupported() bool
	// TODO: Implement virtual method: Internal_GetConnectionStatus() MultiplayerPeerConnectionStatus
...
type NativeMenu interface {
	Object
	HasFeature(feature NativeMenuFeature) bool
	...
	SetInterfaceDirection(rid RID, is_rtl bool)
	SetPopupOpenCallback(rid RID, callback Callable)
	GetPopupOpenCallback(rid RID) Callable
	SetPopupCloseCallback(rid RID, callback Callable)
	...
	IsItemChecked(rid RID, idx int32) bool
	IsItemCheckable(rid RID, idx int32) bool
	IsItemRadioCheckable(rid RID, idx int32) bool
	GetItemCallback(rid RID, idx int32) Callable
	GetItemKeyCallback(rid RID, idx int32) Callable
	GetItemTag(rid RID, idx int32) Variant
	GetItemText(rid RID, idx int32) String
	GetItemSubmenu(rid RID, idx int32) RID
	GetItemAccelerator(rid RID, idx int32) Key
	IsItemDisabled(rid RID, idx int32) bool
	IsItemHidden(rid RID, idx int32) bool
	GetItemTooltip(rid RID, idx int32) String
	GetItemState(rid RID, idx int32) int32
	GetItemMaxStates(rid RID, idx int32) int32
	GetItemIcon(rid RID, idx int32) RefTexture2D
	GetItemIndentationLevel(rid RID, idx int32) int32
	SetItemChecked(rid RID, idx int32, checked bool)
	SetItemCheckable(rid RID, idx int32, checkable bool)
	SetItemRadioCheckable(rid RID, idx int32, checkable bool)
	SetItemCallback(rid RID, idx int32, callback Callable)
	...
	SetItemIcon(rid RID, idx int32, icon RefTexture2D)
	SetItemIndentationLevel(rid RID, idx int32, level int32)
	SetItemIndex(rid RID, idx int32, target_idx int32) int32
	GetItemCount(rid RID) int32
	IsSystemMenu(rid RID) bool
	RemoveItem(rid RID, idx int32)
	Clear(rid RID)
}
type NavigationAgent2D interface {
	...
	GetTargetPosition() Vector2
	SetSimplifyPath(enabled bool)
	GetSimplifyPath() bool
	SetSimplifyEpsilon(epsilon float32)
	GetSimplifyEpsilon() float32
	SetPathReturnMaxLength(length float32)
	GetPathReturnMaxLength() float32
	SetPathReturnMaxRadius(radius float32)
	GetPathReturnMaxRadius() float32
	SetPathSearchMaxPolygons(max_polygons int32)
	GetPathSearchMaxPolygons() int32
	SetPathSearchMaxDistance(distance float32)
	GetPathSearchMaxDistance() float32
	GetPathLength() float32
...
type NavigationMesh interface {
	...
	SetBorderSize(border_size float32)
	GetBorderSize() float32
...
type NavigationMeshSourceGeometryData2D interface {
	...
	AppendTraversableOutlines(traversable_outlines PackedVector2Array)
	AppendObstructionOutlines(obstruction_outlines PackedVector2Array)
	AddTraversableOutline(shape_outline PackedVector2Array)
	AddObstructionOutline(shape_outline PackedVector2Array)
	Merge(other_geometry RefNavigationMeshSourceGeometryData2D)
	AddProjectedObstruction(vertices PackedVector2Array, carve bool)
	ClearProjectedObstructions()
	SetProjectedObstructions(projected_obstructions Array)
	GetProjectedObstructions() Array
	GetBounds() Rect2
}
type NavigationMeshSourceGeometryData3D interface {
	...
	AppendArrays(vertices PackedFloat32Array, indices PackedInt32Array)
	Clear()
	HasData() bool
	...
	Merge(other_geometry RefNavigationMeshSourceGeometryData3D)
	AddProjectedObstruction(vertices PackedVector3Array, elevation float32, height float32, carve bool)
	ClearProjectedObstructions()
	SetProjectedObstructions(projected_obstructions Array)
	GetProjectedObstructions() Array
	GetBounds() AABB
...
type NavigationObstacle2D interface {
	...
	SetAvoidanceLayerValue(layer_number int32, value bool)
	GetAvoidanceLayerValue(layer_number int32) bool
	SetAffectNavigationMesh(enabled bool)
	GetAffectNavigationMesh() bool
	SetCarveNavigationMesh(enabled bool)
	GetCarveNavigationMesh() bool
}
...
type NavigationPathQueryParameters2D interface {
	...
	SetSimplifyEpsilon(epsilon float32)
	GetSimplifyEpsilon() float32
	SetIncludedRegions(regions RID)
	GetIncludedRegions() RID
	SetExcludedRegions(regions RID)
	GetExcludedRegions() RID
	SetPathReturnMaxLength(length float32)
	GetPathReturnMaxLength() float32
	SetPathReturnMaxRadius(radius float32)
	GetPathReturnMaxRadius() float32
...
type NavigationPolygon interface {
	...
	SetBorderSize(border_size float32)
	GetBorderSize() float32
	SetSamplePartitionType(sample_partition_type NavigationPolygonSamplePartitionType)
	GetSamplePartitionType() NavigationPolygonSamplePartitionType
	...
	SetAgentRadius(agent_radius float32)
	GetAgentRadius() float32
	SetBakingRect(rect Rect2)
	GetBakingRect() Rect2
	SetBakingRectOffset(rect_offset Vector2)
	GetBakingRectOffset() Vector2
	Clear()
}
...
type NavigationServer2D interface {
	...
	MapSetMergeRasterizerCellScale(resourceMap RID, scale float32)
	MapGetMergeRasterizerCellScale(resourceMap RID) float32
	...
	MapGetIterationId(resourceMap RID) uint32
	MapSetUseAsyncIterations(resourceMap RID, enabled bool)
	MapGetUseAsyncIterations(resourceMap RID) bool
	MapGetRandomPoint(resourceMap RID, navigation_layers uint32, uniformly bool) Vector2
	QueryPath(parameters RefNavigationPathQueryParameters2D, result RefNavigationPathQueryResult2D, callback Callable)
	RegionCreate() RID
	RegionGetIterationId(region RID) uint32
	RegionSetUseAsyncIterations(region RID, enabled bool)
	RegionGetUseAsyncIterations(region RID) bool
	...
	RegionGetClosestPoint(region RID, to_point Vector2) Vector2
	RegionGetRandomPoint(region RID, navigation_layers uint32, uniformly bool) Vector2
	RegionGetBounds(region RID) Rect2
	LinkCreate() RID
	LinkGetIterationId(link RID) uint32
	...
	AgentHasAvoidanceCallback(agent RID) bool
	AgentSetAvoidanceLayers(agent RID, layers uint32)
	AgentGetAvoidanceLayers(agent RID) uint32
	AgentSetAvoidanceMask(agent RID, mask uint32)
	AgentGetAvoidanceMask(agent RID) uint32
	AgentSetAvoidancePriority(agent RID, priority float32)
	AgentGetAvoidancePriority(agent RID) float32
	ObstacleCreate() RID
	...
	ObstacleGetRadius(obstacle RID) float32
	...
	ObstacleGetAvoidanceLayers(obstacle RID) uint32
	...
	IsBakingNavigationPolygon(navigation_polygon RefNavigationPolygon) bool
	SourceGeometryParserCreate() RID
	SourceGeometryParserSetCallback(parser RID, callback Callable)
	SimplifyPath(path PackedVector2Array, epsilon float32) PackedVector2Array
	FreeRid(rid RID)
	SetActive(active bool)
	SetDebugEnabled(enabled bool)
	GetDebugEnabled() bool
...
type NavigationServer3D interface {
	...
	MapSetUseAsyncIterations(resourceMap RID, enabled bool)
	MapGetUseAsyncIterations(resourceMap RID) bool
	MapGetRandomPoint(resourceMap RID, navigation_layers uint32, uniformly bool) Vector3
	QueryPath(parameters RefNavigationPathQueryParameters3D, result RefNavigationPathQueryResult3D, callback Callable)
	RegionCreate() RID
	RegionGetIterationId(region RID) uint32
	RegionSetUseAsyncIterations(region RID, enabled bool)
	RegionGetUseAsyncIterations(region RID) bool
	...
	RegionGetClosestPointToSegment(region RID, start Vector3, end Vector3, use_collision bool) Vector3
	RegionGetClosestPoint(region RID, to_point Vector3) Vector3
	RegionGetClosestPointNormal(region RID, to_point Vector3) Vector3
	RegionGetRandomPoint(region RID, navigation_layers uint32, uniformly bool) Vector3
	...
	AgentGetHeight(agent RID) float32
	AgentSetMaxSpeed(agent RID, max_speed float32)
	AgentGetMaxSpeed(agent RID) float32
	...
	ObstacleGetHeight(obstacle RID) float32
	...
	IsBakingNavigationMesh(navigation_mesh RefNavigationMesh) bool
	SourceGeometryParserCreate() RID
	SourceGeometryParserSetCallback(parser RID, callback Callable)
	SimplifyPath(path PackedVector3Array, epsilon float32) PackedVector3Array
	FreeRid(rid RID)
	SetActive(active bool)
	SetDebugEnabled(enabled bool)
	GetDebugEnabled() bool
...
type Node interface {
	...
	// TODO: Implement virtual method: Internal_GetAccessibilityConfigurationWarnings() PackedStringArray
	...
	// TODO: Implement virtual method: Internal_GetFocusedAccessibilityElement() RID
	PrintOrphanNodes()
	GetOrphanNodeIds() int64
	...
	SetPhysicsInterpolationMode(mode NodePhysicsInterpolationMode)
	...
	SetAutoTranslateMode(mode NodeAutoTranslateMode)
	GetAutoTranslateMode() NodeAutoTranslateMode
	CanAutoTranslate() bool
...
type OS interface {
	Object
	GetEntropy(size int32) PackedByteArray
	...
	ReadStringFromStdin(buffer_size int64) String
	ReadBufferFromStdin(buffer_size int64) PackedByteArray
	GetStdinType() OSStdHandleType
	GetStdoutType() OSStdHandleType
	GetStderrType() OSStdHandleType
	Execute(path String, arguments PackedStringArray, output Array, read_stderr bool, open_console bool) int32
	ExecuteWithPipe(path String, arguments PackedStringArray, blocking bool) Dictionary
	...
	OpenWithProgram(program_path String, paths PackedStringArray) Error
	...
	IsKeycodeUnicode(code Char32T) bool
	...
	AddLogger(logger RefLogger)
	RemoveLogger(logger RefLogger)
}
type Object interface {
	GDExtensionClass

	GetClass() String
	IsClass(class StringName) bool
	...
	HasConnections(signal StringName) bool
	...
	SetTranslationDomain(domain StringName)
...
type OpenXRAPIExtension interface {
	...
	SetObjectName(object_type int64, object_handle uint64, object_name String)
	BeginDebugLabelRegion(label_name String)
	EndDebugLabelRegion()
	InsertDebugLabel(label_name String)
	GetViewCount() uint32
	GetViewConfiguration() uint64
	IsInitialized() bool
	IsRunning() bool
	SetCustomPlaySpace(space unsafe.Pointer)
	GetPlaySpace() uint64
	GetPredictedDisplayTime() int64
	GetNextFrameTime() int64
	CanRender() bool
	FindAction(name String, action_set RID) RID
	ActionGetHandle(action RID) uint64
	GetHandTracker(hand_index int32) uint64
	RegisterCompositionLayerProvider(extension OpenXRExtensionWrapper)
	UnregisterCompositionLayerProvider(extension OpenXRExtensionWrapper)
	RegisterProjectionViewsExtension(extension OpenXRExtensionWrapper)
	UnregisterProjectionViewsExtension(extension OpenXRExtensionWrapper)
	RegisterFrameInfoExtension(extension OpenXRExtensionWrapper)
	UnregisterFrameInfoExtension(extension OpenXRExtensionWrapper)
	RegisterProjectionLayerExtension(extension OpenXRExtensionWrapper)
	UnregisterProjectionLayerExtension(extension OpenXRExtensionWrapper)
	GetRenderStateZNear() float64
	GetRenderStateZFar() float64
	SetVelocityTexture(render_target RID)
	SetVelocityDepthTexture(render_target RID)
	SetVelocityTargetSize(target_size Vector2i)
	GetSupportedSwapchainFormats() PackedInt64Array
	OpenxrSwapchainCreate(create_flags uint64, usage_flags uint64, swapchain_format int64, width uint32, height uint32, sample_count uint32, array_size uint32) uint64
	OpenxrSwapchainFree(swapchain uint64)
	OpenxrSwapchainGetSwapchain(swapchain uint64) uint64
	OpenxrSwapchainAcquire(swapchain uint64)
	OpenxrSwapchainGetImage(swapchain uint64) RID
	OpenxrSwapchainRelease(swapchain uint64)
	GetProjectionLayer() uint64
...
type OpenXRActionBindingModifier interface {
...
type OpenXRAnalogThresholdModifier interface {
	OpenXRActionBindingModifier
	SetOnThreshold(on_threshold float32)
	GetOnThreshold() float32
	SetOffThreshold(off_threshold float32)
	GetOffThreshold() float32
	SetOnHaptic(haptic RefOpenXRHapticBase)
	GetOnHaptic() RefOpenXRHapticBase
...
type OpenXRBindingModifier interface {
	...
	// TODO: Implement virtual method: Internal_GetIpModification() PackedByteArray

}
type OpenXRBindingModifierEditor interface {
	PanelContainer
	GetBindingModifier() RefOpenXRBindingModifier
	Setup(action_map RefOpenXRActionMap, binding_modifier RefOpenXRBindingModifier)
}
type OpenXRCompositionLayer interface {
	Node3D
	SetLayerViewport(viewport SubViewport)
	GetLayerViewport() SubViewport
	SetUseAndroidSurface(enable bool)
	GetUseAndroidSurface() bool
	SetAndroidSurfaceSize(size Vector2i)
	GetAndroidSurfaceSize() Vector2i
	SetEnableHolePunch(enable bool)
	GetEnableHolePunch() bool
	SetSortOrder(order int32)
	GetSortOrder() int32
	...
	GetMagFilter() OpenXRCompositionLayerFilter
	SetMipmapMode(mode OpenXRCompositionLayerMipmapMode)
	GetMipmapMode() OpenXRCompositionLayerMipmapMode
	SetHorizontalWrap(mode OpenXRCompositionLayerWrap)
	GetHorizontalWrap() OpenXRCompositionLayerWrap
	SetVerticalWrap(mode OpenXRCompositionLayerWrap)
	GetVerticalWrap() OpenXRCompositionLayerWrap
	SetRedSwizzle(mode OpenXRCompositionLayerSwizzle)
	GetRedSwizzle() OpenXRCompositionLayerSwizzle
	SetGreenSwizzle(mode OpenXRCompositionLayerSwizzle)
	GetGreenSwizzle() OpenXRCompositionLayerSwizzle
	SetBlueSwizzle(mode OpenXRCompositionLayerSwizzle)
	GetBlueSwizzle() OpenXRCompositionLayerSwizzle
	SetAlphaSwizzle(mode OpenXRCompositionLayerSwizzle)
	GetAlphaSwizzle() OpenXRCompositionLayerSwizzle
	SetMaxAnisotropy(value float32)
	GetMaxAnisotropy() float32
	SetBorderColor(color Color)
	GetBorderColor() Color
	SetEyeVisibility(eye_visibility OpenXRCompositionLayerEyeVisibility)
	GetEyeVisibility() OpenXRCompositionLayerEyeVisibility
	IntersectsRay(origin Vector3, direction Vector3) Vector2
}
type OpenXRCompositionLayerCylinder interface {
	OpenXRCompositionLayer
	SetRadius(radius float32)
	GetRadius() float32
	SetAspectRatio(aspect_ratio float32)
	GetAspectRatio() float32
	SetCentralAngle(angle float32)
	GetCentralAngle() float32
	SetFallbackSegments(segments uint32)
	GetFallbackSegments() uint32
}
type OpenXRCompositionLayerEquirect interface {
	OpenXRCompositionLayer
	SetRadius(radius float32)
	GetRadius() float32
	SetCentralHorizontalAngle(angle float32)
	GetCentralHorizontalAngle() float32
	SetUpperVerticalAngle(angle float32)
	GetUpperVerticalAngle() float32
	SetLowerVerticalAngle(angle float32)
	GetLowerVerticalAngle() float32
	SetFallbackSegments(segments uint32)
	GetFallbackSegments() uint32
}
type OpenXRCompositionLayerQuad interface {
	OpenXRCompositionLayer
	SetQuadSize(size Vector2)
	GetQuadSize() Vector2
}
type OpenXRDpadBindingModifier interface {
	OpenXRIPBindingModifier
	SetActionSet(action_set RefOpenXRActionSet)
	GetActionSet() RefOpenXRActionSet
	SetInputPath(input_path String)
	GetInputPath() String
	SetThreshold(threshold float32)
	GetThreshold() float32
	SetThresholdReleased(threshold_released float32)
	GetThresholdReleased() float32
	SetCenterRegion(center_region float32)
	GetCenterRegion() float32
	SetWedgeAngle(wedge_angle float32)
	GetWedgeAngle() float32
	SetIsSticky(is_sticky bool)
	GetIsSticky() bool
	SetOnHaptic(haptic RefOpenXRHapticBase)
	GetOnHaptic() RefOpenXRHapticBase
	SetOffHaptic(haptic RefOpenXRHapticBase)
...
type OpenXRExtensionWrapper interface {
	...
	// TODO: Implement virtual method: Internal_SetProjectionViewsAndGetNextPointer(view_index int32,next_pointer unsafe.Pointer,) uint64
	// TODO: Implement virtual method: Internal_SetFrameWaitInfoAndGetNextPointer(next_pointer unsafe.Pointer,) uint64
	// TODO: Implement virtual method: Internal_SetFrameEndInfoAndGetNextPointer(next_pointer unsafe.Pointer,) uint64
	// TODO: Implement virtual method: Internal_SetProjectionLayerAndGetNextPointer(next_pointer unsafe.Pointer,) uint64
	...
	// TODO: Implement virtual method: Internal_OnRegisterMetadata(interaction_profile_metadata OpenXRInteractionProfileMetadata,)
	...
	// TODO: Implement virtual method: Internal_OnSyncActions()
	// TODO: Implement virtual method: Internal_OnPreRender()
	// TODO: Implement virtual method: Internal_OnMainSwapchainsCreated()
	// TODO: Implement virtual method: Internal_OnPreDrawViewport(viewport RID,)
	// TODO: Implement virtual method: Internal_OnPostDrawViewport(viewport RID,)
	...
	// TODO: Implement virtual method: Internal_SetViewportCompositionLayerAndGetNextPointer(layer unsafe.Pointer,property_values Dictionary,next_pointer unsafe.Pointer,) uint64
	// TODO: Implement virtual method: Internal_GetViewportCompositionLayerExtensionProperties() Dictionary
	// TODO: Implement virtual method: Internal_GetViewportCompositionLayerExtensionPropertyDefaults() Dictionary
	// TODO: Implement virtual method: Internal_OnViewportCompositionLayerDestroyed(layer unsafe.Pointer,)
	// TODO: Implement virtual method: Internal_SetAndroidSurfaceSwapchainCreateInfoAndGetNextPointer(property_values Dictionary,next_pointer unsafe.Pointer,) uint64
...
type OpenXRFutureExtension interface {
	OpenXRExtensionWrapper
	IsActive() bool
	RegisterFuture(future uint64, on_success Callable) RefOpenXRFutureResult
	CancelFuture(future uint64)
}
type OpenXRFutureResult interface {
	RefCounted
	GetStatus() OpenXRFutureResultResultStatus
	GetFuture() uint64
	CancelFuture()
	SetResultValue(result_value Variant)
	GetResultValue() Variant
}
type OpenXRHand interface {
	...
	SetSkeletonRig(skeleton_rig OpenXRHandSkeletonRig)
	GetSkeletonRig() OpenXRHandSkeletonRig
	SetBoneUpdate(bone_update OpenXRHandBoneUpdate)
	GetBoneUpdate() OpenXRHandBoneUpdate
}
type OpenXRHapticBase interface {
	Resource
}
type OpenXRHapticVibration interface {
	OpenXRHapticBase
...
type OpenXRIPBinding interface {
	...
	SetBindingPath(binding_path String)
	GetBindingPath() String
	GetBindingModifierCount() int32
	GetBindingModifier(index int32) RefOpenXRActionBindingModifier
	SetBindingModifiers(binding_modifiers Array)
	GetBindingModifiers() Array
...
type OpenXRIPBindingModifier interface {
	OpenXRBindingModifier
}
type OpenXRInteractionProfile interface {
	...
	GetBindings() Array
	GetBindingModifierCount() int32
	GetBindingModifier(index int32) RefOpenXRIPBindingModifier
	SetBindingModifiers(binding_modifiers Array)
	GetBindingModifiers() Array
}
type OpenXRInteractionProfileEditor interface {
	OpenXRInteractionProfileEditorBase
}
type OpenXRInteractionProfileEditorBase interface {
	HBoxContainer
	Setup(action_map RefOpenXRActionMap, interaction_profile RefOpenXRInteractionProfile)
}
...
type OpenXRInterface interface {
	XRInterface
	GetSessionState() OpenXRInterfaceSessionState
	IsUserPresenceSupported() bool
	IsUserPresent() bool
	...
	GetFoveationWithSubsampledImages() bool
	SetFoveationWithSubsampledImages(enabled bool)
	...
	GetHandTrackingSource(hand OpenXRInterfaceHand) OpenXRInterfaceHandTrackedSource
	...
	IsHandInteractionSupported() bool
...
type OpenXRRenderModel interface {
	...
	GetRenderModel() RID
	SetRenderModel(render_model RID)
}
type OpenXRRenderModelExtension interface {
	OpenXRExtensionWrapper
	IsActive() bool
	RenderModelCreate(render_model_id uint64) RID
	RenderModelDestroy(render_model RID)
	RenderModelGetAll() RID
	RenderModelNewSceneInstance(render_model RID) Node3D
	RenderModelGetSubactionPaths(render_model RID) PackedStringArray
	RenderModelGetTopLevelPath(render_model RID) String
	RenderModelGetConfidence(render_model RID) XRPoseTrackingConfidence
	RenderModelGetRootTransform(render_model RID) Transform3D
	RenderModelGetAnimatableNodeCount(render_model RID) uint32
	RenderModelGetAnimatableNodeName(render_model RID, index uint32) String
	RenderModelIsAnimatableNodeVisible(render_model RID, index uint32) bool
	RenderModelGetAnimatableNodeTransform(render_model RID, index uint32) Transform3D
}
type OpenXRRenderModelManager interface {
	Node3D
	GetTracker() OpenXRRenderModelManagerRenderModelTracker
...
type OpenXRSpatialAnchorCapability interface {
	...
	CreateDefaultPersistenceContext(user_callback Callable) RefOpenXRFutureResult
	...
	CreateNewAnchor(transform Transform3D, spatial_context RID, next RefOpenXRStructureBase) RefOpenXRAnchorTracker
	...
	StartEntityDiscovery(spatial_context RID, component_data RefOpenXRSpatialComponentData, next_snapshot_create RefOpenXRStructureBase, next_snapshot_query RefOpenXRStructureBase, user_callback Callable) RefOpenXRFutureResult
	DoEntityUpdate(spatial_context RID, component_data RefOpenXRSpatialComponentData, next_snapshot_create RefOpenXRStructureBase, next_snapshot_query RefOpenXRStructureBase)
}
...
type OpenXRSpatialEntityExtension interface {
	...
	DiscoverSpatialEntitiesWithComponentData(spatial_context RID, component_data RefOpenXRSpatialComponentData, next RefOpenXRStructureBase, user_callback Callable) RefOpenXRFutureResult
...
type OpenXRSpatialEntityTracker interface {
	XRPositionalTracker
	SetSpatialContext(spatial_context RID)
	GetSpatialContext() RID
	...
	AddNext(next RefOpenXRStructureBase)
	RemoveNext(next RefOpenXRStructureBase)
}
...
type OptimizedTranslation interface {
	Translation
	Generate(from RefTranslation) bool
}
type OptionButton interface {
	...
	SetItemTooltip(idx int32, tooltip String)
	SetItemAutoTranslateMode(idx int32, mode NodeAutoTranslateMode)
	SetSearchBarEnabled(enabled bool)
	SetSearchBarMinItemCount(count int32)
	GetSearchBarMinItemCount() int32
	SetSearchBarFuzzySearchEnabled(enabled bool)
	IsSearchBarFuzzySearchEnabled() bool
	SetSearchBarFuzzySearchMaxMisses(max_misses int32)
	GetSearchBarFuzzySearchMaxMisses() int32
	GetItemText(idx int32) String
	GetItemIcon(idx int32) RefTexture2D
...
type PCKPacker interface {
	RefCounted
	PckStart(pck_path String, alignment int32, key String, encrypt_directory bool) Error
	AddFile(target_path String, source_path String, encrypt bool) Error
	AddFileFromBuffer(target_path String, data PackedByteArray, encrypt bool) Error
	AddFileRemoval(target_path String) Error
...
type Parallax2D interface {
	Node2D
	SetScrollScale(scale Vector2)
	GetScrollScale() Vector2
	SetRepeatSize(repeat_size Vector2)
	GetRepeatSize() Vector2
	SetRepeatTimes(repeat_times int32)
	GetRepeatTimes() int32
	SetAutoscroll(autoscroll Vector2)
	GetAutoscroll() Vector2
	SetScrollOffset(offset Vector2)
	GetScrollOffset() Vector2
	SetScreenOffset(offset Vector2)
	GetScreenOffset() Vector2
	SetLimitBegin(offset Vector2)
	GetLimitBegin() Vector2
	SetLimitEnd(offset Vector2)
	GetLimitEnd() Vector2
	SetFollowViewport(follow bool)
	GetFollowViewport() bool
	SetIgnoreCameraScroll(ignore bool)
	IsIgnoreCameraScroll() bool
}
...
type ParticleProcessMaterial interface {
	...
	SetFlatness(amount float32)
	GetFlatness() float32
	SetParam(param ParticleProcessMaterialParameter, value Vector2)
	GetParam(param ParticleProcessMaterialParameter) Vector2
	...
	SetColor(color Color)
	GetColor() Color
	SetUseScale3D(using_scale_3d bool)
	IsUsingScale3D() bool
	SetScale3DMin(scale_3d_min Vector3)
	GetScale3DMin() Vector3
	SetScale3DMax(scale_3d_max Vector3)
	GetScale3DMax() Vector3
	SetUseRotation3D(using_rotation_3d bool)
	IsUsingRotation3D() bool
	SetRotation3DMin(rotation_3d_min Vector3)
	GetRotation3DMin() Vector3
	SetRotation3DMax(rotation_3d_max Vector3)
	GetRotation3DMax() Vector3
	...
	GetSubEmitterAmountAtStart() int32
	SetSubEmitterAmountAtStart(amount int32)
	...
	SetUsingRotationVelocity3D(use_rotation_velocity_3d bool)
	IsUsingRotationVelocity3D() bool
	SetRotationVelocity3DMax(rotation_velocity_3d_max Vector3)
	GetRotationVelocity3DMax() Vector3
	SetRotationVelocity3DMin(rotation_velocity_3d_min Vector3)
	GetRotationVelocity3DMin() Vector3
	SetRotationVelocity3DCurve(rotation_velocity_3d_curve RefTexture2D)
	GetRotationVelocity3DCurve() RefTexture2D
}
...
type Path3D interface {
	...
	GetCurve() RefCurve3D
	SetDebugCustomColor(debug_custom_color Color)
	GetDebugCustomColor() Color
}
...
type PhysicalBoneSimulator3D interface {
	SkeletonModifier3D
	IsSimulatingPhysics() bool
...
type PhysicsDirectBodyState2DExtension interface {
	...
	// TODO: Implement virtual method: Internal_GetTotalGravity() Vector2
	// TODO: Implement virtual method: Internal_GetTotalLinearDamp() float32
	// TODO: Implement virtual method: Internal_GetTotalAngularDamp() float32
	// TODO: Implement virtual method: Internal_GetCenterOfMass() Vector2
	// TODO: Implement virtual method: Internal_GetCenterOfMassLocal() Vector2
	// TODO: Implement virtual method: Internal_GetInverseMass() float32
	// TODO: Implement virtual method: Internal_GetInverseInertia() float32
	// TODO: Implement virtual method: Internal_SetLinearVelocity(velocity Vector2,)
	// TODO: Implement virtual method: Internal_GetLinearVelocity() Vector2
	// TODO: Implement virtual method: Internal_SetAngularVelocity(velocity float32,)
	// TODO: Implement virtual method: Internal_GetAngularVelocity() float32
	// TODO: Implement virtual method: Internal_SetTransform(transform Transform2D,)
	// TODO: Implement virtual method: Internal_GetTransform() Transform2D
	// TODO: Implement virtual method: Internal_GetVelocityAtLocalPosition(local_position Vector2,) Vector2
	// TODO: Implement virtual method: Internal_ApplyCentralImpulse(impulse Vector2,)
	// TODO: Implement virtual method: Internal_ApplyImpulse(impulse Vector2,position Vector2,)
	// TODO: Implement virtual method: Internal_ApplyTorqueImpulse(impulse float32,)
	// TODO: Implement virtual method: Internal_ApplyCentralForce(force Vector2,)
	// TODO: Implement virtual method: Internal_ApplyForce(force Vector2,position Vector2,)
	// TODO: Implement virtual method: Internal_ApplyTorque(torque float32,)
	// TODO: Implement virtual method: Internal_AddConstantCentralForce(force Vector2,)
	// TODO: Implement virtual method: Internal_AddConstantForce(force Vector2,position Vector2,)
	// TODO: Implement virtual method: Internal_AddConstantTorque(torque float32,)
	// TODO: Implement virtual method: Internal_SetConstantForce(force Vector2,)
	// TODO: Implement virtual method: Internal_GetConstantForce() Vector2
	// TODO: Implement virtual method: Internal_SetConstantTorque(torque float32,)
	// TODO: Implement virtual method: Internal_GetConstantTorque() float32
	// TODO: Implement virtual method: Internal_SetSleepState(enabled bool,)
	// TODO: Implement virtual method: Internal_IsSleeping() bool
	// TODO: Implement virtual method: Internal_SetCollisionLayer(layer uint32,)
	// TODO: Implement virtual method: Internal_GetCollisionLayer() uint32
	// TODO: Implement virtual method: Internal_SetCollisionMask(mask uint32,)
	// TODO: Implement virtual method: Internal_GetCollisionMask() uint32
	// TODO: Implement virtual method: Internal_GetContactCount() int32
	// TODO: Implement virtual method: Internal_GetContactLocalPosition(contact_idx int32,) Vector2
	// TODO: Implement virtual method: Internal_GetContactLocalNormal(contact_idx int32,) Vector2
	// TODO: Implement virtual method: Internal_GetContactLocalShape(contact_idx int32,) int32
	// TODO: Implement virtual method: Internal_GetContactLocalVelocityAtPosition(contact_idx int32,) Vector2
	// TODO: Implement virtual method: Internal_GetContactCollider(contact_idx int32,) RID
	// TODO: Implement virtual method: Internal_GetContactColliderPosition(contact_idx int32,) Vector2
	// TODO: Implement virtual method: Internal_GetContactColliderId(contact_idx int32,) uint64
	// TODO: Implement virtual method: Internal_GetContactColliderObject(contact_idx int32,) Object
	// TODO: Implement virtual method: Internal_GetContactColliderShape(contact_idx int32,) int32
	// TODO: Implement virtual method: Internal_GetContactColliderVelocityAtPosition(contact_idx int32,) Vector2
	// TODO: Implement virtual method: Internal_GetContactImpulse(contact_idx int32,) Vector2
	// TODO: Implement virtual method: Internal_GetStep() float32
	// TODO: Implement virtual method: Internal_IntegrateForces()
	// TODO: Implement virtual method: Internal_GetSpaceState() PhysicsDirectSpaceState2D
...
type PhysicsDirectBodyState3DExtension interface {
	...
	// TODO: Implement virtual method: Internal_GetTotalGravity() Vector3
	// TODO: Implement virtual method: Internal_GetTotalLinearDamp() float32
	// TODO: Implement virtual method: Internal_GetTotalAngularDamp() float32
	// TODO: Implement virtual method: Internal_GetCenterOfMass() Vector3
	// TODO: Implement virtual method: Internal_GetCenterOfMassLocal() Vector3
	// TODO: Implement virtual method: Internal_GetPrincipalInertiaAxes() Basis
	// TODO: Implement virtual method: Internal_GetInverseMass() float32
	// TODO: Implement virtual method: Internal_GetInverseInertia() Vector3
	// TODO: Implement virtual method: Internal_GetInverseInertiaTensor() Basis
	// TODO: Implement virtual method: Internal_SetLinearVelocity(velocity Vector3,)
	// TODO: Implement virtual method: Internal_GetLinearVelocity() Vector3
	// TODO: Implement virtual method: Internal_SetAngularVelocity(velocity Vector3,)
	// TODO: Implement virtual method: Internal_GetAngularVelocity() Vector3
	// TODO: Implement virtual method: Internal_SetTransform(transform Transform3D,)
	// TODO: Implement virtual method: Internal_GetTransform() Transform3D
	// TODO: Implement virtual method: Internal_GetVelocityAtLocalPosition(local_position Vector3,) Vector3
	// TODO: Implement virtual method: Internal_ApplyCentralImpulse(impulse Vector3,)
	// TODO: Implement virtual method: Internal_ApplyImpulse(impulse Vector3,position Vector3,)
	// TODO: Implement virtual method: Internal_ApplyTorqueImpulse(impulse Vector3,)
	// TODO: Implement virtual method: Internal_ApplyCentralForce(force Vector3,)
	// TODO: Implement virtual method: Internal_ApplyForce(force Vector3,position Vector3,)
	// TODO: Implement virtual method: Internal_ApplyTorque(torque Vector3,)
	// TODO: Implement virtual method: Internal_AddConstantCentralForce(force Vector3,)
	// TODO: Implement virtual method: Internal_AddConstantForce(force Vector3,position Vector3,)
	// TODO: Implement virtual method: Internal_AddConstantTorque(torque Vector3,)
	// TODO: Implement virtual method: Internal_SetConstantForce(force Vector3,)
	// TODO: Implement virtual method: Internal_GetConstantForce() Vector3
	// TODO: Implement virtual method: Internal_SetConstantTorque(torque Vector3,)
	// TODO: Implement virtual method: Internal_GetConstantTorque() Vector3
	// TODO: Implement virtual method: Internal_SetSleepState(enabled bool,)
	// TODO: Implement virtual method: Internal_IsSleeping() bool
	// TODO: Implement virtual method: Internal_SetCollisionLayer(layer uint32,)
	// TODO: Implement virtual method: Internal_GetCollisionLayer() uint32
	...
	// TODO: Implement virtual method: Internal_GetCollisionMask() uint32
	// TODO: Implement virtual method: Internal_GetContactCount() int32
	// TODO: Implement virtual method: Internal_GetContactLocalPosition(contact_idx int32,) Vector3
	// TODO: Implement virtual method: Internal_GetContactLocalNormal(contact_idx int32,) Vector3
	// TODO: Implement virtual method: Internal_GetContactImpulse(contact_idx int32,) Vector3
	// TODO: Implement virtual method: Internal_GetContactLocalShape(contact_idx int32,) int32
	// TODO: Implement virtual method: Internal_GetContactLocalVelocityAtPosition(contact_idx int32,) Vector3
	// TODO: Implement virtual method: Internal_GetContactCollider(contact_idx int32,) RID
	// TODO: Implement virtual method: Internal_GetContactColliderPosition(contact_idx int32,) Vector3
	// TODO: Implement virtual method: Internal_GetContactColliderId(contact_idx int32,) uint64
	// TODO: Implement virtual method: Internal_GetContactColliderObject(contact_idx int32,) Object
	// TODO: Implement virtual method: Internal_GetContactColliderShape(contact_idx int32,) int32
	// TODO: Implement virtual method: Internal_GetContactColliderVelocityAtPosition(contact_idx int32,) Vector3
	// TODO: Implement virtual method: Internal_GetStep() float32
	// TODO: Implement virtual method: Internal_IntegrateForces()
	// TODO: Implement virtual method: Internal_GetSpaceState() PhysicsDirectSpaceState3D
...
type PhysicsDirectSpaceState2DExtension interface {
	...
	// TODO: Implement virtual method: Internal_IntersectRay(from Vector2,to Vector2,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,hit_from_inside bool,r_result *PhysicsServer2DExtensionRayResult,) bool
	// TODO: Implement virtual method: Internal_IntersectPoint(position Vector2,canvas_instance_id uint64,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,r_results *PhysicsServer2DExtensionShapeResult,max_results int32,) int32
	// TODO: Implement virtual method: Internal_IntersectShape(shape_rid RID,transform Transform2D,motion Vector2,margin float32,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,r_result *PhysicsServer2DExtensionShapeResult,max_results int32,) int32
	// TODO: Implement virtual method: Internal_CastMotion(shape_rid RID,transform Transform2D,motion Vector2,margin float32,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,r_closest_safe *float32,r_closest_unsafe *float32,) bool
	// TODO: Implement virtual method: Internal_CollideShape(shape_rid RID,transform Transform2D,motion Vector2,margin float32,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,r_results unsafe.Pointer,max_results int32,r_result_count *Int32T,) bool
	// TODO: Implement virtual method: Internal_RestInfo(shape_rid RID,transform Transform2D,motion Vector2,margin float32,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,r_rest_info *PhysicsServer2DExtensionShapeRestInfo,) bool
...
type PhysicsDirectSpaceState3DExtension interface {
	...
	// TODO: Implement virtual method: Internal_IntersectRay(from Vector3,to Vector3,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,hit_from_inside bool,hit_back_faces bool,pick_ray bool,r_result *PhysicsServer3DExtensionRayResult,) bool
	// TODO: Implement virtual method: Internal_IntersectPoint(position Vector3,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,r_results *PhysicsServer3DExtensionShapeResult,max_results int32,) int32
	// TODO: Implement virtual method: Internal_IntersectShape(shape_rid RID,transform Transform3D,motion Vector3,margin float32,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,r_result_count *PhysicsServer3DExtensionShapeResult,max_results int32,) int32
	// TODO: Implement virtual method: Internal_CastMotion(shape_rid RID,transform Transform3D,motion Vector3,margin float32,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,r_closest_safe *float32,r_closest_unsafe *float32,r_info *PhysicsServer3DExtensionShapeRestInfo,) bool
	// TODO: Implement virtual method: Internal_CollideShape(shape_rid RID,transform Transform3D,motion Vector3,margin float32,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,r_results unsafe.Pointer,max_results int32,r_result_count *Int32T,) bool
	// TODO: Implement virtual method: Internal_RestInfo(shape_rid RID,transform Transform3D,motion Vector3,margin float32,collision_mask uint32,collide_with_bodies bool,collide_with_areas bool,r_rest_info *PhysicsServer3DExtensionShapeRestInfo,) bool
...
type PhysicsServer2D interface {
	...
	BodySetShapeAsOneWayCollision(body RID, shape_idx int32, enable bool, margin float32, direction Vector2)
	...
	BodySetStateSyncCallback(body RID, callable Callable)
...
type PhysicsServer2DExtension interface {
	...
	// TODO: Implement virtual method: Internal_ShapeCollide(shape_A RID,xform_A Transform2D,motion_A Vector2,shape_B RID,xform_B Transform2D,motion_B Vector2,r_results unsafe.Pointer,result_max int32,r_result_count *Int32T,) bool
	...
	// TODO: Implement virtual method: Internal_BodySetShapeAsOneWayCollision(body RID,shape_idx int32,enable bool,margin float32,direction Vector2,)
	...
	// TODO: Implement virtual method: Internal_BodyCollideShape(body RID,body_shape int32,shape RID,shape_xform Transform2D,motion Vector2,r_results unsafe.Pointer,result_max int32,r_result_count *Int32T,) bool
	...
	// TODO: Implement virtual method: Internal_BodyTestMotion(body RID,from Transform2D,motion Vector2,margin float32,collide_separation_ray bool,recovery_as_collision bool,r_result *PhysicsServer2DExtensionMotionResult,) bool
...
type PhysicsServer3D interface {
	...
	ShapeSetData(shape RID, data Variant)
	ShapeSetMargin(shape RID, margin float32)
	ShapeGetType(shape RID) PhysicsServer3DShapeType
	ShapeGetData(shape RID) Variant
	ShapeGetMargin(shape RID) float32
	SpaceCreate() RID
	SpaceSetActive(space RID, active bool)
	SpaceIsActive(space RID) bool
	...
	SoftBodyCreate() RID
	SoftBodyUpdateRenderingServer(body RID, rendering_server_handler PhysicsServer3DRenderingServerHandler)
	SoftBodySetSpace(body RID, space RID)
	SoftBodyGetSpace(body RID) RID
	SoftBodySetMesh(body RID, mesh RID)
	SoftBodyGetBounds(body RID) AABB
	SoftBodySetCollisionLayer(body RID, layer uint32)
	SoftBodyGetCollisionLayer(body RID) uint32
	SoftBodySetCollisionMask(body RID, mask uint32)
	SoftBodyGetCollisionMask(body RID) uint32
	SoftBodyAddCollisionException(body RID, body_b RID)
	SoftBodyRemoveCollisionException(body RID, body_b RID)
	SoftBodySetState(body RID, state PhysicsServer3DBodyState, variant Variant)
	SoftBodyGetState(body RID, state PhysicsServer3DBodyState) Variant
	SoftBodySetTransform(body RID, transform Transform3D)
	SoftBodySetRayPickable(body RID, enable bool)
	SoftBodySetSimulationPrecision(body RID, simulation_precision int32)
	SoftBodyGetSimulationPrecision(body RID) int32
	SoftBodySetTotalMass(body RID, total_mass float32)
	SoftBodyGetTotalMass(body RID) float32
	SoftBodySetLinearStiffness(body RID, stiffness float32)
	SoftBodyGetLinearStiffness(body RID) float32
	SoftBodySetShrinkingFactor(body RID, shrinking_factor float32)
	SoftBodyGetShrinkingFactor(body RID) float32
	SoftBodySetPressureCoefficient(body RID, pressure_coefficient float32)
	SoftBodyGetPressureCoefficient(body RID) float32
	SoftBodySetDampingCoefficient(body RID, damping_coefficient float32)
	SoftBodyGetDampingCoefficient(body RID) float32
	SoftBodySetDragCoefficient(body RID, drag_coefficient float32)
	SoftBodyGetDragCoefficient(body RID) float32
	SoftBodyMovePoint(body RID, point_index int32, global_position Vector3)
	SoftBodyGetPointGlobalPosition(body RID, point_index int32) Vector3
	SoftBodyRemoveAllPinnedPoints(body RID)
	SoftBodyPinPoint(body RID, point_index int32, pin bool)
	SoftBodyIsPointPinned(body RID, point_index int32) bool
	SoftBodyApplyPointImpulse(body RID, point_index int32, impulse Vector3)
	SoftBodyApplyPointForce(body RID, point_index int32, force Vector3)
	SoftBodyApplyCentralImpulse(body RID, impulse Vector3)
	SoftBodyApplyCentralForce(body RID, force Vector3)
	JointCreate() RID
	JointClear(joint RID)
...
type PhysicsServer3DExtension interface {
	...
	// TODO: Implement virtual method: Internal_BodyTestMotion(body RID,from Transform3D,motion Vector3,margin float32,max_collisions int32,collide_separation_ray bool,recovery_as_collision bool,r_result *PhysicsServer3DExtensionMotionResult,) bool
	...
	// TODO: Implement virtual method: Internal_SoftBodySetShrinkingFactor(body RID,shrinking_factor float32,)
	// TODO: Implement virtual method: Internal_SoftBodyGetShrinkingFactor(body RID,) float32
	...
	// TODO: Implement virtual method: Internal_SoftBodyApplyPointImpulse(body RID,point_index int32,impulse Vector3,)
	// TODO: Implement virtual method: Internal_SoftBodyApplyPointForce(body RID,point_index int32,force Vector3,)
	// TODO: Implement virtual method: Internal_SoftBodyApplyCentralImpulse(body RID,impulse Vector3,)
	// TODO: Implement virtual method: Internal_SoftBodyApplyCentralForce(body RID,force Vector3,)
	// TODO: Implement virtual method: Internal_JointCreate() RID
	// TODO: Implement virtual method: Internal_JointClear(joint RID,)
...
type PopupMenu interface {
	...
	SetItemAutoTranslateMode(index int32, mode NodeAutoTranslateMode)
	...
	SetItemMultistateMax(index int32, max_states int32)
	SetItemShortcutDisabled(index int32, disabled bool)
	SetItemIndex(index int32, target_index int32)
	...
	GetItemAutoTranslateMode(index int32) NodeAutoTranslateMode
	...
	GetItemSubmenuNode(index int32) PopupMenu
	...
	GetItemMultistateMax(index int32) int32
	GetItemMultistate(index int32) int32
...
type PortableCompressedTexture2D interface {
	...
	SetBasisuCompressorParams(uastc_level int32, rdo_quality_loss float32)
...
type ProgressBar interface {
	...
	SetEditorPreviewIndeterminate(preview_indeterminate bool)
	IsEditorPreviewIndeterminateEnabled() bool
}
type ProjectSettings interface {
	...
	GetSettingWithOverrideAndCustomFeatures(name StringName, features PackedStringArray) Variant
...
type PropertyTweener interface {
	...
	SetCustomInterpolator(interpolator_method Callable) RefPropertyTweener
...
type RDAccelerationStructureGeometry interface {
	RefCounted
	SetFlags(p_member RenderingDeviceAccelerationStructureGeometryFlagBits)
	GetFlags() RenderingDeviceAccelerationStructureGeometryFlagBits
	SetVertexBuffer(p_member RID)
	GetVertexBuffer() RID
	SetVertexOffset(p_member uint32)
	GetVertexOffset() uint32
	SetVertexStride(p_member uint32)
	GetVertexStride() uint32
	SetVertexCount(p_member uint32)
	GetVertexCount() uint32
	SetVertexFormat(p_member RenderingDeviceDataFormat)
	GetVertexFormat() RenderingDeviceDataFormat
	SetIndexBuffer(p_member RID)
	GetIndexBuffer() RID
	SetIndexOffset(p_member uint32)
	GetIndexOffset() uint32
	SetIndexCount(p_member uint32)
	GetIndexCount() uint32
}
type RDAccelerationStructureInstance interface {
	RefCounted
	SetTransform(p_member Transform3D)
	GetTransform() Transform3D
	SetId(p_member uint32)
	GetId() uint32
	SetMask(p_member uint8)
	GetMask() uint8
	SetHitSbtRange(p_member int64)
	GetHitSbtRange() int64
	SetFlags(p_member RenderingDeviceAccelerationStructureInstanceFlagBits)
	GetFlags() RenderingDeviceAccelerationStructureInstanceFlagBits
	SetBlas(p_member RID)
	GetBlas() RID
}
...
type RDHitGroup interface {
	RefCounted
	SetClosestHitShader(p_member RefRDPipelineShader)
	GetClosestHitShader() RefRDPipelineShader
	SetAnyHitShader(p_member RefRDPipelineShader)
	GetAnyHitShader() RefRDPipelineShader
	SetIntersectionShader(p_member RefRDPipelineShader)
	GetIntersectionShader() RefRDPipelineShader
}
...
type RDPipelineShader interface {
	RefCounted
	SetShader(p_member RID)
	GetShader() RID
	SetSpecializationConstants(specialization_constants RefRDPipelineSpecializationConstant)
	GetSpecializationConstants() RefRDPipelineSpecializationConstant
}
...
type RDTextureFormat interface {
	...
	SetIsResolveBuffer(p_member bool)
	GetIsResolveBuffer() bool
	SetIsDiscardable(p_member bool)
...
type RandomNumberGenerator interface {
	...
	RandWeighted(weights PackedFloat32Array) int64
	Randomize()
}
...
type ReflectionProbe interface {
	...
	SetIntensity(intensity float32)
	GetIntensity() float32
	SetBlendDistance(blend_distance float32)
	GetBlendDistance() float32
	...
	GetCullMask() uint32
	SetReflectionMask(layers uint32)
	GetReflectionMask() uint32
	SetUpdateMode(mode ReflectionProbeUpdateMode)
	GetUpdateMode() ReflectionProbeUpdateMode
}
type RegEx interface {
	RefCounted
	CreateFromString(pattern String, show_error bool) RefRegEx
	Clear()
	Compile(pattern String, show_error bool) Error
...
type RenderData interface {
	Object
	GetRenderSceneBuffers() RefRenderSceneBuffers
...
type RenderDataExtension interface {
	RenderData
	// TODO: Implement virtual method: Internal_GetRenderSceneBuffers() RefRenderSceneBuffers
	// TODO: Implement virtual method: Internal_GetRenderSceneData() RenderSceneData
	// TODO: Implement virtual method: Internal_GetEnvironment() RID
	// TODO: Implement virtual method: Internal_GetCameraAttributes() RID

}
type RenderDataRD interface {
	RenderData
}
...
type RenderSceneBuffersConfiguration interface {
	...
	GetAnisotropicFilteringLevel() RenderingServerViewportAnisotropicFiltering
	SetAnisotropicFilteringLevel(anisotropic_filtering_level RenderingServerViewportAnisotropicFiltering)
}
type RenderSceneBuffersExtension interface {
	RenderSceneBuffers
	// TODO: Implement virtual method: Internal_Configure(config RefRenderSceneBuffersConfiguration,)
	// TODO: Implement virtual method: Internal_SetFsrSharpness(fsr_sharpness float32,)
	// TODO: Implement virtual method: Internal_SetTextureMipmapBias(texture_mipmap_bias float32,)
	// TODO: Implement virtual method: Internal_SetAnisotropicFilteringLevel(anisotropic_filtering_level int32,)
	// TODO: Implement virtual method: Internal_SetUseDebanding(use_debanding bool,)

}
type RenderSceneBuffersRD interface {
	RenderSceneBuffers
	HasTexture(context StringName, name StringName) bool
	CreateTexture(context StringName, name StringName, data_format RenderingDeviceDataFormat, usage_bits uint32, texture_samples RenderingDeviceTextureSamples, size Vector2i, layers uint32, mipmaps uint32, unique bool, discardable bool) RID
	...
	GetDepthTexture(msaa bool) RID
	GetDepthLayer(layer uint32, msaa bool) RID
	GetVelocityTexture(msaa bool) RID
	GetVelocityLayer(layer uint32, msaa bool) RID
	GetRenderTarget() RID
	GetViewCount() uint32
	GetInternalSize() Vector2i
	GetTargetSize() Vector2i
	...
	GetFsrSharpness() float32
	GetMsaa3D() RenderingServerViewportMSAA
	GetTextureSamples() RenderingDeviceTextureSamples
	GetScreenSpaceAa() RenderingServerViewportScreenSpaceAA
	GetUseTaa() bool
	GetUseDebanding() bool
}
type RenderSceneData interface {
	Object
	GetCamTransform() Transform3D
	GetCamProjection() Projection
	GetViewCount() uint32
	GetViewEyeOffset(view uint32) Vector3
	GetViewProjection(view uint32) Projection
	GetUniformBuffer() RID
}
type RenderSceneDataExtension interface {
	RenderSceneData
	// TODO: Implement virtual method: Internal_GetCamTransform() Transform3D
	// TODO: Implement virtual method: Internal_GetCamProjection() Projection
	// TODO: Implement virtual method: Internal_GetViewCount() uint32
	// TODO: Implement virtual method: Internal_GetViewEyeOffset(view uint32,) Vector3
	// TODO: Implement virtual method: Internal_GetViewProjection(view uint32,) Projection
	// TODO: Implement virtual method: Internal_GetUniformBuffer() RID

}
type RenderSceneDataRD interface {
	RenderSceneData
}
type RenderingDevice interface {
	...
	TextureCreateFromExtension(typeName RenderingDeviceTextureType, format RenderingDeviceDataFormat, samples RenderingDeviceTextureSamples, usage_flags RenderingDeviceTextureUsageBits, image uint64, width uint64, height uint64, depth uint64, layers uint64, mipmaps uint64) RID
	TextureUpdate(texture RID, layer uint32, data PackedByteArray) Error
	TextureGetData(texture RID, layer uint32) PackedByteArray
	TextureGetDataAsync(texture RID, layer uint32, callback Callable) Error
	...
	TextureSetDiscardable(texture RID, discardable bool)
	TextureIsDiscardable(texture RID) bool
	TextureCopy(from_texture RID, to_texture RID, from_pos Vector3, to_pos Vector3, size Vector3, src_mipmap uint32, dst_mipmap uint32, src_layer uint32, dst_layer uint32) Error
	TextureClear(texture RID, color Color, base_mipmap uint32, mipmap_count uint32, base_layer uint32, layer_count uint32) Error
	TextureResolveMultisample(from_texture RID, to_texture RID) Error
	...
	VertexBufferCreate(size_bytes uint32, data PackedByteArray, creation_bits RenderingDeviceBufferCreationBits) RID
	...
	IndexBufferCreate(size_indices uint32, format RenderingDeviceIndexBufferFormat, data PackedByteArray, use_restart_indices bool, creation_bits RenderingDeviceBufferCreationBits) RID
	...
	UniformBufferCreate(size_bytes uint32, data PackedByteArray, creation_bits RenderingDeviceBufferCreationBits) RID
	StorageBufferCreate(size_bytes uint32, data PackedByteArray, usage RenderingDeviceStorageBufferUsage, creation_bits RenderingDeviceBufferCreationBits) RID
	...
	BufferCopy(src_buffer RID, dst_buffer RID, src_offset uint32, dst_offset uint32, size uint32) Error
	BufferUpdate(buffer RID, offset uint32, size_bytes uint32, data PackedByteArray) Error
	BufferClear(buffer RID, offset uint32, size_bytes uint32) Error
	BufferGetData(buffer RID, offset_bytes uint32, size_bytes uint32) PackedByteArray
	BufferGetDataAsync(buffer RID, callback Callable, offset_bytes uint32, size_bytes uint32) Error
	BufferGetDeviceAddress(buffer RID) uint64
	...
	RaytracingPipelineCreate(raygen_shaders RefRDPipelineShader, miss_shaders RefRDPipelineShader, hit_groups RefRDHitGroup, max_trace_recursion_depth uint32) RID
	RaytracingPipelineIsValid(raytracing_pipeline RID) bool
	BlasCreate(geometries RefRDAccelerationStructureGeometry, flags RenderingDeviceAccelerationStructureFlagBits) RID
	TlasCreate(max_instance_count uint32, flags RenderingDeviceAccelerationStructureFlagBits) RID
	BlasBuild(blas RID) Error
	TlasBuild(tlas RID, instances RefRDAccelerationStructureInstance) Error
	HitSbtCreate(raytracing_pipeline RID, initial_hit_group_capacity uint32) RID
	HitSbtSetPipeline(hit_sbt RID, raytracing_pipeline RID) Error
	HitSbtRangeAlloc(hit_sbt RID, hit_group_count uint32) int64
	HitSbtRangeFree(hit_sbt RID, valueRange int64) Error
	HitSbtRangeUpdate(hit_sbt RID, valueRange int64, offset uint32, hit_group_indices PackedInt32Array) Error
	ScreenGetWidth(screen int32) int32
	ScreenGetHeight(screen int32) int32
	ScreenGetFramebufferFormat(screen int32) int64
	DrawListBeginForScreen(screen int32, clear_color Color) int64
	DrawListBegin(framebuffer RID, draw_flags RenderingDeviceDrawFlags, clear_color_values PackedColorArray, clear_depth_value float32, clear_stencil_value uint32, region Rect2, breadcrumb uint32) int64
	...
	DrawListDrawIndirect(draw_list int64, use_indices bool, buffer RID, offset uint32, draw_count uint32, stride uint32)
	...
	ComputeListDispatchIndirect(compute_list int64, buffer RID, offset uint32)
	ComputeListAddBarrier(compute_list int64)
	ComputeListEnd()
	RaytracingListBegin() int64
	RaytracingListBindRaytracingPipeline(raytracing_list int64, raytracing_pipeline RID)
	RaytracingListSetPushConstant(raytracing_list int64, buffer PackedByteArray, size_bytes uint32)
	RaytracingListBindUniformSet(raytracing_list int64, uniform_set RID, set_index uint32)
	RaytracingListTraceRays(raytracing_list int64, raygen_shader_index uint32, hit_sbt RID, width uint32, height uint32, depth uint32)
	RaytracingListEnd()
	FreeRid(rid RID)
	...
	HasFeature(feature RenderingDeviceFeatures) bool
	...
	GetTrackedObjectName(type_index uint32) String
	GetTrackedObjectTypeCount() uint64
	GetDriverTotalMemory() uint64
	GetDriverAllocationCount() uint64
	GetDriverMemoryByObjectType(typeName uint32) uint64
	GetDriverAllocsByObjectType(typeName uint32) uint64
	GetDeviceTotalMemory() uint64
	GetDeviceAllocationCount() uint64
	GetDeviceMemoryByObjectType(typeName uint32) uint64
	GetDeviceAllocsByObjectType(typeName uint32) uint64
}
type RenderingServer interface {
	...
	TextureCreateFromNativeHandle(typeName RenderingServerTextureType, format ImageFormat, native_handle uint64, width int32, height int32, depth int32, layers int32, layered_type RenderingServerTextureLayeredType) RID
	TextureDrawableCreate(width int32, height int32, format RenderingServerTextureDrawableFormat, color Color, with_mipmaps bool) RID
	...
	TextureDrawableBlitRect(textures RID, rect Rect2i, material RID, modulate Color, source_textures RID, to_mipmap int32)
	...
	TextureDrawableGenerateMipmaps(texture RID)
	TextureDrawableGetDefaultMaterial() RID
	...
	MeshSurfaceGetFormatIndexStride(format RenderingServerArrayFormat, vertex_count int32) uint32
	...
	MeshSurfaceRemove(mesh RID, surface int32)
	MeshClear(mesh RID)
	...
	MeshSurfaceUpdateIndexRegion(mesh RID, surface int32, offset int32, data PackedByteArray)
	MeshSetShadowMesh(mesh RID, shadow_mesh RID)
	MultimeshCreate() RID
	MultimeshAllocateData(multimesh RID, instances int32, transform_format RenderingServerMultimeshTransformFormat, color_format bool, custom_data_format bool, use_indirect bool)
	...
	MultimeshSetCustomAabb(multimesh RID, aabb AABB)
	...
	MultimeshSetBufferInterpolated(multimesh RID, buffer PackedFloat32Array, buffer_previous PackedFloat32Array)
	...
	LightSetShadowCasterMask(light RID, mask uint32)
	...
	LightAreaSetSize(light RID, size Vector2)
	LightAreaSetNormalizeEnergy(light RID, enable bool)
	LightProjectorsSetFilter(filter RenderingServerLightProjectorFilter)
	LightmapsSetBicubicFilter(enable bool)
	...
	ReflectionProbeSetBlendDistance(probe RID, blend_distance float32)
	...
	ReflectionProbeSetReflectionMask(probe RID, layers uint32)
	...
	ParticlesRequestProcessTime(particles RID, process_time float32, process_time_residual float32)
	...
	ParticlesSetTransformAlignChannelFilter(particles RID, channel_filter RenderingServerParticlesTransformAlignCustomSrc)
	ParticlesSetTransformAlignAxis(particles RID, rotation_axis RenderingServerParticlesTransformAlignAxis)
	...
	ParticlesCollisionSetHeightFieldMask(particles_collision RID, mask uint32)
	FogVolumeCreate() RID
	...
	CameraSetCompositor(camera RID, compositor RID)
	CameraSetUseVerticalAspect(camera RID, enable bool)
	ViewportCreate() RID
	ViewportSetUseXr(viewport RID, use_xr bool)
	ViewportSetSize(viewport RID, width int32, height int32, view_count int32)
	...
	ViewportSetAnisotropicFilteringLevel(viewport RID, anisotropic_filtering_level RenderingServerViewportAnisotropicFiltering)
	ViewportSetUpdateMode(viewport RID, update_mode RenderingServerViewportUpdateMode)
	ViewportGetUpdateMode(viewport RID) RenderingServerViewportUpdateMode
	...
	ViewportSetVrsUpdateMode(viewport RID, mode RenderingServerViewportVRSUpdateMode)
	...
	CompositorEffectSetEnabled(effect RID, enabled bool)
	CompositorEffectSetCallback(effect RID, callback_type RenderingServerCompositorEffectCallbackType, callback Callable)
	CompositorEffectSetFlag(effect RID, flag RenderingServerCompositorEffectFlags, set bool)
	CompositorCreate() RID
	CompositorSetCompositorEffects(compositor RID, effects RID)
	EnvironmentCreate() RID
	EnvironmentSetBackground(env RID, bg RenderingServerEnvironmentBG)
	EnvironmentSetCameraId(env RID, id int32)
	...
	EnvironmentSetFog(env RID, enable bool, light_color Color, light_energy float32, sun_scatter float32, density float32, height float32, height_density float32, aerial_perspective float32, sky_affect float32, fog_mode RenderingServerEnvironmentFogMode)
	EnvironmentSetFogDepth(env RID, curve float32, begin float32, end float32)
	...
	EnvironmentSetVolumetricFog(env RID, enable bool, density float32, albedo Color, emission Color, emission_energy float32, anisotropy float32, length float32, detail_spread float32, gi_inject float32, temporal_reprojection bool, temporal_reprojection_amount float32, ambient_inject float32, sky_affect float32)
	...
	ScenarioSetCompositor(scenario RID, compositor RID)
	...
	CanvasSetItemRepeat(item RID, repeat_size Vector2, repeat_times int32)
	...
	CanvasItemSetInterpolated(item RID, interpolated bool)
	CanvasItemResetPhysicsInterpolation(item RID)
	CanvasItemTransformPhysicsInterpolation(item RID, transform Transform2D)
	...
	CanvasItemAttachSkeleton(item RID, skeleton RID)
	...
	CanvasItemSetInstanceShaderParameter(instance RID, parameter StringName, value Variant)
	...
	CanvasLightSetInterpolated(light RID, interpolated bool)
	CanvasLightResetPhysicsInterpolation(light RID)
	CanvasLightTransformPhysicsInterpolation(light RID, transform Transform2D)
	...
	CanvasLightOccluderSetInterpolated(occluder RID, interpolated bool)
	CanvasLightOccluderResetPhysicsInterpolation(occluder RID)
	CanvasLightOccluderTransformPhysicsInterpolation(occluder RID, transform Transform2D)
...
type Resource interface {
	...
	// TODO: Implement virtual method: Internal_GetRid() RID
	// TODO: Implement virtual method: Internal_ResetState()
	// TODO: Implement virtual method: Internal_SetPathCache(path String,)
	SetPath(path String)
	...
	SetupLocalToScene()
	ResetState()
	SetIdForPath(path String, id String)
	...
	EmitChanged()
	Duplicate(deep bool) RefResource
	DuplicateDeep(deep_subresources_mode ResourceDeepDuplicateMode) RefResource
	CopyFromResource(resource RefResource) Error
}
type ResourceFormatLoader interface {
	RefCounted
	// TODO: Implement virtual method: Internal_GetRecognizedExtensions() PackedStringArray
	// TODO: Implement virtual method: Internal_RecognizePath(path String,typeName StringName,) bool
	// TODO: Implement virtual method: Internal_HandlesType(typeName StringName,) bool
	// TODO: Implement virtual method: Internal_GetResourceType(path String,) String
	// TODO: Implement virtual method: Internal_GetResourceScriptClass(path String,) String
	// TODO: Implement virtual method: Internal_GetResourceUid(path String,) int64
	// TODO: Implement virtual method: Internal_GetDependencies(path String,add_types bool,) PackedStringArray
	// TODO: Implement virtual method: Internal_RenameDependencies(path String,renames Dictionary,) Error
	// TODO: Implement virtual method: Internal_Exists(path String,) bool
	// TODO: Implement virtual method: Internal_GetClassesUsed(path String,) PackedStringArray
	// TODO: Implement virtual method: Internal_Load(path String,original_path String,use_sub_threads bool,cache_mode int32,) Variant

}
type ResourceFormatSaver interface {
	RefCounted
	// TODO: Implement virtual method: Internal_Save(resource RefResource,path String,flags uint32,) Error
	// TODO: Implement virtual method: Internal_SetUid(path String,uid int64,) Error
	// TODO: Implement virtual method: Internal_Recognize(resource RefResource,) bool
	// TODO: Implement virtual method: Internal_GetRecognizedExtensions(resource RefResource,) PackedStringArray
	// TODO: Implement virtual method: Internal_RecognizePath(resource RefResource,path String,) bool

}
type ResourceImporter interface {
	RefCounted
	// TODO: Implement virtual method: Internal_GetBuildDependencies(path String,) PackedStringArray
...
type ResourceImporterSVG interface {
	ResourceImporter
}
...
type ResourceLoader interface {
	...
	GetCachedRef(path String) RefResource
	Exists(path String, type_hint String) bool
	GetResourceUid(path String) int64
	ListDirectory(directory_path String) PackedStringArray
}
...
type ResourceSaver interface {
	...
	SetUid(resource String, uid int64) Error
	...
	GetResourceIdForPath(path String, generate bool) int64
}
type ResourceUID interface {
	...
	CreateId() int64
	CreateIdForPath(path String) int64
	HasId(id int64) bool
	AddId(id int64, path String)
	SetId(id int64, path String)
	GetIdPath(id int64) String
	RemoveId(id int64)
	UidToPath(uid String) String
	PathToUid(path String) String
	EnsurePath(path_or_uid String) String
}
type RetargetModifier3D interface {
	SkeletonModifier3D
	SetProfile(profile RefSkeletonProfile)
	GetProfile() RefSkeletonProfile
	SetUseGlobalPose(use_global_pose bool)
	IsUsingGlobalPose() bool
	SetEnableFlags(enable_flags RetargetModifier3DTransformFlag)
	GetEnableFlags() RetargetModifier3DTransformFlag
	SetPositionEnabled(enabled bool)
	IsPositionEnabled() bool
	SetRotationEnabled(enabled bool)
	IsRotationEnabled() bool
	SetScaleEnabled(enabled bool)
	IsScaleEnabled() bool
}
...
type RichTextEffect interface {
	Resource
	// TODO: Implement virtual method: Internal_ProcessCustomFx(char_fx RefCharFXTransform,) bool
...
type RichTextLabel interface {
	...
	AddText(text String)
	SetText(text String)
	AddHr(width int32, height int32, color Color, alignment HorizontalAlignment, width_in_percent bool, height_in_percent bool)
	AddImage(image RefTexture2D, width float32, height float32, color Color, inline_align InlineAlignment, region Rect2, key Variant, pad bool, tooltip String, width_unit RichTextLabelImageUnit, height_unit RichTextLabelImageUnit, alt_text String)
	UpdateImage(key Variant, mask RichTextLabelImageUpdateMask, image RefTexture2D, width float32, height float32, color Color, inline_align InlineAlignment, region Rect2, pad bool, tooltip String, width_unit RichTextLabelImageUnit, height_unit RichTextLabelImageUnit)
	Newline()
	RemoveParagraph(paragraph int32, no_invalidate bool) bool
	InvalidateParagraph(paragraph int32) bool
	...
	PushMeta(data Variant, underline_mode RichTextLabelMetaUnderline, tooltip String)
	PushHint(description String)
	PushLanguage(language String)
	PushUnderline(color Color)
	PushStrikethrough(color Color)
	PushTable(columns int32, inline_align InlineAlignment, align_to_row int32, name String)
	...
	SetTableColumnExpand(column int32, expand bool, ratio int32, shrink bool)
	SetTableColumnName(column int32, name String)
	...
	IsScrollActive() bool
	SetScrollFollowVisibleCharacters(follow bool)
	IsScrollFollowingVisibleCharacters() bool
	...
	GetSelectionLineOffset() float32
	SelectAll()
	GetSelectedText() String
	Deselect()
...
type SceneState interface {
	RefCounted
	GetPath() String
	GetBaseSceneState() RefSceneState
	GetNodeCount() int32
...
type Script interface {
	...
	HasScriptMethod(method_name StringName) bool
...
type ScriptBacktrace interface {
	RefCounted
	GetLanguageName() String
	IsEmpty() bool
	GetFrameCount() int32
	GetFrameFunction(index int32) String
	GetFrameFile(index int32) String
	GetFrameLine(index int32) int32
	GetGlobalVariableCount() int32
	GetGlobalVariableName(variable_index int32) String
	GetGlobalVariableValue(variable_index int32) Variant
	GetLocalVariableCount(frame_index int32) int32
	GetLocalVariableName(frame_index int32, variable_index int32) String
	GetLocalVariableValue(frame_index int32, variable_index int32) Variant
	GetMemberVariableCount(frame_index int32) int32
	GetMemberVariableName(frame_index int32, variable_index int32) String
	GetMemberVariableValue(frame_index int32, variable_index int32) Variant
	Format(indent_all int32, indent_frames int32) String
}
...
type ScriptEditor interface {
	...
	UpdateDocsFromScript(script RefScript)
	ClearDocsFromScript(script RefScript)
	GetUnsavedFiles() PackedStringArray
	SaveAllScripts()
...
type ScriptExtension interface {
	Script
	// TODO: Implement virtual method: Internal_EditorCanReloadFromFile() bool
	// TODO: Implement virtual method: Internal_PlaceholderErased(placeholder unsafe.Pointer,)
	// TODO: Implement virtual method: Internal_CanInstantiate() bool
	// TODO: Implement virtual method: Internal_GetBaseScript() RefScript
	// TODO: Implement virtual method: Internal_GetGlobalName() StringName
	// TODO: Implement virtual method: Internal_InheritsScript(script RefScript,) bool
	// TODO: Implement virtual method: Internal_GetInstanceBaseType() StringName
	// TODO: Implement virtual method: Internal_InstanceCreate(for_object Object,) unsafe.Pointer
	// TODO: Implement virtual method: Internal_PlaceholderInstanceCreate(for_object Object,) unsafe.Pointer
	// TODO: Implement virtual method: Internal_HasSourceCode() bool
	// TODO: Implement virtual method: Internal_GetSourceCode() String
	// TODO: Implement virtual method: Internal_SetSourceCode(code String,)
	// TODO: Implement virtual method: Internal_Reload(keep_state bool,) Error
	// TODO: Implement virtual method: Internal_GetDocClassName() StringName
	// TODO: Implement virtual method: Internal_GetDocumentation() Dictionary
	// TODO: Implement virtual method: Internal_GetClassIconPath() String
	// TODO: Implement virtual method: Internal_HasMethod(method StringName,) bool
	// TODO: Implement virtual method: Internal_HasStaticMethod(method StringName,) bool
	// TODO: Implement virtual method: Internal_GetScriptMethodArgumentCount(method StringName,) Variant
	// TODO: Implement virtual method: Internal_GetMethodInfo(method StringName,) Dictionary
	// TODO: Implement virtual method: Internal_IsTool() bool
	// TODO: Implement virtual method: Internal_IsValid() bool
	// TODO: Implement virtual method: Internal_IsAbstract() bool
	// TODO: Implement virtual method: Internal_GetLanguage() ScriptLanguage
	// TODO: Implement virtual method: Internal_HasScriptSignal(signal StringName,) bool
	// TODO: Implement virtual method: Internal_GetScriptSignalList() Dictionary
	// TODO: Implement virtual method: Internal_HasPropertyDefaultValue(property StringName,) bool
	// TODO: Implement virtual method: Internal_GetPropertyDefaultValue(property StringName,) Variant
	// TODO: Implement virtual method: Internal_UpdateExports()
	// TODO: Implement virtual method: Internal_GetScriptMethodList() Dictionary
	// TODO: Implement virtual method: Internal_GetScriptPropertyList() Dictionary
	// TODO: Implement virtual method: Internal_GetMemberLine(member StringName,) int32
	// TODO: Implement virtual method: Internal_GetConstants() Dictionary
	// TODO: Implement virtual method: Internal_GetMembers() StringName
	// TODO: Implement virtual method: Internal_IsPlaceholderFallbackEnabled() bool
	// TODO: Implement virtual method: Internal_GetRpcConfig() Variant
	// TODO: Implement virtual method: Internal_InstanceHas(object Object,) bool
...
type ScriptLanguageExtension interface {
	...
	// TODO: Implement virtual method: Internal_GetName() String
	// TODO: Implement virtual method: Internal_Init()
	// TODO: Implement virtual method: Internal_GetType() String
	// TODO: Implement virtual method: Internal_GetExtension() String
	// TODO: Implement virtual method: Internal_Finish()
	// TODO: Implement virtual method: Internal_GetReservedWords() PackedStringArray
	// TODO: Implement virtual method: Internal_IsControlFlowKeyword(keyword String,) bool
	// TODO: Implement virtual method: Internal_GetCommentDelimiters() PackedStringArray
	// TODO: Implement virtual method: Internal_GetDocCommentDelimiters() PackedStringArray
	// TODO: Implement virtual method: Internal_GetStringDelimiters() PackedStringArray
	// TODO: Implement virtual method: Internal_MakeTemplate(template String,class_name String,base_class_name String,) RefScript
	// TODO: Implement virtual method: Internal_GetBuiltInTemplates(object StringName,) Dictionary
	// TODO: Implement virtual method: Internal_IsUsingTemplates() bool
	// TODO: Implement virtual method: Internal_Validate(script String,path String,validate_functions bool,validate_errors bool,validate_warnings bool,validate_safe_lines bool,) Dictionary
	// TODO: Implement virtual method: Internal_ValidatePath(path String,) String
	// TODO: Implement virtual method: Internal_CreateScript() Object
	// TODO: Implement virtual method: Internal_HasNamedClasses() bool
	// TODO: Implement virtual method: Internal_SupportsBuiltinMode() bool
	// TODO: Implement virtual method: Internal_SupportsDocumentation() bool
	// TODO: Implement virtual method: Internal_CanInheritFromFile() bool
	// TODO: Implement virtual method: Internal_FindFunction(function String,code String,) int32
	// TODO: Implement virtual method: Internal_MakeFunction(class_name String,function_name String,function_args PackedStringArray,) String
	// TODO: Implement virtual method: Internal_CanMakeFunction() bool
	// TODO: Implement virtual method: Internal_OpenInExternalEditor(script RefScript,line int32,column int32,) Error
	// TODO: Implement virtual method: Internal_OverridesExternalEditor() bool
	// TODO: Implement virtual method: Internal_PreferredFileNameCasing() ScriptLanguageScriptNameCasing
	// TODO: Implement virtual method: Internal_CompleteCode(code String,path String,owner Object,) Dictionary
	// TODO: Implement virtual method: Internal_LookupCode(code String,symbol String,path String,owner Object,) Dictionary
	// TODO: Implement virtual method: Internal_AutoIndentCode(code String,from_line int32,to_line int32,) String
	// TODO: Implement virtual method: Internal_AddGlobalConstant(name StringName,value Variant,)
	// TODO: Implement virtual method: Internal_AddNamedGlobalConstant(name StringName,value Variant,)
	// TODO: Implement virtual method: Internal_RemoveNamedGlobalConstant(name StringName,)
	// TODO: Implement virtual method: Internal_ThreadEnter()
	// TODO: Implement virtual method: Internal_ThreadExit()
	// TODO: Implement virtual method: Internal_DebugGetError() String
	// TODO: Implement virtual method: Internal_DebugGetStackLevelCount() int32
	// TODO: Implement virtual method: Internal_DebugGetStackLevelLine(level int32,) int32
	// TODO: Implement virtual method: Internal_DebugGetStackLevelFunction(level int32,) String
	// TODO: Implement virtual method: Internal_DebugGetStackLevelSource(level int32,) String
	// TODO: Implement virtual method: Internal_DebugGetStackLevelLocals(level int32,max_subitems int32,max_depth int32,) Dictionary
	// TODO: Implement virtual method: Internal_DebugGetStackLevelMembers(level int32,max_subitems int32,max_depth int32,) Dictionary
	// TODO: Implement virtual method: Internal_DebugGetStackLevelInstance(level int32,) unsafe.Pointer
	// TODO: Implement virtual method: Internal_DebugGetGlobals(max_subitems int32,max_depth int32,) Dictionary
	// TODO: Implement virtual method: Internal_DebugParseStackLevelExpression(level int32,expression String,max_subitems int32,max_depth int32,) String
	// TODO: Implement virtual method: Internal_DebugGetCurrentStackInfo() Dictionary
	// TODO: Implement virtual method: Internal_ReloadAllScripts()
	// TODO: Implement virtual method: Internal_ReloadScripts(scripts Array,soft_reload bool,)
	// TODO: Implement virtual method: Internal_ReloadToolScript(script RefScript,soft_reload bool,)
	// TODO: Implement virtual method: Internal_GetRecognizedExtensions() PackedStringArray
	// TODO: Implement virtual method: Internal_GetPublicFunctions() Dictionary
	// TODO: Implement virtual method: Internal_GetPublicConstants() Dictionary
	// TODO: Implement virtual method: Internal_GetPublicAnnotations() Dictionary
	// TODO: Implement virtual method: Internal_ProfilingStart()
	// TODO: Implement virtual method: Internal_ProfilingStop()
	// TODO: Implement virtual method: Internal_ProfilingSetSaveNativeCalls(enable bool,)
	// TODO: Implement virtual method: Internal_ProfilingGetAccumulatedData(info_array *ScriptLanguageExtensionProfilingInfo,info_max int32,) int32
	// TODO: Implement virtual method: Internal_ProfilingGetFrameData(info_array *ScriptLanguageExtensionProfilingInfo,info_max int32,) int32
	// TODO: Implement virtual method: Internal_Frame()
	// TODO: Implement virtual method: Internal_HandlesGlobalClassType(typeName String,) bool
	// TODO: Implement virtual method: Internal_GetGlobalClassName(path String,) Dictionary
...
type ScrollContainer interface {
	...
	SetScrollHorizontalByDefault(enable bool)
	IsScrollHorizontalByDefault() bool
	...
	SetDrawFocusBorder(draw bool)
	GetDrawFocusBorder() bool
}
...
type Shader interface {
	...
	SetCode(code String)
	GetCode() String
	SetDefaultTextureParameter(name StringName, texture RefTexture, index int32)
	GetDefaultTextureParameter(name StringName, index int32) RefTexture
...
type ShaderIncludeDB interface {
	Object
	ListBuiltInIncludeFiles() PackedStringArray
	HasBuiltInIncludeFile(filename String) bool
...
type Skeleton3D interface {
	...
	GetBoneMeta(bone_idx int32, key StringName) Variant
	GetBoneMetaList(bone_idx int32) StringName
	HasBoneMeta(bone_idx int32, key StringName) bool
	SetBoneMeta(bone_idx int32, key StringName, value Variant)
	...
	SetBonePose(bone_idx int32, pose Transform3D)
	...
	SetBoneGlobalPose(bone_idx int32, pose Transform3D)
	...
	IsShowRestOnly() bool
	SetModifierCallbackModeProcess(mode Skeleton3DModifierCallbackModeProcess)
	GetModifierCallbackModeProcess() Skeleton3DModifierCallbackModeProcess
	Advance(delta float64)
...
type SkeletonModifier3D interface {
	Node3D
	// TODO: Implement virtual method: Internal_ProcessModificationWithDelta(delta float64,)
	// TODO: Implement virtual method: Internal_ProcessModification()
	// TODO: Implement virtual method: Internal_SkeletonChanged(old_skeleton Skeleton3D,new_skeleton Skeleton3D,)
	// TODO: Implement virtual method: Internal_ValidateBoneNames()
	GetSkeleton() Skeleton3D
	SetActive(active bool)
	IsActive() bool
	SetInfluence(influence float32)
...
type Slider interface {
	...
	GetTicksPosition() SliderTickPosition
	SetTicksPosition(ticks_on_border SliderTickPosition)
...
type SoftBody3D interface {
	...
	SetShrinkingFactor(shrinking_factor float32)
	GetShrinkingFactor() float32
	...
	ApplyImpulse(point_index int32, impulse Vector3)
	ApplyForce(point_index int32, force Vector3)
	ApplyCentralImpulse(impulse Vector3)
	ApplyCentralForce(force Vector3)
	SetPointPinned(point_index int32, pinned bool, attachment_path NodePath, insert_at int32)
...
type SplitContainer interface {
	...
	SetVertical(vertical bool)
	IsVertical() bool
	SetDraggingEnabled(dragging_enabled bool)
	IsDraggingEnabled() bool
	SetDragAreaMarginBegin(margin int32)
	GetDragAreaMarginBegin() int32
	SetDragAreaMarginEnd(margin int32)
	GetDragAreaMarginEnd() int32
	SetDragAreaOffset(offset int32)
	...
	SetDragNestedIntersections(enabled bool)
	IsDraggingNestedIntersections() bool
...
type SpringBoneCollision3D interface {
	Node3D
	GetSkeleton() Skeleton3D
	SetBoneName(bone_name String)
	GetBoneName() String
	SetBone(bone int32)
	GetBone() int32
	SetPositionOffset(offset Vector3)
	GetPositionOffset() Vector3
	SetRotationOffset(offset Quaternion)
	GetRotationOffset() Quaternion
}
type SpringBoneCollisionCapsule3D interface {
	...
	SetMidHeight(mid_height float32)
	GetMidHeight() float32
	SetInside(enabled bool)
	IsInside() bool
}
type SpringBoneCollisionPlane3D interface {
	SpringBoneCollision3D
}
type SpringBoneCollisionSphere3D interface {
	SpringBoneCollision3D
	SetRadius(radius float32)
	GetRadius() float32
	SetInside(enabled bool)
...
type SpringBoneSimulator3D interface {
	SkeletonModifier3D
	SetRootBoneName(index int32, bone_name String)
	GetRootBoneName(index int32) String
	SetRootBone(index int32, bone int32)
	...
	GetCenterFrom(index int32) SpringBoneSimulator3DCenterFrom
	SetCenterNode(index int32, node_path NodePath)
	GetCenterNode(index int32) NodePath
	SetCenterBoneName(index int32, bone_name String)
	GetCenterBoneName(index int32) String
	SetCenterBone(index int32, bone int32)
	...
	GetRadiusDampingCurve(index int32) RefCurve
	SetStiffness(index int32, stiffness float32)
	GetStiffness(index int32) float32
	SetStiffnessDampingCurve(index int32, curve RefCurve)
	GetStiffnessDampingCurve(index int32) RefCurve
	SetDrag(index int32, drag float32)
	GetDrag(index int32) float32
	SetDragDampingCurve(index int32, curve RefCurve)
	GetDragDampingCurve(index int32) RefCurve
	SetGravity(index int32, gravity float32)
	GetGravity(index int32) float32
	SetGravityDampingCurve(index int32, curve RefCurve)
	GetGravityDampingCurve(index int32) RefCurve
	SetGravityDirection(index int32, gravity_direction Vector3)
	GetGravityDirection(index int32) Vector3
	SetSettingCount(count int32)
	GetSettingCount() int32
	ClearSettings()
	SetIndividualConfig(index int32, enabled bool)
	...
	GetJointRadius(index int32, joint int32) float32
	SetJointStiffness(index int32, joint int32, stiffness float32)
	GetJointStiffness(index int32, joint int32) float32
	SetJointDrag(index int32, joint int32, drag float32)
	GetJointDrag(index int32, joint int32) float32
	SetJointGravity(index int32, joint int32, gravity float32)
	GetJointGravity(index int32, joint int32) float32
	SetJointGravityDirection(index int32, joint int32, gravity_direction Vector3)
	GetJointGravityDirection(index int32, joint int32) Vector3
	GetJointCount(index int32) int32
	SetEnableAllChildCollisions(index int32, enabled bool)
	AreAllChildCollisionsEnabled(index int32) bool
	SetExcludeCollisionPath(index int32, collision int32, node_path NodePath)
	GetExcludeCollisionPath(index int32, collision int32) NodePath
	SetExcludeCollisionCount(index int32, count int32)
	GetExcludeCollisionCount(index int32) int32
	ClearExcludeCollisions(index int32)
	SetCollisionPath(index int32, collision int32, node_path NodePath)
	GetCollisionPath(index int32, collision int32) NodePath
	SetCollisionCount(index int32, count int32)
	GetCollisionCount(index int32) int32
...
type SpriteFrames interface {
	...
	DuplicateAnimation(anim_from StringName, anim_to StringName)
	...
	SetAnimationLoopMode(anim StringName, loop_mode SpriteFramesLoopMode)
	GetAnimationLoopMode(anim StringName) SpriteFramesLoopMode
...
type StreamPeerExtension interface {
	StreamPeer
	// TODO: Implement virtual method: Internal_GetData(r_buffer *uint8,r_bytes int32,r_received *Int32T,) Error
	// TODO: Implement virtual method: Internal_GetPartialData(r_buffer *uint8,r_bytes int32,r_received *Int32T,) Error
	// TODO: Implement virtual method: Internal_PutData(data *uint8,bytes int32,r_sent *Int32T,) Error
	// TODO: Implement virtual method: Internal_PutPartialData(data *uint8,bytes int32,r_sent *Int32T,) Error
	// TODO: Implement virtual method: Internal_GetAvailableBytes() int32
...
type SubViewportContainer interface {
	...
	SetMouseTarget(amount bool)
	IsMouseTargetEnabled() bool
}
type SubtweenTweener interface {
	Tweener
	SetDelay(delay float64) RefSubtweenTweener
}
...
type TLSOptions interface {
	...
	GetTrustedCaChain() RefX509Certificate
	GetPrivateKey() RefCryptoKey
	GetOwnCertificate() RefX509Certificate
}
type TabBar interface {
	...
	SetCloseWithMiddleMouse(enabled bool)
	GetCloseWithMiddleMouse() bool
	...
	SetDeselectEnabled(enabled bool)
	GetDeselectEnabled() bool
	ClearTabs()
}
type TabContainer interface {
	...
	SetTabAlignment(alignment TabBarAlignmentMode)
	GetTabAlignment() TabBarAlignmentMode
	SetTabsPosition(tabs_position TabContainerTabPosition)
	GetTabsPosition() TabContainerTabPosition
	SetClipTabs(clip_tabs bool)
	GetClipTabs() bool
...
type TextEdit interface {
	...
	GetTabSize() int32
	SetIndentWrappedLines(enabled bool)
	IsIndentWrappedLines() bool
	SetTabInputMode(enabled bool)
	GetTabInputMode() bool
	...
	IsMiddleMousePasteEnabled() bool
	SetEmptySelectionClipboardEnabled(enabled bool)
	IsEmptySelectionClipboardEnabled() bool
	Clear()
	SetText(text String)
	GetText() String
	GetLineCount() int32
	...
	GetLineWithIme(line int32) String
	...
	GetLineColumnAtPos(position Vector2i, clamp_line bool, clamp_column bool) Vector2i
	...
	AddCaret(line int32, column int32) int32
	RemoveCaret(caret int32)
	RemoveSecondaryCarets()
	GetCaretCount() int32
	AddCaretAtCarets(below bool)
	GetSortedCarets(include_ignored_carets bool) PackedInt32Array
	CollapseCarets(from_line int32, from_column int32, to_line int32, to_column int32, inclusive bool)
	MergeOverlappingCarets()
	BeginMulticaretEdit()
	EndMulticaretEdit()
	IsInMulitcaretEdit() bool
	MulticaretEditIgnoreCaret(caret_index int32) bool
	...
	GetNextCompositeCharacterColumn(line int32, column int32) int32
	GetPreviousCompositeCharacterColumn(line int32, column int32) int32
	GetCaretWrapIndex(caret_index int32) int32
	GetWordUnderCaret(caret_index int32) String
	SetUseDefaultWordSeparators(enabled bool)
	...
	SetDragAndDropSelectionEnabled(enable bool)
	IsDragAndDropSelectionEnabled() bool
	SetSelectionMode(mode TextEditSelectionMode)
	...
	Select(origin_line int32, origin_column int32, caret_line int32, caret_column int32, caret_index int32)
	HasSelection(caret_index int32) bool
	GetSelectedText(caret_index int32) String
	GetSelectionAtLineColumn(line int32, column int32, include_edges bool, only_selections bool) int32
	GetLineRangesFromCarets(only_selections bool, merge_adjacent bool) Vector2i
	GetSelectionOriginLine(caret_index int32) int32
	GetSelectionOriginColumn(caret_index int32) int32
	SetSelectionOriginLine(line int32, can_be_hidden bool, wrap_index int32, caret_index int32)
	SetSelectionOriginColumn(column int32, caret_index int32)
	...
	IsCaretAfterSelectionOrigin(caret_index int32) bool
	...
	SetFitContentWidthEnabled(enabled bool)
	IsFitContentWidthEnabled() bool
	...
	IsLineInViewport(line int32) bool
...
type TextLine interface {
	...
	Draw(canvas RID, pos Vector2, color Color, oversampling float32)
	DrawOutline(canvas RID, pos Vector2, outline_size int32, color Color, oversampling float32)
...
type TextParagraph interface {
	...
	Draw(canvas RID, pos Vector2, color Color, dc_color Color, oversampling float32)
	DrawOutline(canvas RID, pos Vector2, outline_size int32, color Color, dc_color Color, oversampling float32)
	DrawLine(canvas RID, pos Vector2, line int32, color Color, oversampling float32)
	DrawLineOutline(canvas RID, pos Vector2, line int32, outline_size int32, color Color, oversampling float32)
	DrawDropcap(canvas RID, pos Vector2, color Color, oversampling float32)
	DrawDropcapOutline(canvas RID, pos Vector2, outline_size int32, color Color, oversampling float32)
...
type TextServer interface {
	...
	FontSetDisableEmbeddedBitmaps(font_rid RID, disable_embedded_bitmaps bool)
	FontGetDisableEmbeddedBitmaps(font_rid RID) bool
	...
	FontSetModulateColorGlyphs(font_rid RID, modulate bool)
	FontIsModulateColorGlyphs(font_rid RID) bool
	FontGetPaletteCount(font_rid RID) int64
	FontGetPaletteName(font_rid RID, index int64) String
	FontGetPaletteColors(font_rid RID, index int64) PackedColorArray
	FontSetPaletteCustomColors(font_rid RID, colors PackedColorArray)
	FontGetPaletteCustomColors(font_rid RID) PackedColorArray
	FontGetUsedPalette(font_rid RID) int64
	FontSetUsedPalette(font_rid RID, index int64)
	...
	FontSetKeepRoundingRemainders(font_rid RID, keep_rounding_remainders bool)
	FontGetKeepRoundingRemainders(font_rid RID) bool
	...
	FontSetBaselineOffset(font_rid RID, baseline_offset float64)
	FontGetBaselineOffset(font_rid RID) float64
	...
	FontGetSizeCacheInfo(font_rid RID) Dictionary
	...
	FontGetSupportedGlyphs(font_rid RID) PackedInt32Array
	FontRenderRange(font_rid RID, size Vector2i, start int64, end int64)
	FontRenderGlyph(font_rid RID, size Vector2i, index int64)
	FontDrawGlyph(font_rid RID, canvas RID, size int64, pos Vector2, index int64, color Color, oversampling float32)
	FontDrawGlyphOutline(font_rid RID, canvas RID, size int64, outline_size int64, pos Vector2, index int64, color Color, oversampling float32)
	...
	ShapedGetSpanEmbeddedObject(shaped RID, index int64) Variant
	ShapedGetSpanText(shaped RID, index int64) String
	ShapedGetSpanObject(shaped RID, index int64) Variant
	...
	ShapedGetRunDirection(shaped RID, index int64) TextServerDirection
	ShapedGetRunObject(shaped RID, index int64) Variant
	...
	ShapedTextGetWordBreaks(shaped RID, grapheme_flags TextServerGraphemeFlag, skip_grapheme_flags TextServerGraphemeFlag) PackedInt32Array
	...
	ShapedTextGetObjectGlyph(shaped RID, key Variant) int64
	...
	ShapedTextDraw(shaped RID, canvas RID, pos Vector2, clip_l float64, clip_r float64, color Color, oversampling float32)
	ShapedTextDrawOutline(shaped RID, canvas RID, pos Vector2, clip_l float64, clip_r float64, outline_size int64, color Color, oversampling float32)
...
type TextServerExtension interface {
	TextServer
	// TODO: Implement virtual method: Internal_HasFeature(feature TextServerFeature,) bool
	// TODO: Implement virtual method: Internal_GetName() String
	// TODO: Implement virtual method: Internal_GetFeatures() int64
	// TODO: Implement virtual method: Internal_FreeRid(rid RID,)
	// TODO: Implement virtual method: Internal_Has(rid RID,) bool
	// TODO: Implement virtual method: Internal_LoadSupportData(filename String,) bool
	// TODO: Implement virtual method: Internal_GetSupportDataFilename() String
	...
	// TODO: Implement virtual method: Internal_CreateFont() RID
	// TODO: Implement virtual method: Internal_CreateFontLinkedVariation(font_rid RID,) RID
	// TODO: Implement virtual method: Internal_FontSetData(font_rid RID,data PackedByteArray,)
	// TODO: Implement virtual method: Internal_FontSetDataPtr(font_rid RID,data_ptr *uint8,data_size int64,)
	// TODO: Implement virtual method: Internal_FontSetFaceIndex(font_rid RID,face_index int64,)
	// TODO: Implement virtual method: Internal_FontGetFaceIndex(font_rid RID,) int64
	// TODO: Implement virtual method: Internal_FontGetFaceCount(font_rid RID,) int64
	// TODO: Implement virtual method: Internal_FontSetStyle(font_rid RID,style TextServerFontStyle,)
	// TODO: Implement virtual method: Internal_FontGetStyle(font_rid RID,) TextServerFontStyle
	// TODO: Implement virtual method: Internal_FontSetName(font_rid RID,name String,)
	// TODO: Implement virtual method: Internal_FontGetName(font_rid RID,) String
	// TODO: Implement virtual method: Internal_FontGetOtNameStrings(font_rid RID,) Dictionary
	// TODO: Implement virtual method: Internal_FontSetStyleName(font_rid RID,name_style String,)
	// TODO: Implement virtual method: Internal_FontGetStyleName(font_rid RID,) String
	// TODO: Implement virtual method: Internal_FontSetWeight(font_rid RID,weight int64,)
	// TODO: Implement virtual method: Internal_FontGetWeight(font_rid RID,) int64
	// TODO: Implement virtual method: Internal_FontSetStretch(font_rid RID,stretch int64,)
	// TODO: Implement virtual method: Internal_FontGetStretch(font_rid RID,) int64
	// TODO: Implement virtual method: Internal_FontSetAntialiasing(font_rid RID,antialiasing TextServerFontAntialiasing,)
	// TODO: Implement virtual method: Internal_FontGetAntialiasing(font_rid RID,) TextServerFontAntialiasing
	// TODO: Implement virtual method: Internal_FontSetDisableEmbeddedBitmaps(font_rid RID,disable_embedded_bitmaps bool,)
	// TODO: Implement virtual method: Internal_FontGetDisableEmbeddedBitmaps(font_rid RID,) bool
	// TODO: Implement virtual method: Internal_FontSetGenerateMipmaps(font_rid RID,generate_mipmaps bool,)
	// TODO: Implement virtual method: Internal_FontGetGenerateMipmaps(font_rid RID,) bool
	// TODO: Implement virtual method: Internal_FontSetMultichannelSignedDistanceField(font_rid RID,msdf bool,)
	// TODO: Implement virtual method: Internal_FontIsMultichannelSignedDistanceField(font_rid RID,) bool
	// TODO: Implement virtual method: Internal_FontSetMsdfPixelRange(font_rid RID,msdf_pixel_range int64,)
	// TODO: Implement virtual method: Internal_FontGetMsdfPixelRange(font_rid RID,) int64
	// TODO: Implement virtual method: Internal_FontSetMsdfSize(font_rid RID,msdf_size int64,)
	// TODO: Implement virtual method: Internal_FontGetMsdfSize(font_rid RID,) int64
	// TODO: Implement virtual method: Internal_FontSetFixedSize(font_rid RID,fixed_size int64,)
	// TODO: Implement virtual method: Internal_FontGetFixedSize(font_rid RID,) int64
	// TODO: Implement virtual method: Internal_FontSetFixedSizeScaleMode(font_rid RID,fixed_size_scale_mode TextServerFixedSizeScaleMode,)
	// TODO: Implement virtual method: Internal_FontGetFixedSizeScaleMode(font_rid RID,) TextServerFixedSizeScaleMode
	// TODO: Implement virtual method: Internal_FontSetAllowSystemFallback(font_rid RID,allow_system_fallback bool,)
	// TODO: Implement virtual method: Internal_FontIsAllowSystemFallback(font_rid RID,) bool
	// TODO: Implement virtual method: Internal_FontClearSystemFallbackCache()
	// TODO: Implement virtual method: Internal_FontSetForceAutohinter(font_rid RID,force_autohinter bool,)
	// TODO: Implement virtual method: Internal_FontIsForceAutohinter(font_rid RID,) bool
	// TODO: Implement virtual method: Internal_FontSetModulateColorGlyphs(font_rid RID,modulate bool,)
	// TODO: Implement virtual method: Internal_FontIsModulateColorGlyphs(font_rid RID,) bool
	// TODO: Implement virtual method: Internal_FontGetPaletteCount(font_rid RID,) int64
	// TODO: Implement virtual method: Internal_FontGetPaletteName(font_rid RID,index int64,) String
	// TODO: Implement virtual method: Internal_FontGetPaletteColors(font_rid RID,index int64,) PackedColorArray
	// TODO: Implement virtual method: Internal_FontSetPaletteCustomColors(font_rid RID,colors PackedColorArray,)
	// TODO: Implement virtual method: Internal_FontGetPaletteCustomColors(font_rid RID,) PackedColorArray
	// TODO: Implement virtual method: Internal_FontGetUsedPalette(font_rid RID,) int64
	// TODO: Implement virtual method: Internal_FontSetUsedPalette(font_rid RID,index int64,)
	// TODO: Implement virtual method: Internal_FontSetHinting(font_rid RID,hinting TextServerHinting,)
	// TODO: Implement virtual method: Internal_FontGetHinting(font_rid RID,) TextServerHinting
	// TODO: Implement virtual method: Internal_FontSetSubpixelPositioning(font_rid RID,subpixel_positioning TextServerSubpixelPositioning,)
	// TODO: Implement virtual method: Internal_FontGetSubpixelPositioning(font_rid RID,) TextServerSubpixelPositioning
	// TODO: Implement virtual method: Internal_FontSetKeepRoundingRemainders(font_rid RID,keep_rounding_remainders bool,)
	// TODO: Implement virtual method: Internal_FontGetKeepRoundingRemainders(font_rid RID,) bool
	// TODO: Implement virtual method: Internal_FontSetEmbolden(font_rid RID,strength float64,)
	// TODO: Implement virtual method: Internal_FontGetEmbolden(font_rid RID,) float64
	// TODO: Implement virtual method: Internal_FontSetSpacing(font_rid RID,spacing TextServerSpacingType,value int64,)
	// TODO: Implement virtual method: Internal_FontGetSpacing(font_rid RID,spacing TextServerSpacingType,) int64
	// TODO: Implement virtual method: Internal_FontSetBaselineOffset(font_rid RID,baseline_offset float64,)
	// TODO: Implement virtual method: Internal_FontGetBaselineOffset(font_rid RID,) float64
	// TODO: Implement virtual method: Internal_FontSetTransform(font_rid RID,transform Transform2D,)
	// TODO: Implement virtual method: Internal_FontGetTransform(font_rid RID,) Transform2D
	// TODO: Implement virtual method: Internal_FontSetVariationCoordinates(font_rid RID,variation_coordinates Dictionary,)
	// TODO: Implement virtual method: Internal_FontGetVariationCoordinates(font_rid RID,) Dictionary
	// TODO: Implement virtual method: Internal_FontSetOversampling(font_rid RID,oversampling float64,)
	// TODO: Implement virtual method: Internal_FontGetOversampling(font_rid RID,) float64
	// TODO: Implement virtual method: Internal_FontGetSizeCacheList(font_rid RID,) Vector2i
	// TODO: Implement virtual method: Internal_FontClearSizeCache(font_rid RID,)
	// TODO: Implement virtual method: Internal_FontRemoveSizeCache(font_rid RID,size Vector2i,)
	// TODO: Implement virtual method: Internal_FontGetSizeCacheInfo(font_rid RID,) Dictionary
	// TODO: Implement virtual method: Internal_FontSetAscent(font_rid RID,size int64,ascent float64,)
	// TODO: Implement virtual method: Internal_FontGetAscent(font_rid RID,size int64,) float64
	// TODO: Implement virtual method: Internal_FontSetDescent(font_rid RID,size int64,descent float64,)
	// TODO: Implement virtual method: Internal_FontGetDescent(font_rid RID,size int64,) float64
	// TODO: Implement virtual method: Internal_FontSetUnderlinePosition(font_rid RID,size int64,underline_position float64,)
	// TODO: Implement virtual method: Internal_FontGetUnderlinePosition(font_rid RID,size int64,) float64
	// TODO: Implement virtual method: Internal_FontSetUnderlineThickness(font_rid RID,size int64,underline_thickness float64,)
	// TODO: Implement virtual method: Internal_FontGetUnderlineThickness(font_rid RID,size int64,) float64
	// TODO: Implement virtual method: Internal_FontSetScale(font_rid RID,size int64,scale float64,)
	// TODO: Implement virtual method: Internal_FontGetScale(font_rid RID,size int64,) float64
	// TODO: Implement virtual method: Internal_FontGetTextureCount(font_rid RID,size Vector2i,) int64
	// TODO: Implement virtual method: Internal_FontClearTextures(font_rid RID,size Vector2i,)
	// TODO: Implement virtual method: Internal_FontRemoveTexture(font_rid RID,size Vector2i,texture_index int64,)
	// TODO: Implement virtual method: Internal_FontSetTextureImage(font_rid RID,size Vector2i,texture_index int64,image RefImage,)
	// TODO: Implement virtual method: Internal_FontGetTextureImage(font_rid RID,size Vector2i,texture_index int64,) RefImage
	// TODO: Implement virtual method: Internal_FontSetTextureOffsets(font_rid RID,size Vector2i,texture_index int64,offset PackedInt32Array,)
	// TODO: Implement virtual method: Internal_FontGetTextureOffsets(font_rid RID,size Vector2i,texture_index int64,) PackedInt32Array
	// TODO: Implement virtual method: Internal_FontGetGlyphList(font_rid RID,size Vector2i,) PackedInt32Array
	// TODO: Implement virtual method: Internal_FontClearGlyphs(font_rid RID,size Vector2i,)
	// TODO: Implement virtual method: Internal_FontRemoveGlyph(font_rid RID,size Vector2i,glyph int64,)
	// TODO: Implement virtual method: Internal_FontGetGlyphAdvance(font_rid RID,size int64,glyph int64,) Vector2
	// TODO: Implement virtual method: Internal_FontSetGlyphAdvance(font_rid RID,size int64,glyph int64,advance Vector2,)
	// TODO: Implement virtual method: Internal_FontGetGlyphOffset(font_rid RID,size Vector2i,glyph int64,) Vector2
	// TODO: Implement virtual method: Internal_FontSetGlyphOffset(font_rid RID,size Vector2i,glyph int64,offset Vector2,)
	// TODO: Implement virtual method: Internal_FontGetGlyphSize(font_rid RID,size Vector2i,glyph int64,) Vector2
	// TODO: Implement virtual method: Internal_FontSetGlyphSize(font_rid RID,size Vector2i,glyph int64,gl_size Vector2,)
	// TODO: Implement virtual method: Internal_FontGetGlyphUvRect(font_rid RID,size Vector2i,glyph int64,) Rect2
	// TODO: Implement virtual method: Internal_FontSetGlyphUvRect(font_rid RID,size Vector2i,glyph int64,uv_rect Rect2,)
	// TODO: Implement virtual method: Internal_FontGetGlyphTextureIdx(font_rid RID,size Vector2i,glyph int64,) int64
	// TODO: Implement virtual method: Internal_FontSetGlyphTextureIdx(font_rid RID,size Vector2i,glyph int64,texture_idx int64,)
	// TODO: Implement virtual method: Internal_FontGetGlyphTextureRid(font_rid RID,size Vector2i,glyph int64,) RID
	// TODO: Implement virtual method: Internal_FontGetGlyphTextureSize(font_rid RID,size Vector2i,glyph int64,) Vector2
	// TODO: Implement virtual method: Internal_FontGetGlyphContours(font_rid RID,size int64,index int64,) Dictionary
	// TODO: Implement virtual method: Internal_FontGetKerningList(font_rid RID,size int64,) Vector2i
	// TODO: Implement virtual method: Internal_FontClearKerningMap(font_rid RID,size int64,)
	// TODO: Implement virtual method: Internal_FontRemoveKerning(font_rid RID,size int64,glyph_pair Vector2i,)
	// TODO: Implement virtual method: Internal_FontSetKerning(font_rid RID,size int64,glyph_pair Vector2i,kerning Vector2,)
	// TODO: Implement virtual method: Internal_FontGetKerning(font_rid RID,size int64,glyph_pair Vector2i,) Vector2
	// TODO: Implement virtual method: Internal_FontGetGlyphIndex(font_rid RID,size int64,char int64,variation_selector int64,) int64
	// TODO: Implement virtual method: Internal_FontGetCharFromGlyphIndex(font_rid RID,size int64,glyph_index int64,) int64
	// TODO: Implement virtual method: Internal_FontHasChar(font_rid RID,char int64,) bool
	// TODO: Implement virtual method: Internal_FontGetSupportedChars(font_rid RID,) String
	// TODO: Implement virtual method: Internal_FontGetSupportedGlyphs(font_rid RID,) PackedInt32Array
	// TODO: Implement virtual method: Internal_FontRenderRange(font_rid RID,size Vector2i,start int64,end int64,)
	// TODO: Implement virtual method: Internal_FontRenderGlyph(font_rid RID,size Vector2i,index int64,)
	// TODO: Implement virtual method: Internal_FontDrawGlyph(font_rid RID,canvas RID,size int64,pos Vector2,index int64,color Color,oversampling float32,)
	// TODO: Implement virtual method: Internal_FontDrawGlyphOutline(font_rid RID,canvas RID,size int64,outline_size int64,pos Vector2,index int64,color Color,oversampling float32,)
	// TODO: Implement virtual method: Internal_FontIsLanguageSupported(font_rid RID,language String,) bool
	// TODO: Implement virtual method: Internal_FontSetLanguageSupportOverride(font_rid RID,language String,supported bool,)
	// TODO: Implement virtual method: Internal_FontGetLanguageSupportOverride(font_rid RID,language String,) bool
	// TODO: Implement virtual method: Internal_FontRemoveLanguageSupportOverride(font_rid RID,language String,)
	// TODO: Implement virtual method: Internal_FontGetLanguageSupportOverrides(font_rid RID,) PackedStringArray
	// TODO: Implement virtual method: Internal_FontIsScriptSupported(font_rid RID,script String,) bool
	// TODO: Implement virtual method: Internal_FontSetScriptSupportOverride(font_rid RID,script String,supported bool,)
	// TODO: Implement virtual method: Internal_FontGetScriptSupportOverride(font_rid RID,script String,) bool
	// TODO: Implement virtual method: Internal_FontRemoveScriptSupportOverride(font_rid RID,script String,)
	// TODO: Implement virtual method: Internal_FontGetScriptSupportOverrides(font_rid RID,) PackedStringArray
	// TODO: Implement virtual method: Internal_FontSetOpentypeFeatureOverrides(font_rid RID,overrides Dictionary,)
	// TODO: Implement virtual method: Internal_FontGetOpentypeFeatureOverrides(font_rid RID,) Dictionary
	// TODO: Implement virtual method: Internal_FontSupportedFeatureList(font_rid RID,) Dictionary
	// TODO: Implement virtual method: Internal_FontSupportedVariationList(font_rid RID,) Dictionary
	// TODO: Implement virtual method: Internal_FontGetGlobalOversampling() float64
	// TODO: Implement virtual method: Internal_FontSetGlobalOversampling(oversampling float64,)
	// TODO: Implement virtual method: Internal_ReferenceOversamplingLevel(oversampling float64,)
	// TODO: Implement virtual method: Internal_UnreferenceOversamplingLevel(oversampling float64,)
	// TODO: Implement virtual method: Internal_GetHexCodeBoxSize(size int64,index int64,) Vector2
	...
	// TODO: Implement virtual method: Internal_ShapedTextSetBidiOverride(shaped RID,override Array,)
	// TODO: Implement virtual method: Internal_ShapedTextSetCustomPunctuation(shaped RID,punct String,)
	// TODO: Implement virtual method: Internal_ShapedTextGetCustomPunctuation(shaped RID,) String
	// TODO: Implement virtual method: Internal_ShapedTextSetCustomEllipsis(shaped RID,char int64,)
	// TODO: Implement virtual method: Internal_ShapedTextGetCustomEllipsis(shaped RID,) int64
	// TODO: Implement virtual method: Internal_ShapedTextSetOrientation(shaped RID,orientation TextServerOrientation,)
	// TODO: Implement virtual method: Internal_ShapedTextGetOrientation(shaped RID,) TextServerOrientation
	// TODO: Implement virtual method: Internal_ShapedTextSetPreserveInvalid(shaped RID,enabled bool,)
	// TODO: Implement virtual method: Internal_ShapedTextGetPreserveInvalid(shaped RID,) bool
	// TODO: Implement virtual method: Internal_ShapedTextSetPreserveControl(shaped RID,enabled bool,)
	// TODO: Implement virtual method: Internal_ShapedTextGetPreserveControl(shaped RID,) bool
	// TODO: Implement virtual method: Internal_ShapedTextSetSpacing(shaped RID,spacing TextServerSpacingType,value int64,)
	// TODO: Implement virtual method: Internal_ShapedTextGetSpacing(shaped RID,spacing TextServerSpacingType,) int64
	...
	// TODO: Implement virtual method: Internal_ShapedGetSpanEmbeddedObject(shaped RID,index int64,) Variant
	// TODO: Implement virtual method: Internal_ShapedGetSpanText(shaped RID,index int64,) String
	// TODO: Implement virtual method: Internal_ShapedGetSpanObject(shaped RID,index int64,) Variant
	// TODO: Implement virtual method: Internal_ShapedSetSpanUpdateFont(shaped RID,index int64,fonts RID,size int64,opentype_features Dictionary,)
	...
	// TODO: Implement virtual method: Internal_ShapedGetRunDirection(shaped RID,index int64,) TextServerDirection
	// TODO: Implement virtual method: Internal_ShapedGetRunObject(shaped RID,index int64,) Variant
	// TODO: Implement virtual method: Internal_ShapedTextSubstr(shaped RID,start int64,length int64,) RID
	// TODO: Implement virtual method: Internal_ShapedTextGetParent(shaped RID,) RID
	// TODO: Implement virtual method: Internal_ShapedTextFitToWidth(shaped RID,width float64,justification_flags TextServerJustificationFlag,) float64
	// TODO: Implement virtual method: Internal_ShapedTextTabAlign(shaped RID,tab_stops PackedFloat32Array,) float64
	// TODO: Implement virtual method: Internal_ShapedTextShape(shaped RID,) bool
	// TODO: Implement virtual method: Internal_ShapedTextUpdateBreaks(shaped RID,) bool
	// TODO: Implement virtual method: Internal_ShapedTextUpdateJustificationOps(shaped RID,) bool
	// TODO: Implement virtual method: Internal_ShapedTextIsReady(shaped RID,) bool
	// TODO: Implement virtual method: Internal_ShapedTextGetGlyphs(shaped RID,) *Glyph
	// TODO: Implement virtual method: Internal_ShapedTextSortLogical(shaped RID,) *Glyph
	// TODO: Implement virtual method: Internal_ShapedTextGetGlyphCount(shaped RID,) int64
	// TODO: Implement virtual method: Internal_ShapedTextGetRange(shaped RID,) Vector2i
	// TODO: Implement virtual method: Internal_ShapedTextGetLineBreaksAdv(shaped RID,width PackedFloat32Array,start int64,once bool,break_flags TextServerLineBreakFlag,) PackedInt32Array
	// TODO: Implement virtual method: Internal_ShapedTextGetLineBreaks(shaped RID,width float64,start int64,break_flags TextServerLineBreakFlag,) PackedInt32Array
	// TODO: Implement virtual method: Internal_ShapedTextGetWordBreaks(shaped RID,grapheme_flags TextServerGraphemeFlag,skip_grapheme_flags TextServerGraphemeFlag,) PackedInt32Array
	// TODO: Implement virtual method: Internal_ShapedTextGetTrimPos(shaped RID,) int64
	// TODO: Implement virtual method: Internal_ShapedTextGetEllipsisPos(shaped RID,) int64
	// TODO: Implement virtual method: Internal_ShapedTextGetEllipsisGlyphCount(shaped RID,) int64
	// TODO: Implement virtual method: Internal_ShapedTextGetEllipsisGlyphs(shaped RID,) *Glyph
	// TODO: Implement virtual method: Internal_ShapedTextOverrunTrimToWidth(shaped RID,width float64,trim_flags TextServerTextOverrunFlag,)
	// TODO: Implement virtual method: Internal_ShapedTextGetObjects(shaped RID,) Array
	// TODO: Implement virtual method: Internal_ShapedTextGetObjectRect(shaped RID,key Variant,) Rect2
	// TODO: Implement virtual method: Internal_ShapedTextGetObjectRange(shaped RID,key Variant,) Vector2i
	// TODO: Implement virtual method: Internal_ShapedTextGetObjectGlyph(shaped RID,key Variant,) int64
	// TODO: Implement virtual method: Internal_ShapedTextGetSize(shaped RID,) Vector2
	// TODO: Implement virtual method: Internal_ShapedTextGetAscent(shaped RID,) float64
	// TODO: Implement virtual method: Internal_ShapedTextGetDescent(shaped RID,) float64
	// TODO: Implement virtual method: Internal_ShapedTextGetWidth(shaped RID,) float64
	// TODO: Implement virtual method: Internal_ShapedTextGetUnderlinePosition(shaped RID,) float64
	// TODO: Implement virtual method: Internal_ShapedTextGetUnderlineThickness(shaped RID,) float64
	// TODO: Implement virtual method: Internal_ShapedTextGetDominantDirectionInRange(shaped RID,start int64,end int64,) int64
	// TODO: Implement virtual method: Internal_ShapedTextGetCarets(shaped RID,position int64,r_caret *CaretInfo,)
	// TODO: Implement virtual method: Internal_ShapedTextGetSelection(shaped RID,start int64,end int64,) PackedVector2Array
	// TODO: Implement virtual method: Internal_ShapedTextHitTestGrapheme(shaped RID,coord float64,) int64
	// TODO: Implement virtual method: Internal_ShapedTextHitTestPosition(shaped RID,coord float64,) int64
	// TODO: Implement virtual method: Internal_ShapedTextDraw(shaped RID,canvas RID,pos Vector2,clip_l float64,clip_r float64,color Color,oversampling float32,)
	// TODO: Implement virtual method: Internal_ShapedTextDrawOutline(shaped RID,canvas RID,pos Vector2,clip_l float64,clip_r float64,outline_size int64,color Color,oversampling float32,)
	// TODO: Implement virtual method: Internal_ShapedTextGetGraphemeBounds(shaped RID,pos int64,) Vector2
	// TODO: Implement virtual method: Internal_ShapedTextNextGraphemePos(shaped RID,pos int64,) int64
	// TODO: Implement virtual method: Internal_ShapedTextPrevGraphemePos(shaped RID,pos int64,) int64
	// TODO: Implement virtual method: Internal_ShapedTextGetCharacterBreaks(shaped RID,) PackedInt32Array
	// TODO: Implement virtual method: Internal_ShapedTextNextCharacterPos(shaped RID,pos int64,) int64
	// TODO: Implement virtual method: Internal_ShapedTextPrevCharacterPos(shaped RID,pos int64,) int64
	// TODO: Implement virtual method: Internal_ShapedTextClosestCharacterPos(shaped RID,pos int64,) int64
	// TODO: Implement virtual method: Internal_FormatNumber(number String,language String,) String
	// TODO: Implement virtual method: Internal_ParseNumber(number String,language String,) String
	// TODO: Implement virtual method: Internal_PercentSign(language String,) String
	// TODO: Implement virtual method: Internal_StripDiacritics(strValue String,) String
	// TODO: Implement virtual method: Internal_IsValidIdentifier(strValue String,) bool
	// TODO: Implement virtual method: Internal_IsValidLetter(unicode uint64,) bool
	// TODO: Implement virtual method: Internal_StringGetWordBreaks(strValue String,language String,chars_per_line int64,) PackedInt32Array
	// TODO: Implement virtual method: Internal_StringGetCharacterBreaks(strValue String,language String,) PackedInt32Array
	// TODO: Implement virtual method: Internal_IsConfusable(strValue String,dict PackedStringArray,) int64
	// TODO: Implement virtual method: Internal_SpoofCheck(strValue String,) bool
	// TODO: Implement virtual method: Internal_StringToUpper(strValue String,language String,) String
	// TODO: Implement virtual method: Internal_StringToLower(strValue String,language String,) String
	// TODO: Implement virtual method: Internal_StringToTitle(strValue String,language String,) String
	// TODO: Implement virtual method: Internal_ParseStructuredText(parser_type TextServerStructuredTextParser,args Array,text String,) Vector3i
	// TODO: Implement virtual method: Internal_Cleanup()
...
type Texture2D interface {
	Texture
	// TODO: Implement virtual method: Internal_GetImage() RefImage
	// TODO: Implement virtual method: Internal_GetFormat() ImageFormat
	// TODO: Implement virtual method: Internal_GetMipmapCount() int32
...
type Theme interface {
	...
	RenameType(old_theme_type StringName, theme_type StringName)
...
type TileData interface {
	...
	SetOccluderPolygonsCount(layer_id int32, polygons_count int32)
	GetOccluderPolygonsCount(layer_id int32) int32
	AddOccluderPolygon(layer_id int32)
	RemoveOccluderPolygon(layer_id int32, polygon_index int32)
	SetOccluderPolygon(layer_id int32, polygon_index int32, polygon RefOccluderPolygon2D)
	GetOccluderPolygon(layer_id int32, polygon_index int32, flip_h bool, flip_v bool, transpose bool) RefOccluderPolygon2D
	SetOccluder(layer_id int32, occluder_polygon RefOccluderPolygon2D)
	GetOccluder(layer_id int32, flip_h bool, flip_v bool, transpose bool) RefOccluderPolygon2D
	...
	IsValidTerrainPeeringBit(peering_bit TileSetCellNeighbor) bool
	...
	HasCustomData(layer_name String) bool
...
type TileMap interface {
	...
	IsCellFlippedH(layer int32, coords Vector2i, use_proxies bool) bool
	IsCellFlippedV(layer int32, coords Vector2i, use_proxies bool) bool
	IsCellTransposed(layer int32, coords Vector2i, use_proxies bool) bool
...
type TileMapLayer interface {
	Node2D
	// TODO: Implement virtual method: Internal_UseTileDataRuntimeUpdate(coords Vector2i,) bool
	// TODO: Implement virtual method: Internal_TileDataRuntimeUpdate(coords Vector2i,tile_data TileData,)
	// TODO: Implement virtual method: Internal_UpdateCells(coords Vector2i,forced_cleanup bool,)
	SetCell(coords Vector2i, source_id int32, atlas_coords Vector2i, alternative_tile int32)
	EraseCell(coords Vector2i)
	FixInvalidTiles()
	Clear()
	...
	IsCellFlippedH(coords Vector2i) bool
	IsCellFlippedV(coords Vector2i) bool
	IsCellTransposed(coords Vector2i) bool
	GetUsedCells() Vector2i
	GetUsedCellsById(source_id int32, atlas_coords Vector2i, alternative_tile int32) Vector2i
	GetUsedRect() Rect2i
	GetPattern(coords_array Vector2i) RefTileMapPattern
	SetPattern(position Vector2i, pattern RefTileMapPattern)
	SetCellsTerrainConnect(cells Vector2i, terrain_set int32, terrain int32, ignore_empty_terrains bool)
	SetCellsTerrainPath(path Vector2i, terrain_set int32, terrain int32, ignore_empty_terrains bool)
	HasBodyRid(body RID) bool
	GetCoordsForBodyRid(body RID) Vector2i
	UpdateInternals()
	...
	MapToLocal(map_position Vector2i) Vector2
	LocalToMap(local_position Vector2) Vector2i
	SetTileMapDataFromArray(tile_map_layer_data PackedByteArray)
	GetTileMapDataAsArray() PackedByteArray
	SetEnabled(enabled bool)
	IsEnabled() bool
	SetTileSet(tile_set RefTileSet)
	GetTileSet() RefTileSet
	SetYSortOrigin(y_sort_origin int32)
	GetYSortOrigin() int32
	SetXDrawOrderReversed(x_draw_order_reversed bool)
	IsXDrawOrderReversed() bool
	SetRenderingQuadrantSize(size int32)
	GetRenderingQuadrantSize() int32
	SetCollisionEnabled(enabled bool)
	IsCollisionEnabled() bool
	SetUseKinematicBodies(use_kinematic_bodies bool)
	IsUsingKinematicBodies() bool
	SetCollisionVisibilityMode(visibility_mode TileMapLayerDebugVisibilityMode)
	GetCollisionVisibilityMode() TileMapLayerDebugVisibilityMode
	SetPhysicsQuadrantSize(size int32)
	GetPhysicsQuadrantSize() int32
	SetOcclusionEnabled(enabled bool)
	IsOcclusionEnabled() bool
	SetNavigationEnabled(enabled bool)
	IsNavigationEnabled() bool
	SetNavigationMap(resourceMap RID)
	GetNavigationMap() RID
	SetNavigationVisibilityMode(show_navigation TileMapLayerDebugVisibilityMode)
	GetNavigationVisibilityMode() TileMapLayerDebugVisibilityMode
}
...
type TileSet interface {
	...
	SetPhysicsLayerCollisionPriority(layer_index int32, priority float32)
	GetPhysicsLayerCollisionPriority(layer_index int32) float32
	...
	ClearTerrains(terrain_set int32)
	...
	HasCustomDataLayerByName(layer_name String) bool
	...
	SetCoordsLevelTileProxy(source_from int32, coords_from Vector2i, source_to int32, coords_to Vector2i)
...
type Timer interface {
	...
	IsPaused() bool
	SetIgnoreTimeScale(ignore bool)
	IsIgnoringTimeScale() bool
	IsStopped() bool
	GetTimeLeft() float64
...
type TranslationDomain interface {
	...
	SetLocaleOverride(locale String)
	IsEnabled() bool
	SetEnabled(enabled bool)
	IsPseudolocalizationEnabled() bool
	SetPseudolocalizationEnabled(enabled bool)
	IsPseudolocalizationAccentsEnabled() bool
	SetPseudolocalizationAccentsEnabled(enabled bool)
	IsPseudolocalizationDoubleVowelsEnabled() bool
	SetPseudolocalizationDoubleVowelsEnabled(enabled bool)
	IsPseudolocalizationFakeBidiEnabled() bool
	SetPseudolocalizationFakeBidiEnabled(enabled bool)
	IsPseudolocalizationOverrideEnabled() bool
	SetPseudolocalizationOverrideEnabled(enabled bool)
	IsPseudolocalizationSkipPlaceholdersEnabled() bool
	SetPseudolocalizationSkipPlaceholdersEnabled(enabled bool)
	GetPseudolocalizationExpansionRatio() float32
	SetPseudolocalizationExpansionRatio(ratio float32)
	GetPseudolocalizationPrefix() String
	SetPseudolocalizationPrefix(prefix String)
	GetPseudolocalizationSuffix() String
	SetPseudolocalizationSuffix(suffix String)
...
type TranslationServer interface {
	...
	StandardizeLocale(locale String, add_defaults bool) String
...
type Tree interface {
	...
	GetCustomDrawingCanvasItem() RID
	...
	SetAllowSearch(allow bool)
	GetAllowSearch() bool
	SetAutoTooltip(enable bool)
	IsAutoTooltipEnabled() bool
}
type TreeItem interface {
	Object
	SetCellMode(column int32, mode TreeItemTreeCellMode)
	GetCellMode(column int32) TreeItemTreeCellMode
	SetAutoTranslateMode(column int32, mode NodeAutoTranslateMode)
	GetAutoTranslateMode(column int32) NodeAutoTranslateMode
	...
	SetDescription(column int32, description String)
	GetDescription(column int32) String
	...
	SetAutowrapTrimFlags(column int32, flags TextServerLineBreakFlag)
	GetAutowrapTrimFlags(column int32) TextServerLineBreakFlag
	...
	SetIconOverlay(column int32, texture RefTexture2D)
	GetIconOverlay(column int32) RefTexture2D
	...
	Select(column int32, set_as_cursor bool)
	...
	ClearButtons()
	AddButton(column int32, button RefTexture2D, id int32, disabled bool, tooltip_text String, description String)
	...
	SetButtonDescription(column int32, button_index int32, description String)
	...
	SetAcceptChildren(allowed bool)
	IsAcceptingChildren() bool
...
type TriangleMesh interface {
	RefCounted
	CreateFromFaces(faces PackedVector3Array) bool
	GetFaces() PackedVector3Array
	IntersectSegment(begin Vector3, end Vector3) Dictionary
	IntersectRay(begin Vector3, dir Vector3) Dictionary
}
...
type Tween interface {
	...
	TweenSubtween(subtween RefTween) RefSubtweenTweener
	TweenAwait(signal Signal) RefAwaitTweener
	...
	SetIgnoreTimeScale(ignore bool) RefTween
...
type UniformSetCacheRD interface {
	Object
	GetCache(shader RID, set uint32, uniforms RefRDUniform) RID
}
...
type Viewport interface {
	...
	SetUseOversampling(enable bool)
	IsUsingOversampling() bool
	SetOversamplingOverride(oversampling float32)
	GetOversamplingOverride() float32
	GetOversampling() float32
	...
	GuiSetDragDescription(description String)
	GuiIsDragging() bool
	...
	SetTextureMipmapBias(texture_mipmap_bias float32)
	GetTextureMipmapBias() float32
	SetAnisotropicFilteringLevel(anisotropic_filtering_level ViewportAnisotropicFiltering)
	GetAnisotropicFilteringLevel() ViewportAnisotropicFiltering
	SetVrsMode(mode ViewportVRSMode)
	GetVrsMode() ViewportVRSMode
	SetVrsUpdateMode(mode ViewportVRSUpdateMode)
...
type VirtualJoystick interface {
	Control
	SetJoystickMode(mode VirtualJoystickJoystickMode)
	GetJoystickMode() VirtualJoystickJoystickMode
	SetJoystickSize(size float32)
	GetJoystickSize() float32
	SetTipSize(size float32)
	GetTipSize() float32
	SetDeadzoneRatio(ratio float32)
	GetDeadzoneRatio() float32
	SetClampzoneRatio(ratio float32)
	GetClampzoneRatio() float32
	SetInitialOffsetRatio(ratio Vector2)
	GetInitialOffsetRatio() Vector2
	SetActionLeft(action StringName)
	GetActionLeft() StringName
	SetActionRight(action StringName)
	GetActionRight() StringName
	SetActionUp(action StringName)
	GetActionUp() StringName
	SetActionDown(action StringName)
	GetActionDown() StringName
	SetVisibilityMode(mode VirtualJoystickVisibilityMode)
	GetVisibilityMode() VirtualJoystickVisibilityMode
}
...
type VisualShaderNodeCubemap interface {
	...
	SetCubeMap(value RefTextureLayered)
	GetCubeMap() RefTextureLayered
...
type VisualShaderNodeFrame interface {
	...
	SetTintColor(color Color)
	GetTintColor() Color
	SetAutoshrinkEnabled(enable bool)
	IsAutoshrinkEnabled() bool
	AddAttachedNode(node int32)
	RemoveAttachedNode(node int32)
	SetAttachedNodes(attached_nodes PackedInt32Array)
	GetAttachedNodes() PackedInt32Array
}
...
type VisualShaderNodeIntParameter interface {
	...
	SetStep(value int32)
	GetStep() int32
	SetEnumNames(names PackedStringArray)
	GetEnumNames() PackedStringArray
	SetDefaultValueEnabled(enabled bool)
	IsDefaultValueEnabled() bool
...
type VisualShaderNodeRemap interface {
	VisualShaderNode
	SetOpType(op_type VisualShaderNodeRemapOpType)
	GetOpType() VisualShaderNodeRemapOpType
}
type VisualShaderNodeReroute interface {
	VisualShaderNode
	GetPortType() VisualShaderNodePortType
}
...
type VisualShaderNodeTexture2DArray interface {
	...
	SetTextureArray(value RefTextureLayered)
	GetTextureArray() RefTextureLayered
}
...
type WebRTCDataChannelExtension interface {
	...
	// TODO: Implement virtual method: Internal_Poll() Error
	// TODO: Implement virtual method: Internal_Close()
	// TODO: Implement virtual method: Internal_SetWriteMode(write_mode WebRTCDataChannelWriteMode,)
	// TODO: Implement virtual method: Internal_GetWriteMode() WebRTCDataChannelWriteMode
	// TODO: Implement virtual method: Internal_WasStringPacket() bool
	// TODO: Implement virtual method: Internal_GetReadyState() WebRTCDataChannelChannelState
	// TODO: Implement virtual method: Internal_GetLabel() String
	// TODO: Implement virtual method: Internal_IsOrdered() bool
	// TODO: Implement virtual method: Internal_GetId() int32
	// TODO: Implement virtual method: Internal_GetMaxPacketLifeTime() int32
	// TODO: Implement virtual method: Internal_GetMaxRetransmits() int32
	// TODO: Implement virtual method: Internal_GetProtocol() String
	// TODO: Implement virtual method: Internal_IsNegotiated() bool
	// TODO: Implement virtual method: Internal_GetBufferedAmount() int32
...
type WebRTCPeerConnectionExtension interface {
	...
	// TODO: Implement virtual method: Internal_GetConnectionState() WebRTCPeerConnectionConnectionState
	// TODO: Implement virtual method: Internal_GetGatheringState() WebRTCPeerConnectionGatheringState
	// TODO: Implement virtual method: Internal_GetSignalingState() WebRTCPeerConnectionSignalingState
	// TODO: Implement virtual method: Internal_Initialize(config Dictionary,) Error
	// TODO: Implement virtual method: Internal_CreateDataChannel(label String,config Dictionary,) RefWebRTCDataChannel
	// TODO: Implement virtual method: Internal_CreateOffer() Error
	// TODO: Implement virtual method: Internal_SetRemoteDescription(typeName String,sdp String,) Error
	// TODO: Implement virtual method: Internal_SetLocalDescription(typeName String,sdp String,) Error
	// TODO: Implement virtual method: Internal_AddIceCandidate(sdp_mid_name String,sdp_mline_index int32,sdp_name String,) Error
	// TODO: Implement virtual method: Internal_Poll() Error
	// TODO: Implement virtual method: Internal_Close()
...
type WebSocketPeer interface {
	...
	GetMaxQueuedPackets() int32
	SetHeartbeatInterval(interval float64)
	GetHeartbeatInterval() float64
}
type WebXRInterface interface {
	...
	GetInputSourceTracker(input_source_id int32) RefXRControllerTracker
...
type Window interface {
	...
	SetHdrOutputRequested(requested bool)
	IsHdrOutputRequested() bool
	GetOutputMaxLinearValue() float32
	IsMaximizeAllowed() bool
	RequestAttention()
	SetTaskbarProgressValue(value float32)
	SetTaskbarProgressState(state DisplayServerProgressState)
	MoveToForeground()
	SetVisible(visible bool)
	IsVisible() bool
	Hide()
	...
	SetTransient(transient bool)
	IsTransient() bool
	SetTransientToFocused(enable bool)
	IsTransientToFocused() bool
...
type XRBodyModifier3D interface {
	...
	GetBodyUpdate() XRBodyModifier3DBodyUpdate
	SetBoneUpdate(bone_update XRBodyModifier3DBoneUpdate)
	GetBoneUpdate() XRBodyModifier3DBoneUpdate
}
type XRBodyTracker interface {
	XRPositionalTracker
	SetHasTrackingData(has_data bool)
	GetHasTrackingData() bool
	SetBodyFlags(flags XRBodyTrackerBodyFlags)
	GetBodyFlags() XRBodyTrackerBodyFlags
	SetJointFlags(joint XRBodyTrackerJoint, flags XRBodyTrackerJointFlags)
	GetJointFlags(joint XRBodyTrackerJoint) XRBodyTrackerJointFlags
	SetJointTransform(joint XRBodyTrackerJoint, transform Transform3D)
	GetJointTransform(joint XRBodyTrackerJoint) Transform3D
}
...
type XRControllerTracker interface {
	XRPositionalTracker
}
...
type XRFaceTracker interface {
	XRTracker
	GetBlendShape(blend_shape XRFaceTrackerBlendShapeEntry) float32
	SetBlendShape(blend_shape XRFaceTrackerBlendShapeEntry, weight float32)
	GetBlendShapes() PackedFloat32Array
	SetBlendShapes(weights PackedFloat32Array)
}
type XRHandModifier3D interface {
	...
	GetBoneUpdate() XRHandModifier3DBoneUpdate
}
type XRHandTracker interface {
	XRPositionalTracker
	SetHasTrackingData(has_data bool)
	GetHasTrackingData() bool
	SetHandTrackingSource(source XRHandTrackerHandTrackingSource)
	GetHandTrackingSource() XRHandTrackerHandTrackingSource
	SetHandJointFlags(joint XRHandTrackerHandJoint, flags XRHandTrackerHandJointFlags)
	GetHandJointFlags(joint XRHandTrackerHandJoint) XRHandTrackerHandJointFlags
	SetHandJointTransform(joint XRHandTrackerHandJoint, transform Transform3D)
	GetHandJointTransform(joint XRHandTrackerHandJoint) Transform3D
	SetHandJointRadius(joint XRHandTrackerHandJoint, radius float32)
	GetHandJointRadius(joint XRHandTrackerHandJoint) float32
	SetHandJointLinearVelocity(joint XRHandTrackerHandJoint, linear_velocity Vector3)
	GetHandJointLinearVelocity(joint XRHandTrackerHandJoint) Vector3
	SetHandJointAngularVelocity(joint XRHandTrackerHandJoint, angular_velocity Vector3)
	GetHandJointAngularVelocity(joint XRHandTrackerHandJoint) Vector3
}
...
type XRInterfaceExtension interface {
	...
	// TODO: Implement virtual method: Internal_GetVrsTextureFormat() XRInterfaceVRSTextureFormat
...
type XRServer interface {
	...
	SetCameraLockedToOrigin(enabled bool)
	IsCameraLockedToOrigin() bool
...
type XRVRS interface {
	...
	GetVrsStrength() float32
	SetVrsStrength(strength float32)
	GetVrsRenderRegion() Rect2i
	SetVrsRenderRegion(render_region Rect2i)
	MakeVrsTexture(target_size Vector2, eye_foci PackedVector2Array) RID
}
type ZIPPacker interface {
	RefCounted
	Open(path String, append ZIPPackerZipAppend) Error
	SetCompressionLevel(compression_level int32)
	GetCompressionLevel() int32
	AddDirectory(path String, permissions FileAccessUnixPermissionFlags, modified_time uint64) Error
	StartFile(path String, permissions FileAccessUnixPermissionFlags, modified_time uint64) Error
...
type ZIPReader interface {
	...
	GetCompressionLevel(path String, case_sensitive bool) int32
}
