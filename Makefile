...
remote_debug_test:
	...
	LOG_LEVEL=info \
	GOTRACEBACK=crash \
	GODEBUG=sbrk=1,asyncpreemptoff=1,cgocheck=1,invalidptr=1,clobberfree=1,tracebackancestors=5 \
...
ci_gen_test_project_files:
	...
	LOG_LEVEL=info \
	GOTRACEBACK=1 \
	GODEBUG=sbrk=1,gctrace=1,asyncpreemptoff=1,cgocheck=1,invalidptr=1,clobberfree=1,tracebackancestors=5 \
