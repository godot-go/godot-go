...
type AccessibilityServerAccessibilityRole int

const (
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_UNKNOWN              AccessibilityServerAccessibilityRole = 0
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_DEFAULT_BUTTON       AccessibilityServerAccessibilityRole = 1
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_AUDIO                AccessibilityServerAccessibilityRole = 2
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_VIDEO                AccessibilityServerAccessibilityRole = 3
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_STATIC_TEXT          AccessibilityServerAccessibilityRole = 4
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_CONTAINER            AccessibilityServerAccessibilityRole = 5
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_PANEL                AccessibilityServerAccessibilityRole = 6
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_BUTTON               AccessibilityServerAccessibilityRole = 7
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_LINK                 AccessibilityServerAccessibilityRole = 8
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_CHECK_BOX            AccessibilityServerAccessibilityRole = 9
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_RADIO_BUTTON         AccessibilityServerAccessibilityRole = 10
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_CHECK_BUTTON         AccessibilityServerAccessibilityRole = 11
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_SCROLL_BAR           AccessibilityServerAccessibilityRole = 12
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_SCROLL_VIEW          AccessibilityServerAccessibilityRole = 13
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_SPLITTER             AccessibilityServerAccessibilityRole = 14
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_SLIDER               AccessibilityServerAccessibilityRole = 15
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_SPIN_BUTTON          AccessibilityServerAccessibilityRole = 16
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_PROGRESS_INDICATOR   AccessibilityServerAccessibilityRole = 17
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_TEXT_FIELD           AccessibilityServerAccessibilityRole = 18
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_MULTILINE_TEXT_FIELD AccessibilityServerAccessibilityRole = 19
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_COLOR_PICKER         AccessibilityServerAccessibilityRole = 20
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_TABLE                AccessibilityServerAccessibilityRole = 21
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_CELL                 AccessibilityServerAccessibilityRole = 22
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_ROW                  AccessibilityServerAccessibilityRole = 23
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_ROW_GROUP            AccessibilityServerAccessibilityRole = 24
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_ROW_HEADER           AccessibilityServerAccessibilityRole = 25
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_COLUMN_HEADER        AccessibilityServerAccessibilityRole = 26
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_TREE                 AccessibilityServerAccessibilityRole = 27
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_TREE_ITEM            AccessibilityServerAccessibilityRole = 28
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_LIST                 AccessibilityServerAccessibilityRole = 29
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_LIST_ITEM            AccessibilityServerAccessibilityRole = 30
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_LIST_BOX             AccessibilityServerAccessibilityRole = 31
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_LIST_BOX_OPTION      AccessibilityServerAccessibilityRole = 32
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_TAB_BAR              AccessibilityServerAccessibilityRole = 33
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_TAB                  AccessibilityServerAccessibilityRole = 34
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_TAB_PANEL            AccessibilityServerAccessibilityRole = 35
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_MENU_BAR             AccessibilityServerAccessibilityRole = 36
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_MENU                 AccessibilityServerAccessibilityRole = 37
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_MENU_ITEM            AccessibilityServerAccessibilityRole = 38
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_MENU_ITEM_CHECK_BOX  AccessibilityServerAccessibilityRole = 39
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_MENU_ITEM_RADIO      AccessibilityServerAccessibilityRole = 40
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_IMAGE                AccessibilityServerAccessibilityRole = 41
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_WINDOW               AccessibilityServerAccessibilityRole = 42
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_TITLE_BAR            AccessibilityServerAccessibilityRole = 43
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_DIALOG               AccessibilityServerAccessibilityRole = 44
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_TOOLTIP              AccessibilityServerAccessibilityRole = 45
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_REGION               AccessibilityServerAccessibilityRole = 46
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ROLE_ROLE_TEXT_RUN             AccessibilityServerAccessibilityRole = 47
)

type AccessibilityServerAccessibilityPopupType int

const (
	ACCESSIBILITY_SERVER_ACCESSIBILITY_POPUP_TYPE_POPUP_MENU   AccessibilityServerAccessibilityPopupType = 0
	ACCESSIBILITY_SERVER_ACCESSIBILITY_POPUP_TYPE_POPUP_LIST   AccessibilityServerAccessibilityPopupType = 1
	ACCESSIBILITY_SERVER_ACCESSIBILITY_POPUP_TYPE_POPUP_TREE   AccessibilityServerAccessibilityPopupType = 2
	ACCESSIBILITY_SERVER_ACCESSIBILITY_POPUP_TYPE_POPUP_DIALOG AccessibilityServerAccessibilityPopupType = 3
)

type AccessibilityServerAccessibilityFlags int

const (
	ACCESSIBILITY_SERVER_ACCESSIBILITY_FLAGS_FLAG_HIDDEN            AccessibilityServerAccessibilityFlags = 0
	ACCESSIBILITY_SERVER_ACCESSIBILITY_FLAGS_FLAG_MULTISELECTABLE   AccessibilityServerAccessibilityFlags = 1
	ACCESSIBILITY_SERVER_ACCESSIBILITY_FLAGS_FLAG_REQUIRED          AccessibilityServerAccessibilityFlags = 2
	ACCESSIBILITY_SERVER_ACCESSIBILITY_FLAGS_FLAG_VISITED           AccessibilityServerAccessibilityFlags = 3
	ACCESSIBILITY_SERVER_ACCESSIBILITY_FLAGS_FLAG_BUSY              AccessibilityServerAccessibilityFlags = 4
	ACCESSIBILITY_SERVER_ACCESSIBILITY_FLAGS_FLAG_MODAL             AccessibilityServerAccessibilityFlags = 5
	ACCESSIBILITY_SERVER_ACCESSIBILITY_FLAGS_FLAG_TOUCH_PASSTHROUGH AccessibilityServerAccessibilityFlags = 6
	ACCESSIBILITY_SERVER_ACCESSIBILITY_FLAGS_FLAG_READONLY          AccessibilityServerAccessibilityFlags = 7
	ACCESSIBILITY_SERVER_ACCESSIBILITY_FLAGS_FLAG_DISABLED          AccessibilityServerAccessibilityFlags = 8
	ACCESSIBILITY_SERVER_ACCESSIBILITY_FLAGS_FLAG_CLIPS_CHILDREN    AccessibilityServerAccessibilityFlags = 9
)

type AccessibilityServerAccessibilityAction int

const (
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_CLICK                 AccessibilityServerAccessibilityAction = 0
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_FOCUS                 AccessibilityServerAccessibilityAction = 1
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_BLUR                  AccessibilityServerAccessibilityAction = 2
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_COLLAPSE              AccessibilityServerAccessibilityAction = 3
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_EXPAND                AccessibilityServerAccessibilityAction = 4
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_DECREMENT             AccessibilityServerAccessibilityAction = 5
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_INCREMENT             AccessibilityServerAccessibilityAction = 6
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_HIDE_TOOLTIP          AccessibilityServerAccessibilityAction = 7
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SHOW_TOOLTIP          AccessibilityServerAccessibilityAction = 8
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SET_TEXT_SELECTION    AccessibilityServerAccessibilityAction = 9
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_REPLACE_SELECTED_TEXT AccessibilityServerAccessibilityAction = 10
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SCROLL_BACKWARD       AccessibilityServerAccessibilityAction = 11
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SCROLL_DOWN           AccessibilityServerAccessibilityAction = 12
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SCROLL_FORWARD        AccessibilityServerAccessibilityAction = 13
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SCROLL_LEFT           AccessibilityServerAccessibilityAction = 14
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SCROLL_RIGHT          AccessibilityServerAccessibilityAction = 15
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SCROLL_UP             AccessibilityServerAccessibilityAction = 16
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SCROLL_INTO_VIEW      AccessibilityServerAccessibilityAction = 17
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SCROLL_TO_POINT       AccessibilityServerAccessibilityAction = 18
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SET_SCROLL_OFFSET     AccessibilityServerAccessibilityAction = 19
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SET_VALUE             AccessibilityServerAccessibilityAction = 20
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_SHOW_CONTEXT_MENU     AccessibilityServerAccessibilityAction = 21
	ACCESSIBILITY_SERVER_ACCESSIBILITY_ACTION_ACTION_CUSTOM                AccessibilityServerAccessibilityAction = 22
)

type AccessibilityServerAccessibilityLiveMode int

const (
	ACCESSIBILITY_SERVER_ACCESSIBILITY_LIVE_MODE_LIVE_OFF       AccessibilityServerAccessibilityLiveMode = 0
	ACCESSIBILITY_SERVER_ACCESSIBILITY_LIVE_MODE_LIVE_POLITE    AccessibilityServerAccessibilityLiveMode = 1
	ACCESSIBILITY_SERVER_ACCESSIBILITY_LIVE_MODE_LIVE_ASSERTIVE AccessibilityServerAccessibilityLiveMode = 2
)

type AccessibilityServerAccessibilityScrollUnit int

const (
	ACCESSIBILITY_SERVER_ACCESSIBILITY_SCROLL_UNIT_SCROLL_UNIT_ITEM AccessibilityServerAccessibilityScrollUnit = 0
	ACCESSIBILITY_SERVER_ACCESSIBILITY_SCROLL_UNIT_SCROLL_UNIT_PAGE AccessibilityServerAccessibilityScrollUnit = 1
)

type AccessibilityServerAccessibilityScrollHint int

const (
	ACCESSIBILITY_SERVER_ACCESSIBILITY_SCROLL_HINT_SCROLL_HINT_TOP_LEFT     AccessibilityServerAccessibilityScrollHint = 0
	ACCESSIBILITY_SERVER_ACCESSIBILITY_SCROLL_HINT_SCROLL_HINT_BOTTOM_RIGHT AccessibilityServerAccessibilityScrollHint = 1
	ACCESSIBILITY_SERVER_ACCESSIBILITY_SCROLL_HINT_SCROLL_HINT_TOP_EDGE     AccessibilityServerAccessibilityScrollHint = 2
	ACCESSIBILITY_SERVER_ACCESSIBILITY_SCROLL_HINT_SCROLL_HINT_BOTTOM_EDGE  AccessibilityServerAccessibilityScrollHint = 3
	ACCESSIBILITY_SERVER_ACCESSIBILITY_SCROLL_HINT_SCROLL_HINT_LEFT_EDGE    AccessibilityServerAccessibilityScrollHint = 4
	ACCESSIBILITY_SERVER_ACCESSIBILITY_SCROLL_HINT_SCROLL_HINT_RIGHT_EDGE   AccessibilityServerAccessibilityScrollHint = 5
)
...
type AnimationNodeBlendSpace1DSyncMode int

const (
	ANIMATION_NODE_BLEND_SPACE_1_D_SYNC_MODE_SYNC_MODE_NONE            AnimationNodeBlendSpace1DSyncMode = 0
	ANIMATION_NODE_BLEND_SPACE_1_D_SYNC_MODE_SYNC_MODE_INDEPENDENT     AnimationNodeBlendSpace1DSyncMode = 1
	ANIMATION_NODE_BLEND_SPACE_1_D_SYNC_MODE_SYNC_MODE_CYCLIC_MUTABLE  AnimationNodeBlendSpace1DSyncMode = 2
	ANIMATION_NODE_BLEND_SPACE_1_D_SYNC_MODE_SYNC_MODE_CYCLIC_CONSTANT AnimationNodeBlendSpace1DSyncMode = 3
)
...
type AnimationNodeBlendSpace2DSyncMode int

const (
	ANIMATION_NODE_BLEND_SPACE_2_D_SYNC_MODE_SYNC_MODE_NONE            AnimationNodeBlendSpace2DSyncMode = 0
	ANIMATION_NODE_BLEND_SPACE_2_D_SYNC_MODE_SYNC_MODE_INDEPENDENT     AnimationNodeBlendSpace2DSyncMode = 1
	ANIMATION_NODE_BLEND_SPACE_2_D_SYNC_MODE_SYNC_MODE_CYCLIC_MUTABLE  AnimationNodeBlendSpace2DSyncMode = 2
	ANIMATION_NODE_BLEND_SPACE_2_D_SYNC_MODE_SYNC_MODE_CYCLIC_CONSTANT AnimationNodeBlendSpace2DSyncMode = 3
)
...
const (
	...
	AUDIO_STREAM_INTERACTIVE_TRANSITION_TO_TIME_TRANSITION_TO_TIME_PREVIOUS_POSITION AudioStreamInteractiveTransitionToTime = 2
)
...
type BlitMaterialBlendMode int

const (
	BLIT_MATERIAL_BLEND_MODE_BLEND_MODE_MIX      BlitMaterialBlendMode = 0
	BLIT_MATERIAL_BLEND_MODE_BLEND_MODE_ADD      BlitMaterialBlendMode = 1
	BLIT_MATERIAL_BLEND_MODE_BLEND_MODE_SUB      BlitMaterialBlendMode = 2
	BLIT_MATERIAL_BLEND_MODE_BLEND_MODE_MUL      BlitMaterialBlendMode = 3
	BLIT_MATERIAL_BLEND_MODE_BLEND_MODE_DISABLED BlitMaterialBlendMode = 4
)

type BoneConstraint3DReferenceType int

const (
	BONE_CONSTRAINT_3_D_REFERENCE_TYPE_REFERENCE_TYPE_BONE BoneConstraint3DReferenceType = 0
	BONE_CONSTRAINT_3_D_REFERENCE_TYPE_REFERENCE_TYPE_NODE BoneConstraint3DReferenceType = 1
)

type BoneTwistDisperser3DDisperseMode int

const (
	BONE_TWIST_DISPERSER_3_D_DISPERSE_MODE_DISPERSE_MODE_EVEN     BoneTwistDisperser3DDisperseMode = 0
	BONE_TWIST_DISPERSER_3_D_DISPERSE_MODE_DISPERSE_MODE_WEIGHTED BoneTwistDisperser3DDisperseMode = 1
	BONE_TWIST_DISPERSER_3_D_DISPERSE_MODE_DISPERSE_MODE_CUSTOM   BoneTwistDisperser3DDisperseMode = 2
)
...
const (
	...
	CPU_PARTICLES_2_D_EMISSION_SHAPE_EMISSION_SHAPE_RING            CPUParticles2DEmissionShape = 6
	CPU_PARTICLES_2_D_EMISSION_SHAPE_EMISSION_SHAPE_MAX             CPUParticles2DEmissionShape = 7
)
...
type CanvasItemOversamplingWithScale int

const (
	CANVAS_ITEM_OVERSAMPLING_WITH_SCALE_OVERSAMPLING_WITH_SCALE_PARENT_NODE CanvasItemOversamplingWithScale = 0
	CANVAS_ITEM_OVERSAMPLING_WITH_SCALE_OVERSAMPLING_WITH_SCALE_DISABLED    CanvasItemOversamplingWithScale = 1
	CANVAS_ITEM_OVERSAMPLING_WITH_SCALE_OVERSAMPLING_WITH_SCALE_ENABLED     CanvasItemOversamplingWithScale = 2
	CANVAS_ITEM_OVERSAMPLING_WITH_SCALE_OVERSAMPLING_WITH_SCALE_MAX         CanvasItemOversamplingWithScale = 3
)
...
const (
	...
	CODE_EDIT_CODE_COMPLETION_KIND_KIND_KEYWORD    CodeEditCodeCompletionKind = 10
)
...
const (
	...
	DISPLAY_SERVER_FEATURE_FEATURE_HDR_OUTPUT                  DisplayServerFeature = 35
	DISPLAY_SERVER_FEATURE_FEATURE_PIP_MODE                    DisplayServerFeature = 36
)
...
const (
	...
	DISPLAY_SERVER_ACCESSIBILITY_ROLE_ROLE_REGION               DisplayServerAccessibilityRole = 46
	DISPLAY_SERVER_ACCESSIBILITY_ROLE_ROLE_TEXT_RUN             DisplayServerAccessibilityRole = 47
)
...
type DisplayServerProgressState int

const (
	DISPLAY_SERVER_PROGRESS_STATE_PROGRESS_STATE_NOPROGRESS    DisplayServerProgressState = 0
	DISPLAY_SERVER_PROGRESS_STATE_PROGRESS_STATE_INDETERMINATE DisplayServerProgressState = 1
	DISPLAY_SERVER_PROGRESS_STATE_PROGRESS_STATE_NORMAL        DisplayServerProgressState = 2
	DISPLAY_SERVER_PROGRESS_STATE_PROGRESS_STATE_ERROR         DisplayServerProgressState = 3
	DISPLAY_SERVER_PROGRESS_STATE_PROGRESS_STATE_PAUSED        DisplayServerProgressState = 4
)
...
const (
	...
	DISPLAY_SERVER_WINDOW_EVENT_WINDOW_EVENT_OUTPUT_MAX_LINEAR_VALUE_CHANGED DisplayServerWindowEvent = 9
)
...
const (
	...
	DISPLAY_SERVER_HANDLE_TYPE_GLX_VISUALID   DisplayServerHandleType = 6
	DISPLAY_SERVER_HANDLE_TYPE_GLX_FBCONFIG   DisplayServerHandleType = 7
)
...
type DrawableTexture2DDrawableFormat int

const (
	DRAWABLE_TEXTURE_2_D_DRAWABLE_FORMAT_DRAWABLE_FORMAT_RGBA_8      DrawableTexture2DDrawableFormat = 0
	DRAWABLE_TEXTURE_2_D_DRAWABLE_FORMAT_DRAWABLE_FORMAT_RGBA_8_SRGB DrawableTexture2DDrawableFormat = 1
	DRAWABLE_TEXTURE_2_D_DRAWABLE_FORMAT_DRAWABLE_FORMAT_RGBAH       DrawableTexture2DDrawableFormat = 2
	DRAWABLE_TEXTURE_2_D_DRAWABLE_FORMAT_DRAWABLE_FORMAT_RGBAF       DrawableTexture2DDrawableFormat = 3
)
...
const (
	...
	EDITOR_CONTEXT_MENU_PLUGIN_CONTEXT_MENU_SLOT_CONTEXT_SLOT_INSPECTOR_PROPERTY EditorContextMenuPluginContextMenuSlot = 7
)

type EditorDockDockLayout int

const (
	EDITOR_DOCK_DOCK_LAYOUT_DOCK_LAYOUT_VERTICAL   EditorDockDockLayout = 1
	EDITOR_DOCK_DOCK_LAYOUT_DOCK_LAYOUT_HORIZONTAL EditorDockDockLayout = 2
	EDITOR_DOCK_DOCK_LAYOUT_DOCK_LAYOUT_FLOATING   EditorDockDockLayout = 4
	EDITOR_DOCK_DOCK_LAYOUT_DOCK_LAYOUT_ALL        EditorDockDockLayout = 7
)

type EditorDockDockSlot int

const (
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_NONE     EditorDockDockSlot = -1
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_LEFT_UL  EditorDockDockSlot = 0
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_LEFT_BL  EditorDockDockSlot = 1
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_LEFT_UR  EditorDockDockSlot = 2
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_LEFT_BR  EditorDockDockSlot = 3
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_RIGHT_UL EditorDockDockSlot = 4
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_RIGHT_BL EditorDockDockSlot = 5
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_RIGHT_UR EditorDockDockSlot = 6
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_RIGHT_BR EditorDockDockSlot = 7
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_BOTTOM   EditorDockDockSlot = 8
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_BOTTOM_L EditorDockDockSlot = 9
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_BOTTOM_R EditorDockDockSlot = 10
	EDITOR_DOCK_DOCK_SLOT_DOCK_SLOT_MAX      EditorDockDockSlot = 11
)
...
const (
	...
	EDITOR_FEATURE_PROFILE_FEATURE_FEATURE_SIGNALS_DOCK    EditorFeatureProfileFeature = 9
	EDITOR_FEATURE_PROFILE_FEATURE_FEATURE_GROUPS_DOCK     EditorFeatureProfileFeature = 10
	EDITOR_FEATURE_PROFILE_FEATURE_FEATURE_MAX             EditorFeatureProfileFeature = 11
)
...
const (
	EDITOR_PLUGIN_DOCK_SLOT_DOCK_SLOT_NONE     EditorPluginDockSlot = -1
	...
	EDITOR_PLUGIN_DOCK_SLOT_DOCK_SLOT_BOTTOM   EditorPluginDockSlot = 8
	EDITOR_PLUGIN_DOCK_SLOT_DOCK_SLOT_MAX      EditorPluginDockSlot = 9
)
...
type EditorSceneFormatImporterImportFlags int

const (
	EDITOR_SCENE_FORMAT_IMPORTER_IMPORT_FLAGS_IMPORT_SCENE                          EditorSceneFormatImporterImportFlags = 1
	EDITOR_SCENE_FORMAT_IMPORTER_IMPORT_FLAGS_IMPORT_ANIMATION                      EditorSceneFormatImporterImportFlags = 2
	EDITOR_SCENE_FORMAT_IMPORTER_IMPORT_FLAGS_IMPORT_FAIL_ON_MISSING_DEPENDENCIES   EditorSceneFormatImporterImportFlags = 4
	EDITOR_SCENE_FORMAT_IMPORTER_IMPORT_FLAGS_IMPORT_GENERATE_TANGENT_ARRAYS        EditorSceneFormatImporterImportFlags = 8
	EDITOR_SCENE_FORMAT_IMPORTER_IMPORT_FLAGS_IMPORT_USE_NAMED_SKIN_BINDS           EditorSceneFormatImporterImportFlags = 16
	EDITOR_SCENE_FORMAT_IMPORTER_IMPORT_FLAGS_IMPORT_DISCARD_MESHES_AND_MATERIALS   EditorSceneFormatImporterImportFlags = 32
	EDITOR_SCENE_FORMAT_IMPORTER_IMPORT_FLAGS_IMPORT_FORCE_DISABLE_MESH_COMPRESSION EditorSceneFormatImporterImportFlags = 64
)
...
type EditorSpinSliderControlState int

const (
	EDITOR_SPIN_SLIDER_CONTROL_STATE_CONTROL_STATE_DEFAULT       EditorSpinSliderControlState = 0
	EDITOR_SPIN_SLIDER_CONTROL_STATE_CONTROL_STATE_PREFER_SLIDER EditorSpinSliderControlState = 1
	EDITOR_SPIN_SLIDER_CONTROL_STATE_CONTROL_STATE_HIDE          EditorSpinSliderControlState = 2
)
...
const (
	...
	FILE_DIALOG_CUSTOMIZATION_CUSTOMIZATION_OVERWRITE_WARNING FileDialogCustomization = 7
	FILE_DIALOG_CUSTOMIZATION_CUSTOMIZATION_DELETE            FileDialogCustomization = 8
)
...
type GLTFDocumentTextureMapMode int

const (
	GLTF_DOCUMENT_TEXTURE_MAP_MODE_TEXTURE_MAP_MODE_DO_NOT_REMAP               GLTFDocumentTextureMapMode = 0
	GLTF_DOCUMENT_TEXTURE_MAP_MODE_TEXTURE_MAP_MODE_REMAP_TO_STANDARD_MATERIAL GLTFDocumentTextureMapMode = 1
)
...
type GLTFDocumentImportFlags int

const (
	GLTF_DOCUMENT_IMPORT_FLAGS_IMPORT_FLAG_GENERATE_TANGENT_ARRAYS        GLTFDocumentImportFlags = 8
	GLTF_DOCUMENT_IMPORT_FLAGS_IMPORT_FLAG_USE_NAMED_SKIN_BINDS           GLTFDocumentImportFlags = 16
	GLTF_DOCUMENT_IMPORT_FLAGS_IMPORT_FLAG_DISCARD_MESHES_AND_MATERIALS   GLTFDocumentImportFlags = 32
	GLTF_DOCUMENT_IMPORT_FLAGS_IMPORT_FLAG_FORCE_DISABLE_MESH_COMPRESSION GLTFDocumentImportFlags = 64
)
...
type GLTFStateHandleBinaryImageMode int

const (
	GLTF_STATE_HANDLE_BINARY_IMAGE_MODE_HANDLE_BINARY_IMAGE_MODE_DISCARD_TEXTURES      GLTFStateHandleBinaryImageMode = 0
	GLTF_STATE_HANDLE_BINARY_IMAGE_MODE_HANDLE_BINARY_IMAGE_MODE_EXTRACT_TEXTURES      GLTFStateHandleBinaryImageMode = 1
	GLTF_STATE_HANDLE_BINARY_IMAGE_MODE_HANDLE_BINARY_IMAGE_MODE_EMBED_AS_BASISU       GLTFStateHandleBinaryImageMode = 2
	GLTF_STATE_HANDLE_BINARY_IMAGE_MODE_HANDLE_BINARY_IMAGE_MODE_EMBED_AS_UNCOMPRESSED GLTFStateHandleBinaryImageMode = 3
)
...
const (
	...
	GPU_PARTICLES_3_D_TRANSFORM_ALIGN_TRANSFORM_ALIGN_LOCAL_BILLBOARD           GPUParticles3DTransformAlign = 4
)
...
const (
	...
	GRADIENT_TEXTURE_2_D_FILL_FILL_CONIC  GradientTexture2DFill = 3
)
...
type GridMapDebugVisibilityMode int

const (
	GRID_MAP_DEBUG_VISIBILITY_MODE_DEBUG_VISIBILITY_MODE_DEFAULT    GridMapDebugVisibilityMode = 0
	GRID_MAP_DEBUG_VISIBILITY_MODE_DEBUG_VISIBILITY_MODE_FORCE_SHOW GridMapDebugVisibilityMode = 1
	GRID_MAP_DEBUG_VISIBILITY_MODE_DEBUG_VISIBILITY_MODE_FORCE_HIDE GridMapDebugVisibilityMode = 2
)
...
const (
	...
	IMAGE_FORMAT_FORMAT_R_16            ImageFormat = 39
	IMAGE_FORMAT_FORMAT_RG_16           ImageFormat = 40
	IMAGE_FORMAT_FORMAT_RGB_16          ImageFormat = 41
	IMAGE_FORMAT_FORMAT_RGBA_16         ImageFormat = 42
	IMAGE_FORMAT_FORMAT_R_16_I          ImageFormat = 43
	IMAGE_FORMAT_FORMAT_RG_16_I         ImageFormat = 44
	IMAGE_FORMAT_FORMAT_RGB_16_I        ImageFormat = 45
	IMAGE_FORMAT_FORMAT_RGBA_16_I       ImageFormat = 46
	IMAGE_FORMAT_FORMAT_MAX             ImageFormat = 47
)
...
type ItemListScrollHintMode int

const (
	ITEM_LIST_SCROLL_HINT_MODE_SCROLL_HINT_MODE_DISABLED ItemListScrollHintMode = 0
	ITEM_LIST_SCROLL_HINT_MODE_SCROLL_HINT_MODE_BOTH     ItemListScrollHintMode = 1
	ITEM_LIST_SCROLL_HINT_MODE_SCROLL_HINT_MODE_TOP      ItemListScrollHintMode = 2
	ITEM_LIST_SCROLL_HINT_MODE_SCROLL_HINT_MODE_BOTTOM   ItemListScrollHintMode = 3
)
...
type LineEditExpandMode int

const (
	LINE_EDIT_EXPAND_MODE_EXPAND_MODE_ORIGINAL_SIZE    LineEditExpandMode = 0
	LINE_EDIT_EXPAND_MODE_EXPAND_MODE_FIT_TO_TEXT      LineEditExpandMode = 1
	LINE_EDIT_EXPAND_MODE_EXPAND_MODE_FIT_TO_LINE_EDIT LineEditExpandMode = 2
)
...
const (
	...
	NODE_DUPLICATE_FLAGS_DUPLICATE_INTERNAL_STATE    NodeDuplicateFlags = 16
	NODE_DUPLICATE_FLAGS_DUPLICATE_DEFAULT           NodeDuplicateFlags = 15
)
...
type OpenXRAndroidThreadSettingsExtensionThreadType int

const (
	OPEN_XR_ANDROID_THREAD_SETTINGS_EXTENSION_THREAD_TYPE_THREAD_TYPE_APPLICATION_MAIN   OpenXRAndroidThreadSettingsExtensionThreadType = 0
	OPEN_XR_ANDROID_THREAD_SETTINGS_EXTENSION_THREAD_TYPE_THREAD_TYPE_APPLICATION_WORKER OpenXRAndroidThreadSettingsExtensionThreadType = 1
	OPEN_XR_ANDROID_THREAD_SETTINGS_EXTENSION_THREAD_TYPE_THREAD_TYPE_RENDERER_MAIN      OpenXRAndroidThreadSettingsExtensionThreadType = 2
	OPEN_XR_ANDROID_THREAD_SETTINGS_EXTENSION_THREAD_TYPE_THREAD_TYPE_RENDERER_WORKER    OpenXRAndroidThreadSettingsExtensionThreadType = 3
)
...
type OpenXRCompositionLayerEyeVisibility int

const (
	OPEN_XR_COMPOSITION_LAYER_EYE_VISIBILITY_EYE_VISIBILITY_BOTH  OpenXRCompositionLayerEyeVisibility = 0
	OPEN_XR_COMPOSITION_LAYER_EYE_VISIBILITY_EYE_VISIBILITY_LEFT  OpenXRCompositionLayerEyeVisibility = 1
	OPEN_XR_COMPOSITION_LAYER_EYE_VISIBILITY_EYE_VISIBILITY_RIGHT OpenXRCompositionLayerEyeVisibility = 2
)
...
type OpenXRSpatialAnchorCapabilityPersistenceScope int

const (
	OPEN_XR_SPATIAL_ANCHOR_CAPABILITY_PERSISTENCE_SCOPE_PERSISTENCE_SCOPE_SYSTEM_MANAGED OpenXRSpatialAnchorCapabilityPersistenceScope = 1
	OPEN_XR_SPATIAL_ANCHOR_CAPABILITY_PERSISTENCE_SCOPE_PERSISTENCE_SCOPE_LOCAL_ANCHORS  OpenXRSpatialAnchorCapabilityPersistenceScope = 1000781000
)

type OpenXRSpatialCapabilityConfigurationAprilTagAprilTagDict int

const (
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_APRIL_TAG_APRIL_TAG_DICT_APRIL_TAG_DICT_16_H_5  OpenXRSpatialCapabilityConfigurationAprilTagAprilTagDict = 1
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_APRIL_TAG_APRIL_TAG_DICT_APRIL_TAG_DICT_25_H_9  OpenXRSpatialCapabilityConfigurationAprilTagAprilTagDict = 2
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_APRIL_TAG_APRIL_TAG_DICT_APRIL_TAG_DICT_36_H_10 OpenXRSpatialCapabilityConfigurationAprilTagAprilTagDict = 3
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_APRIL_TAG_APRIL_TAG_DICT_APRIL_TAG_DICT_36_H_11 OpenXRSpatialCapabilityConfigurationAprilTagAprilTagDict = 4
)

type OpenXRSpatialCapabilityConfigurationArucoArucoDict int

const (
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_4_X_4_50   OpenXRSpatialCapabilityConfigurationArucoArucoDict = 1
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_4_X_4_100  OpenXRSpatialCapabilityConfigurationArucoArucoDict = 2
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_4_X_4_250  OpenXRSpatialCapabilityConfigurationArucoArucoDict = 3
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_4_X_4_1000 OpenXRSpatialCapabilityConfigurationArucoArucoDict = 4
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_5_X_5_50   OpenXRSpatialCapabilityConfigurationArucoArucoDict = 5
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_5_X_5_100  OpenXRSpatialCapabilityConfigurationArucoArucoDict = 6
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_5_X_5_250  OpenXRSpatialCapabilityConfigurationArucoArucoDict = 7
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_5_X_5_1000 OpenXRSpatialCapabilityConfigurationArucoArucoDict = 8
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_6_X_6_50   OpenXRSpatialCapabilityConfigurationArucoArucoDict = 9
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_6_X_6_100  OpenXRSpatialCapabilityConfigurationArucoArucoDict = 10
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_6_X_6_250  OpenXRSpatialCapabilityConfigurationArucoArucoDict = 11
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_6_X_6_1000 OpenXRSpatialCapabilityConfigurationArucoArucoDict = 12
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_7_X_7_50   OpenXRSpatialCapabilityConfigurationArucoArucoDict = 13
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_7_X_7_100  OpenXRSpatialCapabilityConfigurationArucoArucoDict = 14
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_7_X_7_250  OpenXRSpatialCapabilityConfigurationArucoArucoDict = 15
	OPEN_XR_SPATIAL_CAPABILITY_CONFIGURATION_ARUCO_ARUCO_DICT_ARUCO_DICT_7_X_7_1000 OpenXRSpatialCapabilityConfigurationArucoArucoDict = 16
)

type OpenXRSpatialComponentMarkerListMarkerType int

const (
	OPEN_XR_SPATIAL_COMPONENT_MARKER_LIST_MARKER_TYPE_MARKER_TYPE_UNKNOWN      OpenXRSpatialComponentMarkerListMarkerType = 0
	OPEN_XR_SPATIAL_COMPONENT_MARKER_LIST_MARKER_TYPE_MARKER_TYPE_QRCODE       OpenXRSpatialComponentMarkerListMarkerType = 1
	OPEN_XR_SPATIAL_COMPONENT_MARKER_LIST_MARKER_TYPE_MARKER_TYPE_MICRO_QRCODE OpenXRSpatialComponentMarkerListMarkerType = 2
	OPEN_XR_SPATIAL_COMPONENT_MARKER_LIST_MARKER_TYPE_MARKER_TYPE_ARUCO        OpenXRSpatialComponentMarkerListMarkerType = 3
	OPEN_XR_SPATIAL_COMPONENT_MARKER_LIST_MARKER_TYPE_MARKER_TYPE_APRIL_TAG    OpenXRSpatialComponentMarkerListMarkerType = 4
	OPEN_XR_SPATIAL_COMPONENT_MARKER_LIST_MARKER_TYPE_MARKER_TYPE_MAX          OpenXRSpatialComponentMarkerListMarkerType = 5
)

type OpenXRSpatialComponentPlaneAlignmentListPlaneAlignment int

const (
	OPEN_XR_SPATIAL_COMPONENT_PLANE_ALIGNMENT_LIST_PLANE_ALIGNMENT_PLANE_ALIGNMENT_HORIZONTAL_UPWARD   OpenXRSpatialComponentPlaneAlignmentListPlaneAlignment = 0
	OPEN_XR_SPATIAL_COMPONENT_PLANE_ALIGNMENT_LIST_PLANE_ALIGNMENT_PLANE_ALIGNMENT_HORIZONTAL_DOWNWARD OpenXRSpatialComponentPlaneAlignmentListPlaneAlignment = 1
	OPEN_XR_SPATIAL_COMPONENT_PLANE_ALIGNMENT_LIST_PLANE_ALIGNMENT_PLANE_ALIGNMENT_VERTICAL            OpenXRSpatialComponentPlaneAlignmentListPlaneAlignment = 2
	OPEN_XR_SPATIAL_COMPONENT_PLANE_ALIGNMENT_LIST_PLANE_ALIGNMENT_PLANE_ALIGNMENT_ARBITRARY           OpenXRSpatialComponentPlaneAlignmentListPlaneAlignment = 3
)

type OpenXRSpatialComponentPlaneSemanticLabelListPlaneSemanticLabel int

const (
	OPEN_XR_SPATIAL_COMPONENT_PLANE_SEMANTIC_LABEL_LIST_PLANE_SEMANTIC_LABEL_PLANE_SEMANTIC_LABEL_UNCATEGORIZED OpenXRSpatialComponentPlaneSemanticLabelListPlaneSemanticLabel = 1
	OPEN_XR_SPATIAL_COMPONENT_PLANE_SEMANTIC_LABEL_LIST_PLANE_SEMANTIC_LABEL_PLANE_SEMANTIC_LABEL_FLOOR         OpenXRSpatialComponentPlaneSemanticLabelListPlaneSemanticLabel = 2
	OPEN_XR_SPATIAL_COMPONENT_PLANE_SEMANTIC_LABEL_LIST_PLANE_SEMANTIC_LABEL_PLANE_SEMANTIC_LABEL_WALL          OpenXRSpatialComponentPlaneSemanticLabelListPlaneSemanticLabel = 3
	OPEN_XR_SPATIAL_COMPONENT_PLANE_SEMANTIC_LABEL_LIST_PLANE_SEMANTIC_LABEL_PLANE_SEMANTIC_LABEL_CEILING       OpenXRSpatialComponentPlaneSemanticLabelListPlaneSemanticLabel = 4
	OPEN_XR_SPATIAL_COMPONENT_PLANE_SEMANTIC_LABEL_LIST_PLANE_SEMANTIC_LABEL_PLANE_SEMANTIC_LABEL_TABLE         OpenXRSpatialComponentPlaneSemanticLabelListPlaneSemanticLabel = 5
)

type OpenXRSpatialEntityExtensionCapability int

const (
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_CAPABILITY_CAPABILITY_PLANE_TRACKING                OpenXRSpatialEntityExtensionCapability = 1000741000
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_CAPABILITY_CAPABILITY_MARKER_TRACKING_QR_CODE       OpenXRSpatialEntityExtensionCapability = 1000743000
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_CAPABILITY_CAPABILITY_MARKER_TRACKING_MICRO_QR_CODE OpenXRSpatialEntityExtensionCapability = 1000743001
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_CAPABILITY_CAPABILITY_MARKER_TRACKING_ARUCO_MARKER  OpenXRSpatialEntityExtensionCapability = 1000743002
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_CAPABILITY_CAPABILITY_MARKER_TRACKING_APRIL_TAG     OpenXRSpatialEntityExtensionCapability = 1000743003
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_CAPABILITY_CAPABILITY_ANCHOR                        OpenXRSpatialEntityExtensionCapability = 1000762000
)

type OpenXRSpatialEntityExtensionComponentType int

const (
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_BOUNDED_2_D          OpenXRSpatialEntityExtensionComponentType = 1
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_BOUNDED_3_D          OpenXRSpatialEntityExtensionComponentType = 2
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_PARENT               OpenXRSpatialEntityExtensionComponentType = 3
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_MESH_3_D             OpenXRSpatialEntityExtensionComponentType = 4
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_PLANE_ALIGNMENT      OpenXRSpatialEntityExtensionComponentType = 1000741000
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_MESH_2_D             OpenXRSpatialEntityExtensionComponentType = 1000741001
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_POLYGON_2_D          OpenXRSpatialEntityExtensionComponentType = 1000741002
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_PLANE_SEMANTIC_LABEL OpenXRSpatialEntityExtensionComponentType = 1000741003
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_MARKER               OpenXRSpatialEntityExtensionComponentType = 1000743000
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_ANCHOR               OpenXRSpatialEntityExtensionComponentType = 1000762000
	OPEN_XR_SPATIAL_ENTITY_EXTENSION_COMPONENT_TYPE_COMPONENT_TYPE_PERSISTENCE          OpenXRSpatialEntityExtensionComponentType = 1000763000
)

type OpenXRSpatialEntityTrackerEntityTrackingState int

const (
	OPEN_XR_SPATIAL_ENTITY_TRACKER_ENTITY_TRACKING_STATE_ENTITY_TRACKING_STATE_STOPPED  OpenXRSpatialEntityTrackerEntityTrackingState = 1
	OPEN_XR_SPATIAL_ENTITY_TRACKER_ENTITY_TRACKING_STATE_ENTITY_TRACKING_STATE_PAUSED   OpenXRSpatialEntityTrackerEntityTrackingState = 2
	OPEN_XR_SPATIAL_ENTITY_TRACKER_ENTITY_TRACKING_STATE_ENTITY_TRACKING_STATE_TRACKING OpenXRSpatialEntityTrackerEntityTrackingState = 3
)
...
const (
	...
	PARTICLE_PROCESS_MATERIAL_PARTICLE_FLAGS_PARTICLE_FLAG_INHERIT_EMITTER_SCALE ParticleProcessMaterialParticleFlags = 4
	PARTICLE_PROCESS_MATERIAL_PARTICLE_FLAGS_PARTICLE_FLAG_MAX                   ParticleProcessMaterialParticleFlags = 5
)
...
type PerformanceMonitorType int

const (
	PERFORMANCE_MONITOR_TYPE_MONITOR_TYPE_QUANTITY   PerformanceMonitorType = 0
	PERFORMANCE_MONITOR_TYPE_MONITOR_TYPE_MEMORY     PerformanceMonitorType = 1
	PERFORMANCE_MONITOR_TYPE_MONITOR_TYPE_TIME       PerformanceMonitorType = 2
	PERFORMANCE_MONITOR_TYPE_MONITOR_TYPE_PERCENTAGE PerformanceMonitorType = 3
)
...
const (
	...
	RENDERING_DEVICE_TEXTURE_USAGE_BITS_TEXTURE_USAGE_DEPTH_RESOLVE_ATTACHMENT_BIT RenderingDeviceTextureUsageBits = 4096
...
const (
	...
	RENDERING_DEVICE_BUFFER_CREATION_BITS_BUFFER_CREATION_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT RenderingDeviceBufferCreationBits = 8
)

type RenderingDeviceAccelerationStructureFlagBits int

const (
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_FLAG_BITS_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT      RenderingDeviceAccelerationStructureFlagBits = 1
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_FLAG_BITS_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT  RenderingDeviceAccelerationStructureFlagBits = 2
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_FLAG_BITS_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT RenderingDeviceAccelerationStructureFlagBits = 4
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_FLAG_BITS_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT RenderingDeviceAccelerationStructureFlagBits = 8
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_FLAG_BITS_ACCELERATION_STRUCTURE_LOW_MEMORY_BIT        RenderingDeviceAccelerationStructureFlagBits = 16
)

type RenderingDeviceAccelerationStructureGeometryFlagBits int

const (
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_GEOMETRY_FLAG_BITS_ACCELERATION_STRUCTURE_GEOMETRY_OPAQUE_BIT                          RenderingDeviceAccelerationStructureGeometryFlagBits = 1
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_GEOMETRY_FLAG_BITS_ACCELERATION_STRUCTURE_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT RenderingDeviceAccelerationStructureGeometryFlagBits = 2
)

type RenderingDeviceAccelerationStructureInstanceFlagBits int

const (
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_INSTANCE_FLAG_BITS_ACCELERATION_STRUCTURE_INSTANCE_TRIANGLE_FACING_CULL_DISABLE_BIT RenderingDeviceAccelerationStructureInstanceFlagBits = 1
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_INSTANCE_FLAG_BITS_ACCELERATION_STRUCTURE_INSTANCE_TRIANGLE_FLIP_FACING_BIT         RenderingDeviceAccelerationStructureInstanceFlagBits = 2
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_INSTANCE_FLAG_BITS_ACCELERATION_STRUCTURE_INSTANCE_FORCE_OPAQUE_BIT                 RenderingDeviceAccelerationStructureInstanceFlagBits = 4
	RENDERING_DEVICE_ACCELERATION_STRUCTURE_INSTANCE_FLAG_BITS_ACCELERATION_STRUCTURE_INSTANCE_FORCE_NO_OPAQUE_BIT              RenderingDeviceAccelerationStructureInstanceFlagBits = 8
)
...
const (
	...
	RENDERING_DEVICE_UNIFORM_TYPE_UNIFORM_TYPE_UNIFORM_BUFFER_DYNAMIC      RenderingDeviceUniformType = 10
	RENDERING_DEVICE_UNIFORM_TYPE_UNIFORM_TYPE_STORAGE_BUFFER_DYNAMIC      RenderingDeviceUniformType = 11
	RENDERING_DEVICE_UNIFORM_TYPE_UNIFORM_TYPE_ACCELERATION_STRUCTURE      RenderingDeviceUniformType = 12
	RENDERING_DEVICE_UNIFORM_TYPE_UNIFORM_TYPE_MAX                         RenderingDeviceUniformType = 13
)
...
const (
	...
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_RAYGEN                     RenderingDeviceShaderStage = 5
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_ANY_HIT                    RenderingDeviceShaderStage = 6
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_CLOSEST_HIT                RenderingDeviceShaderStage = 7
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_MISS                       RenderingDeviceShaderStage = 8
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_INTERSECTION               RenderingDeviceShaderStage = 9
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_MAX                        RenderingDeviceShaderStage = 10
	...
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_RAYGEN_BIT                 RenderingDeviceShaderStage = 32
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_ANY_HIT_BIT                RenderingDeviceShaderStage = 64
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_CLOSEST_HIT_BIT            RenderingDeviceShaderStage = 128
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_MISS_BIT                   RenderingDeviceShaderStage = 256
	RENDERING_DEVICE_SHADER_STAGE_SHADER_STAGE_INTERSECTION_BIT           RenderingDeviceShaderStage = 512
)
...
const (
	...
	RENDERING_DEVICE_FEATURES_SUPPORTS_RAY_QUERY             RenderingDeviceFeatures = 11
	RENDERING_DEVICE_FEATURES_SUPPORTS_RAYTRACING_PIPELINE   RenderingDeviceFeatures = 12
	RENDERING_DEVICE_FEATURES_SUPPORTS_HDR_OUTPUT            RenderingDeviceFeatures = 13
)
...
type RenderingServerTextureDrawableFormat int

const (
	RENDERING_SERVER_TEXTURE_DRAWABLE_FORMAT_TEXTURE_DRAWABLE_FORMAT_RGBA_8      RenderingServerTextureDrawableFormat = 0
	RENDERING_SERVER_TEXTURE_DRAWABLE_FORMAT_TEXTURE_DRAWABLE_FORMAT_RGBA_8_SRGB RenderingServerTextureDrawableFormat = 1
	RENDERING_SERVER_TEXTURE_DRAWABLE_FORMAT_TEXTURE_DRAWABLE_FORMAT_RGBAH       RenderingServerTextureDrawableFormat = 2
	RENDERING_SERVER_TEXTURE_DRAWABLE_FORMAT_TEXTURE_DRAWABLE_FORMAT_RGBAF       RenderingServerTextureDrawableFormat = 3
)
...
const (
	...
	RENDERING_SERVER_SHADER_MODE_SHADER_TEXTURE_BLIT RenderingServerShaderMode = 5
	RENDERING_SERVER_SHADER_MODE_SHADER_MAX          RenderingServerShaderMode = 6
)
...
const (
	...
	RENDERING_SERVER_LIGHT_TYPE_LIGHT_AREA        RenderingServerLightType = 3
)
...
const (
	...
	RENDERING_SERVER_PARTICLES_TRANSFORM_ALIGN_PARTICLES_TRANSFORM_ALIGN_LOCAL_BILLBOARD           RenderingServerParticlesTransformAlign = 4
)

type RenderingServerParticlesTransformAlignCustomSrc int

const (
	RENDERING_SERVER_PARTICLES_TRANSFORM_ALIGN_CUSTOM_SRC_PARTICLES_ALIGN_CHANNEL_FILTER_DISABLED RenderingServerParticlesTransformAlignCustomSrc = 0
	RENDERING_SERVER_PARTICLES_TRANSFORM_ALIGN_CUSTOM_SRC_PARTICLES_ALIGN_CHANNEL_FILTER_X        RenderingServerParticlesTransformAlignCustomSrc = 1
	RENDERING_SERVER_PARTICLES_TRANSFORM_ALIGN_CUSTOM_SRC_PARTICLES_ALIGN_CHANNEL_FILTER_Y        RenderingServerParticlesTransformAlignCustomSrc = 2
	RENDERING_SERVER_PARTICLES_TRANSFORM_ALIGN_CUSTOM_SRC_PARTICLES_ALIGN_CHANNEL_FILTER_Z        RenderingServerParticlesTransformAlignCustomSrc = 3
	RENDERING_SERVER_PARTICLES_TRANSFORM_ALIGN_CUSTOM_SRC_PARTICLES_ALIGN_CHANNEL_FILTER_W        RenderingServerParticlesTransformAlignCustomSrc = 4
)

type RenderingServerParticlesTransformAlignAxis int

const (
	RENDERING_SERVER_PARTICLES_TRANSFORM_ALIGN_AXIS_PARTICLES_ALIGN_AXIS_X RenderingServerParticlesTransformAlignAxis = 0
	RENDERING_SERVER_PARTICLES_TRANSFORM_ALIGN_AXIS_PARTICLES_ALIGN_AXIS_Y RenderingServerParticlesTransformAlignAxis = 1
)
...
const (
	...
	RENDERING_SERVER_VIEWPORT_SCALING_3_D_MODE_VIEWPORT_SCALING_3_D_MODE_NEAREST          RenderingServerViewportScaling3DMode = 5
	RENDERING_SERVER_VIEWPORT_SCALING_3_D_MODE_VIEWPORT_SCALING_3_D_MODE_MAX              RenderingServerViewportScaling3DMode = 6
)
...
type RenderingServerSplashStretchMode int

const (
	RENDERING_SERVER_SPLASH_STRETCH_MODE_SPLASH_STRETCH_MODE_DISABLED    RenderingServerSplashStretchMode = 0
	RENDERING_SERVER_SPLASH_STRETCH_MODE_SPLASH_STRETCH_MODE_KEEP        RenderingServerSplashStretchMode = 1
	RENDERING_SERVER_SPLASH_STRETCH_MODE_SPLASH_STRETCH_MODE_KEEP_WIDTH  RenderingServerSplashStretchMode = 2
	RENDERING_SERVER_SPLASH_STRETCH_MODE_SPLASH_STRETCH_MODE_KEEP_HEIGHT RenderingServerSplashStretchMode = 3
	RENDERING_SERVER_SPLASH_STRETCH_MODE_SPLASH_STRETCH_MODE_COVER       RenderingServerSplashStretchMode = 4
	RENDERING_SERVER_SPLASH_STRETCH_MODE_SPLASH_STRETCH_MODE_IGNORE      RenderingServerSplashStretchMode = 5
)
...
const (
	...
	RICH_TEXT_LABEL_IMAGE_UPDATE_MASK_UPDATE_WIDTH_UNIT RichTextLabelImageUpdateMask = 128
)

type RichTextLabelImageUnit int

const (
	RICH_TEXT_LABEL_IMAGE_UNIT_IMAGE_UNIT_PIXEL   RichTextLabelImageUnit = 0
	RICH_TEXT_LABEL_IMAGE_UNIT_IMAGE_UNIT_PERCENT RichTextLabelImageUnit = 1
	RICH_TEXT_LABEL_IMAGE_UNIT_IMAGE_UNIT_EM      RichTextLabelImageUnit = 2
)
...
const (
	...
	SCRIPT_LANGUAGE_EXTENSION_CODE_COMPLETION_KIND_CODE_COMPLETION_KIND_KEYWORD    ScriptLanguageExtensionCodeCompletionKind = 10
	SCRIPT_LANGUAGE_EXTENSION_CODE_COMPLETION_KIND_CODE_COMPLETION_KIND_MAX        ScriptLanguageExtensionCodeCompletionKind = 11
)
...
const (
	...
	SCROLL_CONTAINER_SCROLL_MODE_SCROLL_MODE_MAXIMIZE_FIRST ScrollContainerScrollMode = 5
)

type ScrollContainerScrollHintMode int

const (
	SCROLL_CONTAINER_SCROLL_HINT_MODE_SCROLL_HINT_MODE_DISABLED         ScrollContainerScrollHintMode = 0
	SCROLL_CONTAINER_SCROLL_HINT_MODE_SCROLL_HINT_MODE_ALL              ScrollContainerScrollHintMode = 1
	SCROLL_CONTAINER_SCROLL_HINT_MODE_SCROLL_HINT_MODE_TOP_AND_LEFT     ScrollContainerScrollHintMode = 2
	SCROLL_CONTAINER_SCROLL_HINT_MODE_SCROLL_HINT_MODE_BOTTOM_AND_RIGHT ScrollContainerScrollHintMode = 3
)
...
const (
	...
	SHADER_MODE_MODE_TEXTURE_BLIT ShaderMode = 5
)
...
type SkeletonModifier3DBoneDirection int

const (
	SKELETON_MODIFIER_3_D_BONE_DIRECTION_BONE_DIRECTION_PLUS_X      SkeletonModifier3DBoneDirection = 0
	SKELETON_MODIFIER_3_D_BONE_DIRECTION_BONE_DIRECTION_MINUS_X     SkeletonModifier3DBoneDirection = 1
	SKELETON_MODIFIER_3_D_BONE_DIRECTION_BONE_DIRECTION_PLUS_Y      SkeletonModifier3DBoneDirection = 2
	SKELETON_MODIFIER_3_D_BONE_DIRECTION_BONE_DIRECTION_MINUS_Y     SkeletonModifier3DBoneDirection = 3
	SKELETON_MODIFIER_3_D_BONE_DIRECTION_BONE_DIRECTION_PLUS_Z      SkeletonModifier3DBoneDirection = 4
	SKELETON_MODIFIER_3_D_BONE_DIRECTION_BONE_DIRECTION_MINUS_Z     SkeletonModifier3DBoneDirection = 5
	SKELETON_MODIFIER_3_D_BONE_DIRECTION_BONE_DIRECTION_FROM_PARENT SkeletonModifier3DBoneDirection = 6
)

type SkeletonModifier3DSecondaryDirection int

const (
	SKELETON_MODIFIER_3_D_SECONDARY_DIRECTION_SECONDARY_DIRECTION_NONE    SkeletonModifier3DSecondaryDirection = 0
	SKELETON_MODIFIER_3_D_SECONDARY_DIRECTION_SECONDARY_DIRECTION_PLUS_X  SkeletonModifier3DSecondaryDirection = 1
	SKELETON_MODIFIER_3_D_SECONDARY_DIRECTION_SECONDARY_DIRECTION_MINUS_X SkeletonModifier3DSecondaryDirection = 2
	SKELETON_MODIFIER_3_D_SECONDARY_DIRECTION_SECONDARY_DIRECTION_PLUS_Y  SkeletonModifier3DSecondaryDirection = 3
	SKELETON_MODIFIER_3_D_SECONDARY_DIRECTION_SECONDARY_DIRECTION_MINUS_Y SkeletonModifier3DSecondaryDirection = 4
	SKELETON_MODIFIER_3_D_SECONDARY_DIRECTION_SECONDARY_DIRECTION_PLUS_Z  SkeletonModifier3DSecondaryDirection = 5
	SKELETON_MODIFIER_3_D_SECONDARY_DIRECTION_SECONDARY_DIRECTION_MINUS_Z SkeletonModifier3DSecondaryDirection = 6
	SKELETON_MODIFIER_3_D_SECONDARY_DIRECTION_SECONDARY_DIRECTION_CUSTOM  SkeletonModifier3DSecondaryDirection = 7
)

type SkeletonModifier3DRotationAxis int

const (
	SKELETON_MODIFIER_3_D_ROTATION_AXIS_ROTATION_AXIS_X      SkeletonModifier3DRotationAxis = 0
	SKELETON_MODIFIER_3_D_ROTATION_AXIS_ROTATION_AXIS_Y      SkeletonModifier3DRotationAxis = 1
	SKELETON_MODIFIER_3_D_ROTATION_AXIS_ROTATION_AXIS_Z      SkeletonModifier3DRotationAxis = 2
	SKELETON_MODIFIER_3_D_ROTATION_AXIS_ROTATION_AXIS_ALL    SkeletonModifier3DRotationAxis = 3
	SKELETON_MODIFIER_3_D_ROTATION_AXIS_ROTATION_AXIS_CUSTOM SkeletonModifier3DRotationAxis = 4
)
...
type SpriteFramesLoopMode int

const (
	SPRITE_FRAMES_LOOP_MODE_LOOP_NONE     SpriteFramesLoopMode = 0
	SPRITE_FRAMES_LOOP_MODE_LOOP_LINEAR   SpriteFramesLoopMode = 1
	SPRITE_FRAMES_LOOP_MODE_LOOP_PINGPONG SpriteFramesLoopMode = 2
)

type StreamPeerSocketStatus int

const (
	STREAM_PEER_SOCKET_STATUS_STATUS_NONE       StreamPeerSocketStatus = 0
	STREAM_PEER_SOCKET_STATUS_STATUS_CONNECTING StreamPeerSocketStatus = 1
	STREAM_PEER_SOCKET_STATUS_STATUS_CONNECTED  StreamPeerSocketStatus = 2
	STREAM_PEER_SOCKET_STATUS_STATUS_ERROR      StreamPeerSocketStatus = 3
)
...
const (
	...
	TEXT_SERVER_TEXT_OVERRUN_FLAG_OVERRUN_SHORT_STRING_ELLIPSIS TextServerTextOverrunFlag = 32
)
...
type TreeScrollHintMode int

const (
	TREE_SCROLL_HINT_MODE_SCROLL_HINT_MODE_DISABLED TreeScrollHintMode = 0
	TREE_SCROLL_HINT_MODE_SCROLL_HINT_MODE_BOTH     TreeScrollHintMode = 1
	TREE_SCROLL_HINT_MODE_SCROLL_HINT_MODE_TOP      TreeScrollHintMode = 2
	TREE_SCROLL_HINT_MODE_SCROLL_HINT_MODE_BOTTOM   TreeScrollHintMode = 3
)
...
const (
	...
	VIEWPORT_SCALING_3_D_MODE_SCALING_3_D_MODE_NEAREST          ViewportScaling3DMode = 5
	VIEWPORT_SCALING_3_D_MODE_SCALING_3_D_MODE_MAX              ViewportScaling3DMode = 6
)
...
const (
	...
	VIEWPORT_DEBUG_DRAW_DEBUG_DRAW_CLUSTER_AREA_LIGHTS       ViewportDebugDraw = 27
	VIEWPORT_DEBUG_DRAW_DEBUG_DRAW_AREA_LIGHT_ATLAS          ViewportDebugDraw = 28
)
...
const (
	...
	VIEWPORT_DEFAULT_CANVAS_ITEM_TEXTURE_FILTER_DEFAULT_CANVAS_ITEM_TEXTURE_FILTER_PARENT_NODE          ViewportDefaultCanvasItemTextureFilter = 4
	VIEWPORT_DEFAULT_CANVAS_ITEM_TEXTURE_FILTER_DEFAULT_CANVAS_ITEM_TEXTURE_FILTER_MAX                  ViewportDefaultCanvasItemTextureFilter = 5
)
...
const (
	...
	VIEWPORT_DEFAULT_CANVAS_ITEM_TEXTURE_REPEAT_DEFAULT_CANVAS_ITEM_TEXTURE_REPEAT_PARENT_NODE ViewportDefaultCanvasItemTextureRepeat = 3
	VIEWPORT_DEFAULT_CANVAS_ITEM_TEXTURE_REPEAT_DEFAULT_CANVAS_ITEM_TEXTURE_REPEAT_MAX         ViewportDefaultCanvasItemTextureRepeat = 4
)
...
type VirtualJoystickJoystickMode int

const (
	VIRTUAL_JOYSTICK_JOYSTICK_MODE_JOYSTICK_FIXED     VirtualJoystickJoystickMode = 0
	VIRTUAL_JOYSTICK_JOYSTICK_MODE_JOYSTICK_DYNAMIC   VirtualJoystickJoystickMode = 1
	VIRTUAL_JOYSTICK_JOYSTICK_MODE_JOYSTICK_FOLLOWING VirtualJoystickJoystickMode = 2
)

type VirtualJoystickVisibilityMode int

const (
	VIRTUAL_JOYSTICK_VISIBILITY_MODE_VISIBILITY_ALWAYS       VirtualJoystickVisibilityMode = 0
	VIRTUAL_JOYSTICK_VISIBILITY_MODE_VISIBILITY_WHEN_TOUCHED VirtualJoystickVisibilityMode = 1
)
...
const (
	...
	VISUAL_SHADER_TYPE_TYPE_TEXTURE_BLIT   VisualShaderType = 10
	VISUAL_SHADER_TYPE_TYPE_MAX            VisualShaderType = 11
)
...
const (
	...
	VISUAL_SHADER_NODE_PARAMETER_QUALIFIER_QUAL_INSTANCE_INDEX VisualShaderNodeParameterQualifier = 3
	VISUAL_SHADER_NODE_PARAMETER_QUALIFIER_QUAL_MAX            VisualShaderNodeParameterQualifier = 4
)
