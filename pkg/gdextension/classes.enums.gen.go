...
const (
	...
	ANIMATION_UPDATE_MODE_UPDATE_TRIGGER  = 2
	ANIMATION_UPDATE_MODE_UPDATE_CAPTURE  = 3
	)
...
type NativeExtensionInitializationLevel int
const (
	NATIVE_EXTENSION_INITIALIZATION_LEVEL_INITIALIZATION_LEVEL_CORE NativeExtensionInitializationLevel = 0
	NATIVE_EXTENSION_INITIALIZATION_LEVEL_INITIALIZATION_LEVEL_SERVERS  = 1
	NATIVE_EXTENSION_INITIALIZATION_LEVEL_INITIALIZATION_LEVEL_SCENE  = 2
	NATIVE_EXTENSION_INITIALIZATION_LEVEL_INITIALIZATION_LEVEL_EDITOR  = 3
	)
type NativeExtensionManagerLoadStatus int
const (
	NATIVE_EXTENSION_MANAGER_LOAD_STATUS_LOAD_STATUS_OK NativeExtensionManagerLoadStatus = 0
	NATIVE_EXTENSION_MANAGER_LOAD_STATUS_LOAD_STATUS_FAILED  = 1
	NATIVE_EXTENSION_MANAGER_LOAD_STATUS_LOAD_STATUS_ALREADY_LOADED  = 2
	NATIVE_EXTENSION_MANAGER_LOAD_STATUS_LOAD_STATUS_NOT_LOADED  = 3
	NATIVE_EXTENSION_MANAGER_LOAD_STATUS_LOAD_STATUS_NEEDS_RESTART  = 4
	)
...
const (
	NAVIGATION_MESH_SOURCE_GEOMETRY_MODE_SOURCE_GEOMETRY_NAVMESH_CHILDREN NavigationMeshSourceGeometryMode = 0
...
const (
	...
	NODE_DUPLICATE_FLAGS_DUPLICATE_USE_INSTANCING  = 8
	)
...
type Node3DRotationOrder int
const (
	NODE_3_D_ROTATION_ORDER_ROTATION_ORDER_XYZ Node3DRotationOrder = 0
	NODE_3_D_ROTATION_ORDER_ROTATION_ORDER_XZY  = 1
	NODE_3_D_ROTATION_ORDER_ROTATION_ORDER_YXZ  = 2
	NODE_3_D_ROTATION_ORDER_ROTATION_ORDER_YZX  = 3
	NODE_3_D_ROTATION_ORDER_ROTATION_ORDER_ZXY  = 4
	NODE_3_D_ROTATION_ORDER_ROTATION_ORDER_ZYX  = 5
	)
type OSVideoDriver int
const (
	OS_VIDEO_DRIVER_VIDEO_DRIVER_VULKAN OSVideoDriver = 0
	OS_VIDEO_DRIVER_VIDEO_DRIVER_OPENGL_3  = 1
	)
type OSWeekday int
const (
...
const (
	...
	RENDERING_SERVER_CANVAS_GROUP_MODE_CANVAS_GROUP_MODE_OPAQUE  = 1
	RENDERING_SERVER_CANVAS_GROUP_MODE_CANVAS_GROUP_MODE_TRANSPARENT  = 2
	)
