...
type FileModeFlags int
const (
	FILE_MODE_FLAGS_READ FileModeFlags = 1
	FILE_MODE_FLAGS_WRITE  = 2
	FILE_MODE_FLAGS_READ_WRITE  = 3
	FILE_MODE_FLAGS_WRITE_READ  = 7
	)
type FileCompressionMode int
const (
	FILE_COMPRESSION_MODE_COMPRESSION_FASTLZ FileCompressionMode = 0
	FILE_COMPRESSION_MODE_COMPRESSION_DEFLATE  = 1
	FILE_COMPRESSION_MODE_COMPRESSION_ZSTD  = 2
	FILE_COMPRESSION_MODE_COMPRESSION_GZIP  = 3
	)
